...
void main() {
    highp vec4 var_d6e99 = v_Additional;
    ...
    highp vec4 var_376ff = Data_PS[var_fedb0];
    int var_f469d = int(var_ea3a1.x);
    int var_f1761 = int(Data_PS[max(0, (var_f469d + (-1)))].y);
    highp vec4 var_3a1da = Data_PS[var_fedb0];
    highp float var_98b39;
    if (1 == var_f473b)
    {
        var_98b39 = clamp(0.5 - (length(v_ScreenNormalPosition.xy - v_Additional.xy) - var_d6e99.z), 0.0, 1.0);
    }
    else
    {
        ...
        if (2 == var_f473b)
        {
            ...
            var_736b5 = clamp(0.5 - (var_f2c71 - var_d6e99.z), 0.0, 1.0) * (1.0 - clamp(0.5 - (var_f2c71 - (var_d6e99.z - var_d6e99.w)), 0.0, 1.0));
        }
        else
        {
            ...
            else
            {
                ...
                else
                {
                    ...
                    {
                        var_3a1da = vec4(0.0);
                        highp vec4 var_79b72 = Data_PS[var_f469d + 1];
                        highp float var_7d97a;
                        if (Data_PS[var_f469d].x > 3.0)
                        {
                            var_7d97a = Data_PS[var_f469d].x * 0.307196319103240966796875;
                        }
                        else
                        {
                            var_7d97a = 0.60000002384185791015625 + (Data_PS[var_f469d].x * 0.100000001490116119384765625);
                        }
                        int var_868c8 = (int(Data_PS[var_f469d].x) * 2) + 1;
                        ...
                        int var_84061 = int(mod(Data_PS[var_f469d].x + 1.0, 2.0));
                        ...
                        int var_825f8 = int((Data_PS[var_f469d].x * 0.5) + 1.0);
                        ...
                        for (; var_f6ced < var_825f8; var_2ae5d = var_b2b23, var_f6ced++)
                        {
                            if ((var_f6ced != 0) || (var_84061 != 1))
                            {
                                ...
                                var_d4b82.x = var_1b6c6 * Data_PS[var_f469d].y;
                                var_d4b82.y = var_1b6c6 * Data_PS[var_f469d].z;
                                var_b2b23 = var_042ad;
                            }
                            else
                            {
                            ...
                            highp vec4 var_aaa40 = vec4(v_Additional.xy + var_d4b82, 0.0, 0.0);
                            highp vec4 var_43661 = vec4(v_Additional.xy - var_d4b82, 0.0, 0.0);
                            ...
                            if (var_f434b)
                            {
                                var_aaa40.x = clamp(var_d6e99.x + var_d4b82.x, var_79b72.x, var_79b72.x + var_79b72.z);
                                var_aaa40.y = clamp(var_d6e99.y + var_d4b82.y, var_79b72.y, var_79b72.y + var_79b72.w);
                                var_43661.x = clamp(var_d6e99.x - var_d4b82.x, var_79b72.x, var_79b72.x + var_79b72.z);
                                var_43661.y = clamp(var_d6e99.y - var_d4b82.y, var_79b72.y, var_79b72.y + var_79b72.w);
                            }
                            highp vec4 var_c5bca = texture(s_txBuffer, (vec2(var_aaa40.x, 1.0 - var_aaa40.y) * UVTransform[0].zw) + UVTransform[0].xy);
                            highp vec4 var_103d7 = texture(s_txBuffer, (vec2(var_43661.x, 1.0 - var_43661.y) * UVTransform[0].zw) + UVTransform[0].xy);
                            highp vec4 var_186b3;
                            highp vec4 var_9c734;
                            if ((var_f1761 & 2) != 0)
                            {
                                highp vec3 var_a8992 = var_c5bca.xyz;
                                ...
                                highp vec3 var_ff496 = var_103d7.xyz;
                                ...
                                var_9c734 = vec4(var_4495d.x, var_4495d.y, var_4495d.z, var_103d7.w);
                                var_186b3 = vec4(var_6ca41.x, var_6ca41.y, var_6ca41.z, var_c5bca.w);
                            }
                            else
                            {
                                ...
                                if ((var_f1761 & 16) != 0)
                                {
                                    highp vec3 var_b0d06 = var_c5bca.xyz;
                                    ...
                                    highp vec3 var_bbf1f = var_103d7.xyz;
                                    ...
                                    var_769ac = vec4(var_58a86.x, var_58a86.y, var_58a86.z, var_103d7.w);
                                    var_3d9ef = vec4(var_558eb.x, var_558eb.y, var_558eb.z, var_c5bca.w);
                                }
                                else
                                {
                                    var_769ac = var_103d7;
                            ...
                            var_3a1da += ((var_186b3 + var_9c734) * var_b2b23);
                        }
                        var_ddde2 = var_376ff.w;
                    }
                    else
                    {
                        ...
                        if (7 == var_f473b)
                        {
                            ...
                            highp vec4 var_c1770 = Data_PS[var_f469d];
                            ...
                            highp vec4 var_6aac9 = texture(s_txBuffer, (vec2(var_d2bfb.x, 1.0 - var_d2bfb.y) * UVTransform[0].zw) + UVTransform[0].xy);
                            if ((var_f1761 & 2) != 0)
                            {
                                highp vec3 var_be626 = var_6aac9.xyz;
                                ...
                                var_6aac9 = vec4(var_08b75.x, var_08b75.y, var_08b75.z, var_6aac9.w);
                            }
                            else
                            {
                                if ((var_f1761 & 16) != 0)
                                {
                                    highp vec3 var_7bca4 = var_6aac9.xyz;
                                    ...
                                    var_6aac9 = vec4(var_51794.x, var_51794.y, var_51794.z, var_6aac9.w);
                                }
                            }
                            highp float var_6215c = var_6aac9.w;
                            highp float var_598f3 = max(var_6215c, 9.9999997473787516355514526367188e-06);
                            highp vec4 var_176b1 = var_6aac9;
                            highp vec4 var_729fe = vec4(var_176b1.xyz / vec3(var_598f3), var_598f3);
                            var_6aac9 = var_729fe;
                            var_3a1da.x = dot(var_729fe, Data_PS[var_f469d + 1]);
                            var_3a1da.y = dot(var_729fe, Data_PS[var_f469d + 2]);
                            var_3a1da.z = dot(var_729fe, Data_PS[var_f469d + 3]);
                            var_3a1da.w = dot(var_729fe, Data_PS[var_f469d + 4]);
                            highp vec4 var_ea70f = var_3a1da;
                            highp vec4 var_288d5 = var_ea70f + Data_PS[var_f469d + 5];
                            var_3a1da = var_288d5;
                            highp vec3 var_5ad70 = var_288d5.xyz;
                            var_3a1da.w = mix(clamp(((0.2125999927520751953125 * var_5ad70.x) + (0.715200006961822509765625 * var_5ad70.y)) + (0.072200000286102294921875 * var_5ad70.z), 0.0, 1.0), var_3a1da.w, var_376ff.z);
                            highp float var_9f710 = var_3a1da.w;
                            var_3a1da.w = 1.0;
                            var_df5f8 = (var_9f710 * var_376ff.w) * clamp(var_d6e99.z, 0.0, 1.0);
                        }
                        else
                        {
                            ...
                            if (var_bb487)
                            {
                                ...
                                var_3a1da = vec4(var_04011, 1.0);
                                highp float var_3b2d5;
                                if (12 == var_f473b)
                                {
                                    var_3b2d5 = (var_376ff.w * clamp(var_d6e99.z, 0.0, 1.0)) * texture(s_txBuffer3, (v_Additional.xy * UVTransform[3].zw) + UVTransform[3].xy).x;
                                }
                                else
                                {
                                    var_3b2d5 = var_376ff.w;
                                }
                                var_97871 = var_3b2d5;
                            }
                            else
                            {
                                ...
                                if (11 == var_f473b)
                                {
                                    var_2183b = clamp((1.0 - clamp(abs(dot(v_Additional.xyz, vec3(v_ScreenNormalPosition.xy, 1.0))), 0.0, 1.0)) * var_d6e99.w, 0.0, 1.0);
                                }
                                else
                                {
                                    ...
                                    if (19 == var_f473b)
                                    {
                                        highp vec4 var_85a00 = Data_PS[var_f469d];
                                        ...
                                        var_3a1da = mix(Data_PS[var_f469d + 1], Data_PS[var_fedb0], vec4(clamp(var_3e548 - (var_31273 + var_07a02), 0.0, 1.0))) * clamp(var_3e548 - max(0.0, var_31273 - var_07a02), 0.0, 1.0);
                                        var_ed456 = 1.0;
                                    }
                                    else
                                    {
                                        ...
                                        {
                                            highp vec2 var_4c7e7 = v_Additional.zw;
                                            if (var_f473b == 35)
                                            {
                                                highp vec2 var_f7064 = var_4c7e7;
                                                highp vec2 var_c898c = (Data_PS[var_f469d].zw * vec2(fract(var_f7064).x, 1.0 - fract(var_f7064).y)) + Data_PS[var_f469d].xy;
                                                var_4c7e7 = var_c898c;
                                                var_3a1da = texture(s_txBuffer, (var_c898c * UVTransform[0].zw) + UVTransform[0].xy);
                                            }
                                            else
                                            {
                                                var_3a1da = texture(s_txBuffer, (vec2(var_4c7e7.x, 1.0 - var_4c7e7.y) * UVTransform[0].zw) + UVTransform[0].xy);
                                            }
                                            if ((var_f1761 & 2) != 0)
                                            {
                                                highp vec3 var_88946 = var_3a1da.xyz;
                                                ...
                                                var_3a1da = vec4(var_02fa6.x, var_02fa6.y, var_02fa6.z, var_3a1da.w);
                                            }
                                            else
                                            {
                                                if ((var_f1761 & 16) != 0)
                                                {
                                                    highp vec3 var_e5842 = var_3a1da.xyz;
                                                    ...
                                                    var_3a1da = vec4(var_7ac79.x, var_7ac79.y, var_7ac79.z, var_3a1da.w);
                                                }
                                            }
                                            var_3a1da.w = mix(var_3a1da.w, 1.0 - var_3a1da.w, float((int(var_376ff.x) & 1) != 0));
                                            highp vec3 var_b21cc = var_3a1da.xyz;
                                            var_3a1da.w = mix(clamp(((0.2125999927520751953125 * var_b21cc.x) + (0.715200006961822509765625 * var_b21cc.y)) + (0.072200000286102294921875 * var_b21cc.z), 0.0, 1.0), var_3a1da.w, var_376ff.z);
                                            var_3a1da.w = mix(var_3a1da.w, 1.0, float((int(var_376ff.x) & 2) != 0));
                                            ...
                                            var_e78af = var_376ff.w * clamp(0.5 - ((dot(var_9570c, var_9570c) - 1.0) * inversesqrt(max(dot(var_78729, var_78729), 9.9999997473787516355514526367188e-05))), 0.0, 1.0);
                                        }
                                        else
                                        {
                                            ...
                                            if (var_f473b == 33)
                                            {
                                                highp vec2 var_25a40 = Data_PS[var_f469d].xy;
                                                ...
                                                var_3a1da = texture(s_txBuffer, (((Data_PS[var_f469d + 1].zw * vec2(fract(v_Additional.zw).x, 1.0 - fract(v_Additional.zw).y)) + Data_PS[var_f469d + 1].xy) * UVTransform[0].zw) + UVTransform[0].xy);
                                                if ((var_f1761 & 2) != 0)
                                                {
                                                    highp vec3 var_f2f08 = var_3a1da.xyz;
                                                    ...
                                                    var_3a1da = vec4(var_87004.x, var_87004.y, var_87004.z, var_3a1da.w);
                                                }
                                                else
                                                {
                                                    if ((var_f1761 & 16) != 0)
                                                    {
                                                        highp vec3 var_e3e93 = var_3a1da.xyz;
                                                        ...
                                                        var_3a1da = vec4(var_ce391.x, var_ce391.y, var_ce391.z, var_3a1da.w);
                                                    }
                                                }
                                                var_3a1da.w = mix(1.0 - var_3a1da.w, var_3a1da.w, var_376ff.x);
                                                highp vec3 var_b5c5f = var_3a1da.xyz;
                                                var_3a1da.w = mix(clamp(((0.2125999927520751953125 * var_b5c5f.x) + (0.715200006961822509765625 * var_b5c5f.y)) + (0.072200000286102294921875 * var_b5c5f.z), 0.0, 1.0), var_3a1da.w, var_376ff.z);
                                                var_3a1da.w = mix(var_3a1da.w, 1.0, var_ea3a1.y);
                                                var_6143b = var_376ff.w * clamp(0.5 - (var_ca1ef * (length(v_ScreenNormalPosition.xy - v_Additional.xy) - var_a2ee7.z)), 0.0, 1.0);
                                            }
                                            else
                                            {
                                                ...
                                                if (var_f473b == 23)
                                                {
                                                    highp vec4 var_a8ef3 = texture(s_txBuffer, (v_Additional.xy * UVTransform[0].zw) + UVTransform[0].xy);
                                                    highp float var_26b24 = var_a8ef3.x;
                                                    highp vec4 var_5743b = Data_PS[var_f469d];
                                                    ...
                                                    var_3a1da = mix(Data_PS[var_f469d + 1], Data_PS[var_fedb0], vec4(smoothstep(var_23cd3 - var_5743b.x, var_23cd3 + var_5743b.x, var_26b24))) * var_fd049;
                                                    var_119dc = 1.0;
                                                }
                                                else
                                                {
                                                    ...
                                                    if (var_f473b == 24)
                                                    {
                                                        highp vec3 var_58b5b = texture(s_txBuffer3, (v_Additional.xy * UVTransform[3].zw) + UVTransform[3].xy).xyz;
                                                        var_3a1da = Data_PS[var_fedb0] * smoothstep(0.5 - var_d6e99.z, 0.5 + var_d6e99.z, max(min(var_58b5b.x, var_58b5b.y), min(max(var_58b5b.x, var_58b5b.y), var_58b5b.z)));
                                                        var_33568 = 1.0;
                                                    }
                                                    else
                                                    {
                                                        ...
                                                        if (var_f473b == 25)
                                                        {
                                                            highp vec3 var_c6325 = texture(s_txBuffer, (v_Additional.xy * UVTransform[0].zw) + UVTransform[0].xy).xyz;
                                                            highp vec4 var_714ab = Data_PS[var_f469d];
                                                            ...
                                                            highp float var_bc6ed = max(min(var_c6325.x, var_c6325.y), min(max(var_c6325.x, var_c6325.y), var_c6325.z));
                                                            highp float var_7f653 = smoothstep(var_d3a86 - var_714ab.x, var_d3a86 + var_714ab.x, var_bc6ed);
                                                            if (var_7f653 <= 0.0)
                                                            {
                                                                discard;
                                                            }
                                                            var_3a1da = mix(Data_PS[var_f469d + 1], Data_PS[var_fedb0], vec4(smoothstep(var_60d5d - var_714ab.x, var_60d5d + var_714ab.x, var_bc6ed))) * var_7f653;
                                                            var_8dc78 = 1.0;
                                                        }
                                                        else
                                                        {
                                                            ...
                                                            if (var_f473b == 31)
                                                            {
                                                                highp vec2 var_e55bf = v_Additional.zw;
                                                                var_3a1da = texture(s_txBuffer, (vec2(var_e55bf.x, 1.0 - var_e55bf.y) * UVTransform[0].zw) + UVTransform[0].xy);
                                                                if ((var_f1761 & 2) != 0)
                                                                {
                                                                    highp vec3 var_14c63 = var_3a1da.xyz;
                                                                    ...
                                                                    var_3a1da = vec4(var_c5d9b.x, var_c5d9b.y, var_c5d9b.z, var_3a1da.w);
                                                                }
                                                                else
                                                                {
                                                                    if ((var_f1761 & 16) != 0)
                                                                    {
                                                                        highp vec3 var_37e42 = var_3a1da.xyz;
                                                                        ...
                                                                        var_3a1da = vec4(var_3c09e.x, var_3c09e.y, var_3c09e.z, var_3a1da.w);
                                                                    }
                                                                }
                                                                var_3a1da.w = mix(1.0 - var_3a1da.w, var_3a1da.w, var_376ff.x);
                                                                highp vec3 var_7c508 = var_3a1da.xyz;
                                                                var_3a1da.w = mix(clamp(((0.2125999927520751953125 * var_7c508.x) + (0.715200006961822509765625 * var_7c508.y)) + (0.072200000286102294921875 * var_7c508.z), 0.0, 1.0), var_3a1da.w, var_376ff.z);
                                                                var_3a1da.w = mix(var_3a1da.w, 1.0, var_ea3a1.y);
                                                                highp vec2 var_6be68 = Data_PS[var_f469d].xy;
                                                                ...
                                                                var_772b6 = var_376ff.w * clamp(0.5 - (var_40575 * (length(v_ScreenNormalPosition.xy - v_Additional.xy) - var_a2ee7.z)), 0.0, 1.0);
                                                            }
                                                            else
                                                            {
                                                                var_772b6 = 1.0;
    ...
    if ((var_f1761 & 64) != 0)
    {
        highp vec3 var_74485 = var_3a1da.xyz * var_3a1da.w;
        var_3a1da = vec4(var_74485.x, var_74485.y, var_74485.z, var_3a1da.w);
    }
    bgfx_FragColor = var_3a1da * var_98b39;
}
