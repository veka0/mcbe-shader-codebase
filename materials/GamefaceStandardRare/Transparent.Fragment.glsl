                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (7.0 == float(var_c9987))
                        {
                            ...
                            var_54ab8.w = mix(((0.2125999927520751953125 * var_635fc.x) + (0.715200006961822509765625 * var_635fc.y)) + (0.072200000286102294921875 * var_635fc.z), var_54ab8.w, var_a33c5.z);
