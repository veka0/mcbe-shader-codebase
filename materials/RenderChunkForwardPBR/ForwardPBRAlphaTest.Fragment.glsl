...
void func_bbb6d(inout int arg_826b5, inout highp float arg_9eee0, inout highp float arg_6b488, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c, inout highp float arg_77c90) {
    if (var_6f64b.zLights[arg_826b5].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        arg_6b488 = 1.0;
        return;
    }
    highp vec3 loc_44ea9 = arg_aee55 - var_6f64b.zLights[arg_826b5].position.xyz;
    ...
    highp float loc_e670f = (textureLod(s_PointLightShadowTextureArray, vec4(loc_f715f, float(var_6f64b.zLights[arg_826b5].shadowProbeIndex)), 0.0).x * 2.0) - 1.0;
...
void func_a474e(inout highp vec4 arg_e84ec, inout int arg_9327a, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_0a2b9, inout highp vec3 arg_f6a53, inout highp vec3 arg_4f9dc, inout highp float arg_8bccf) {
    ...
    highp vec3 loc_a4b3e = var_6f64b.zLights[arg_9327a].position.xyz - v_worldPos;
    ...
    if (loc_3a449 >= (var_6f64b.zLights[arg_9327a].position.w * var_6f64b.zLights[arg_9327a].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_0a2b9 = vec3(0.0);
    ...
    highp float loc_4c5a5 = loc_3a449 / ((var_6f64b.zLights[arg_9327a].position.w * var_6f64b.zLights[arg_9327a].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_6f64b.zLights[arg_9327a].color.xyz * loc_219c5;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_3a449 / ((var_6f64b.zLights[arg_9327a].position.w * var_6f64b.zLights[arg_9327a].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_a011d;
    arg_7f337 = loc_cddfe;
    arg_0a2b9 = (var_6f64b.zLights[arg_9327a].color.xyz * var_6f64b.zLights[arg_9327a].color.w) * loc_219c5;
}
void func_e9ab7(inout bool arg_9a2b4, inout bool arg_b6724, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_33e52, inout highp vec3 arg_33c3b, inout highp vec3 arg_e4e64, inout highp vec3 arg_061f9, inout highp float arg_e8ed0, inout highp vec3 arg_04538, inout highp vec3 arg_dd9d3, inout highp float arg_f859b, inout highp float arg_105b9, inout highp vec3 arg_5a8cd, inout highp vec3 arg_4fa31) {
    ...
    for (int loc_86630 = loc_490eb; loc_86630 < loc_c476d; loc_983e3 = loc_7c75a, loc_33c65 = loc_ed2f2, loc_23246 = loc_62c27, loc_86630++)
    {
        ...
        highp vec3 loc_287bb = normalize((u_view * vec4(var_6f64b.zLights[loc_4d5d9].position.xyz, 1.0)).xyz - arg_33c3b);
...
void func_323af(inout highp vec3 arg_4f139, inout highp vec3 arg_d5e4d, inout highp vec3 arg_5b214, inout highp vec3 arg_2f16d, inout highp vec4 arg_d4ca2, inout highp vec3 arg_9eae3, inout highp vec3 arg_b40e7, inout highp vec3 arg_624c4, inout highp vec3 arg_d0fae, inout highp float arg_da044, inout highp vec3 arg_2286e, inout highp vec3 arg_afec0, inout highp float arg_3ee82, inout highp float arg_e0adf, inout highp vec3 arg_55d38) {
    ...
    func_e9ab7(loc_8e13b, loc_777c4, loc_c6d60, loc_fd6f9, loc_8bedd, arg_9eae3, arg_624c4, arg_d0fae, arg_da044, arg_2286e, arg_afec0, arg_3ee82, arg_e0adf, loc_85808, arg_55d38);
...
void main() {
    ...
    highp vec4 var_a426b = texture(s_MatTexture, v_texcoord0);
#endif
...
#endif
#if defined(DITHERING__ON) && defined(SEASONS__OFF)
    highp vec4 var_a426b = var_5e3c6;
#endif
#ifdef SEASONS__OFF
    if (var_0a028.y != 0.0)
    {
        highp vec3 var_c7ec1 = mix(var_a426b.xyz, var_a426b.xyz * v_color0.xyz, vec3(var_a426b.w));
        var_a426b = vec4(var_c7ec1.x, var_c7ec1.y, var_c7ec1.z, var_a426b.w);
        var_a426b.w = 1.0;
    }
    else
    {
        highp vec3 var_55928 = var_a426b.xyz * v_color0.xyz;
        var_a426b = vec4(var_55928.x, var_55928.y, var_55928.z, var_a426b.w);
    }
#endif
#ifdef SEASONS__ON
    highp vec3 var_2455e = v_color0.xyz;
    highp vec3 var_2b07f = (var_5e3c6.xyz * mix(vec3(1.0), texture(s_SeasonsTexture, v_color0.xy).xyz * 2.0, vec3(var_2455e.z))).xyz * vec3(var_57380.w);
    highp vec4 var_a426b = vec4(var_2b07f.x, var_2b07f.y, var_2b07f.z, var_5e3c6.w);
    var_a426b.w = 1.0;
#endif
    highp vec4 var_791d8 = var_a426b;
#ifdef SEASONS__OFF
    highp vec3 var_0a054 = var_791d8.xyz * var_57380.w;
    var_a426b = vec4(var_0a054.x, var_0a054.y, var_0a054.z, var_791d8.w);
    highp vec3 var_9e11a = var_0a054.xyz;
#endif
    highp vec3 var_0f267;
#ifdef SEASONS__OFF
    func_9b87e(var_0f267, var_9e11a);
#endif
#ifdef SEASONS__ON
    func_66b9c(var_0f267, var_a426b);
#endif
    highp vec3 var_d2ce2;
    highp float var_5e5e9;
    highp float var_d95ec;
    highp float var_39edd;
    highp float var_35f91;
    func_a72a6(var_35f91, var_39edd, var_d95ec, var_5e5e9, var_d2ce2);
    ...
    highp vec3 var_de9be = var_930c5.xyz;
    ...
    highp vec3 var_f0a2e;
    if (var_fc5fc)
    {
        highp vec3 var_a85cf = v_worldPos - WorldOrigin.xyz;
        highp vec3 var_1f1d3 = normalize(round(normalize((u_invView * vec4(normalize(cross(normalize(dFdx(var_de9be)), normalize(dFdy(var_de9be)))), 0.0)).xyz) / vec3(QuantizationPrecisionRoundingParameters.x)) * QuantizationPrecisionRoundingParameters.x);
        highp vec3 var_8ce38 = mod(var_a85cf, vec3(QuantizationParameters.z));
        var_f0a2e = (var_a85cf - (var_8ce38 - (var_1f1d3 * dot(var_8ce38, var_1f1d3)))) + WorldOrigin.xyz;
    }
    else
    {
        var_f0a2e = v_worldPos;
    }
    highp vec3 var_44eb9 = var_e14aa.xyz;
    highp vec3 var_73e61 = (u_view * var_e14aa).xyz;
    highp vec3 var_c5e74 = vec3(0.039999999105930328369140625 * (1.0 - var_35f91)) + (var_0f267 * var_35f91);
    ...
    highp float var_62b20 = clamp(((var_a7492.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0);
    highp float var_106e2 = length(var_de9be);
    highp vec3 var_5bd0a = var_12830;
    highp vec4 var_9a0a9;
    highp vec3 var_df802;
    highp vec3 var_030d7;
    if (var_5bd0a.z != 1.0)
    {
        highp vec3 var_c2de9 = -(var_de9be / vec3(length(var_de9be) + 9.9999997473787516355514526367188e-05));
        highp float var_f6272 = var_5e5e9 * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        highp vec3 var_8bbda = var_de9be;
        ...
        highp vec3 var_94c87;
        highp vec3 var_33188;
        func_7abc7(var_a7492, var_33188, var_94c87, var_73e61, var_a3c91, var_44eb9, var_8bbda, var_c90aa, var_c2de9, var_39edd, var_c5e74, var_0f267, var_35f91, var_f6272);
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_323af(var_e318f, var_33188, var_aae12, var_94c87, var_05431, var_de9be, var_f0a2e, var_73e61, var_c2de9, var_39edd, var_c5e74, var_0f267, var_35f91, var_f6272, var_44eb9);
        var_030d7 = var_e318f;
        var_df802 = var_aae12;
        var_9a0a9 = var_05431;
    }
    ...
    highp vec4 var_fe23f = var_9a0a9;
    highp float var_feb0d = var_a7492.x * var_a7492.x;
    highp vec4 var_9a3c1 = SkyAmbientLightColorIntensity;
    highp float var_011d0 = var_a7492.y * var_a7492.y;
    ...
    {
        highp float var_79b3e = clamp((((length(var_de9be) / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) * FogAndDistanceControl.y, 0.0, 1.0);
    ...
    highp vec4 var_38268 = vec4(var_1bb57, var_bdb1d);
    highp vec4 var_b8062 = var_38268;
    highp vec3 var_410f5 = mix((((((var_0f267 * (1.0 - var_35f91)) * max((clamp(vec3(var_feb0d + (var_fe23f.x * var_fe23f.w), (var_feb0d * ((((var_feb0d * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_fe23f.y * var_fe23f.w), (var_feb0d * (((var_feb0d * var_feb0d) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_fe23f.z * var_fe23f.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_011d0 * var_011d0) * var_a7492.y, (var_a7492.y * var_a7492.y) * var_a7492.y, CameraLightIntensity.y)) * var_9a3c1.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_030d7) + var_df802) + (((mix(var_0f267, vec3(dot(var_0f267, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_d95ec)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_38268.xyz, vec3(var_b8062.w));
    highp vec4 var_f8ea4;
    if (VolumeScatteringEnabledAndPointLightVolumetricsEnabled.x != 0.0)
    {
        ...
        var_f8ea4 = mix(textureLod(s_ScatteringBuffer, vec3(var_8cf8f, var_115ba.y, float(var_0e80b)), 0.0), textureLod(s_ScatteringBuffer, vec3(var_8cf8f, var_115ba.y, float(var_0e80b + 1)), 0.0), vec4(clamp(var_14f4f - float(var_0e80b), 0.0, 1.0)));
    }
    else
    {
        var_f8ea4 = vec4(0.0, 0.0, 0.0, 1.0);
    }
    highp vec4 var_b61f4 = var_f8ea4;
    highp vec3 var_3087b;
    if (IBLParameters.x != 0.0)
    {
        ...
        {
            var_dd3fd = (u_view * vec4(var_f0a2e, 1.0)).xyz;
            var_a8715 = var_f0a2e;
        }
        else
        {
        ...
        highp vec3 var_a56d9 = reflect(normalize(var_a8715 - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_44eb9);
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_3da12(var_a7492, var_35f91, var_713f8, var_26642);
    ...
    highp vec3 var_7ea3c = vec4(var_f8ea4.xyz + (var_410f5 * var_b61f4.w), 1.0).xyz + var_3087b;
    highp vec3 var_9d369;
    if (PreExposureEnabled.x > 0.0)
    {
        var_9d369 = var_7ea3c * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_9d369 = var_7ea3c;
...
#ifdef SEASONS__OFF
    bgfx_FragData[0] = vec4(var_9d369.x, var_9d369.y, var_9d369.z, vec4(var_6394b, var_6394b, var_6394b, var_a426b.w).w);
#endif
#ifdef SEASONS__ON
