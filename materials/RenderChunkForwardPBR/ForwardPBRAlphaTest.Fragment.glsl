...
void main() {
...
#ifdef SEASONS__OFF
    func_66b9c(var_06d9b, var_269bc);
#endif
#ifdef SEASONS__ON
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_6c485(var_12cd7, var_33188, var_94c87, var_73e61, var_a3c91, var_44eb9, var_8bbda, var_c90aa, var_c2de9, var_39edd, var_c5e74, var_06d9b, var_2eb10, var_f6272);
