...
void main() {
    ...
    highp vec3 var_3b8a3 = var_e14aa.xyz;
    ...
    highp vec4 var_a622c = vec4(var_c582a, 0.0);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_5797c(var_1a204, var_ce603, var_938e2, var_73e61, var_a3c91, var_3b8a3, var_8bbda, var_c90aa, var_c2de9, var_39edd, var_c5e74, var_31778, var_4de16, var_a712c);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_95aa8(var_e318f, var_ce603, var_aae12, var_938e2, var_05431, var_15859, var_2b534, var_73e61, var_c2de9, var_39edd, var_c5e74, var_31778, var_4de16, var_3b8a3, var_a712c);
        var_e35de = var_e318f;
#endif
    ...
    highp vec3 var_e8753;
    if ((DirectionalLightToggleAndMaxDistanceAndMaxCascadesPerLightAndGPUBlockLightingEnabled.w != 0.0) && (!((var_9c6ab & 1u) != 0u)))
    {
        highp vec3 var_b75dd = ((v_worldPos - WorldOrigin.xyz) - vec3(0.5)) + (var_3b8a3 * 0.20000000298023223876953125);
        ...
        if (var_a0c0a)
        {
            ...
            if (var_f2a9a)
            {
                var_47daf = any(greaterThanEqual(abs(var_3b8a3), vec3(1.0)));
            }
            else
            {
                var_47daf = var_f2a9a;
            ...
            if (var_47daf)
            {
                highp vec3 var_c2195 = var_3b8a3;
                highp vec3 var_3e9f3 = abs(var_3b8a3);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp vec3 var_a56d9 = reflect(normalize(var_a8715 - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_3b8a3);
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_d903a(var_a622c, var_4de16, var_713f8, var_26642);
