...
void main() {
    ...
    if ((((var_2b55b.x + var_2b55b.y) + var_2b55b.z) < 9.9999997473787516355514526367188e-05) && (var_f2797.x > 9.9999997473787516355514526367188e-05))
    {
        ...
        var_c0663 = clamp(vec3(var_9a19a + (var_0bc6f.x * var_0bc6f.w), (var_9a19a * ((((var_9a19a * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_0bc6f.y * var_0bc6f.w), (var_9a19a * (((var_9a19a * var_9a19a) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_0bc6f.z * var_0bc6f.w)), vec3(0.0), vec3(1.0));
    }
    else
    {
        var_c0663 = v_lightColor;
    }
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_409ba(var_f2797, var_33188, var_94c87, var_73e61, var_a3c91, var_6821e, var_8bbda, var_c90aa, var_c2de9, var_39edd, var_c5e74, var_06d9b, var_2eb10, var_a712c);
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_d7f93(var_e318f, var_33188, var_aae12, var_94c87, var_05431, var_15859, var_2b534, var_73e61, var_c2de9, var_39edd, var_c5e74, var_06d9b, var_2eb10, var_6821e, var_a712c);
        var_99cf4 = var_e318f;
        var_819bb = var_aae12;
        var_1cf85 = var_05431;
    }
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_f1037(var_c0663, var_2eb10, var_713f8, var_26642);
