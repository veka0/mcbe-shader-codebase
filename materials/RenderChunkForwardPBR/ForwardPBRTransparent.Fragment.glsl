...
void func_1fbc4(inout highp vec2 arg_ea738, inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_218ea, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_a9fca, inout highp vec2 arg_f36e7, inout highp vec3 arg_81f79, inout highp float arg_d565c, inout highp vec3 arg_58ffc, inout highp vec3 arg_cff01, inout highp float arg_5416d, inout highp float arg_cdb42) {
...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_1fbc4(var_e0a6e, var_aa187, var_2f96b, var_fd99d, var_a3c91, var_23547, var_8bbda, var_0c2c8, var_ea145, var_670e7, var_7ba6a, var_e0d4d, var_0dbe1, var_911cb);
