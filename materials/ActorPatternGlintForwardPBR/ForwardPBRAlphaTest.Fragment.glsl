...
layout(binding = 15, std430) buffer s_zLights { Light zLights[]; } var_336b0;
layout(binding = 14, std430) buffer s_zLightLookupArray { LightData zLightLookupArray[]; } var_dc686;
...
void func_5b6a6(inout int arg_826b5, inout highp float arg_9eee0, inout highp float arg_6b488, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c) {
    if (var_336b0.zLights[arg_826b5].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        arg_6b488 = 1.0;
        return;
    }
    highp vec3 loc_44ea9 = arg_aee55 - var_336b0.zLights[arg_826b5].position.xyz;
    ...
    highp float loc_e670f = (textureLod(s_PointLightShadowTextureArray, vec4(loc_f715f, float(var_336b0.zLights[arg_826b5].shadowProbeIndex)), 0.0).x * 2.0) - 1.0;
...
void func_735c6(inout highp vec4 arg_e84ec, inout int arg_34699, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_ec226, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    highp vec3 loc_a4b3e = var_336b0.zLights[arg_34699].position.xyz - v_worldPos;
    ...
    if (loc_3a449 >= (var_336b0.zLights[arg_34699].position.w * var_336b0.zLights[arg_34699].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_ec226 = vec3(0.0);
    ...
    highp float loc_4c5a5 = loc_3a449 / ((var_336b0.zLights[arg_34699].position.w * var_336b0.zLights[arg_34699].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_336b0.zLights[arg_34699].color.xyz * loc_4217d;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_3a449 / ((var_336b0.zLights[arg_34699].position.w * var_336b0.zLights[arg_34699].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_a011d;
    arg_7f337 = loc_cddfe;
    arg_ec226 = ((var_336b0.zLights[arg_34699].color.xyz * var_336b0.zLights[arg_34699].color.w) * loc_4217d) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_0fcb2(inout bool arg_9a2b4, inout bool arg_b6724, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_33e52, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_fea00, inout highp vec3 arg_5e5a1, inout highp vec3 arg_061f9, inout highp vec4 arg_eac61, inout highp vec3 arg_8f7d6, inout highp vec3 arg_115ae) {
    ...
    {
        int loc_959ae = int(var_dc686.zLightLookupArray[loc_86630].lookup);
        if (loc_959ae < 0)
        {
            break;
        }
        highp vec3 loc_74d8b = normalize((u_view * vec4(var_336b0.zLights[loc_959ae].position.xyz, 1.0)).xyz - arg_fea00);
...
void main() {
    ...
    highp vec4 var_74779 = vec4(var_2b5c5.xyz * var_2b5c5.xyz, abs(var_2b5c5.w)) + vec4(mix((var_24765.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w)), 0.0);
    var_74779.w = var_24765.w;
