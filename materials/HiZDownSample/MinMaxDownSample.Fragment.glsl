...
void main() {
    ...
    highp vec2 var_0bf02 = textureLod(s_PreviousMip, v_texcoord0.xy + (vec2(-0.5) * PreviousMipResolutionAndRecipResolution.zw), MipLevel.x).xy;
    var_5a19e.x = var_0bf02.x;
    var_a035d.x = var_0bf02.y;
    var_0bf02 = textureLod(s_PreviousMip, v_texcoord0.xy + (vec2(0.5, -0.5) * PreviousMipResolutionAndRecipResolution.zw), MipLevel.x).xy;
    var_5a19e.y = var_0bf02.x;
    var_a035d.y = var_0bf02.y;
    var_0bf02 = textureLod(s_PreviousMip, v_texcoord0.xy + (vec2(-0.5, 0.5) * PreviousMipResolutionAndRecipResolution.zw), MipLevel.x).xy;
    var_5a19e.z = var_0bf02.x;
    var_a035d.z = var_0bf02.y;
    var_0bf02 = textureLod(s_PreviousMip, v_texcoord0.xy + (vec2(0.5) * PreviousMipResolutionAndRecipResolution.zw), MipLevel.x).xy;
    var_5a19e.w = var_0bf02.x;
    var_a035d.w = var_0bf02.y;
