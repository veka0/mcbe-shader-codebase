...
void main() {
    ...
    highp vec4 var_104d9 = Data_PS[var_1821c];
                ...
                else
                {
                    ...
                    if (6.0 == float(var_c9987))
                    {
                        ...
                        for (int var_6696c = 0; float(var_6696c) < var_7e301.x; var_6696c++)
                        {
                            ...
                            var_104d9 += ((texture(s_txBuffer, (vec2(var_09c82.x, 1.0 - var_09c82.y) * UVTransform[0].zw) + UVTransform[0].xy) + texture(s_txBuffer, (vec2(var_67347.x, 1.0 - var_67347.y) * UVTransform[0].zw) + UVTransform[0].xy)) * Data_PS[(var_8998a + 3) + (var_6696c / 4)][var_6696c % 4]);
                        }
                    ...
                    else
                    {
                        ...
                        if (7.0 == float(var_c9987))
                        {
                            ...
                            var_e7cba = var_729fe;
                            var_104d9.x = dot(var_729fe, Data_PS[var_8998a + 1]);
                            var_104d9.y = dot(var_729fe, Data_PS[var_8998a + 2]);
                            var_104d9.z = dot(var_729fe, Data_PS[var_8998a + 3]);
                            var_104d9.w = dot(var_729fe, Data_PS[var_8998a + 4]);
                            highp vec4 var_ea70f = var_104d9;
                            highp vec4 var_288d5 = var_ea70f + Data_PS[var_8998a + 5];
                            var_104d9 = var_288d5;
                            highp vec3 var_635fc = var_288d5.xyz;
                            var_104d9.w = mix(((0.2125999927520751953125 * var_635fc.x) + (0.715200006961822509765625 * var_635fc.y)) + (0.072200000286102294921875 * var_635fc.z), var_104d9.w, var_a33c5.z);
                            highp float var_9f710 = var_104d9.w;
                            var_104d9.w = 1.0;
                        ...
                        else
                        {
                            ...
                            if (var_213e3)
                            {
                                ...
                                var_104d9 = vec4(transpose(mat3(vec3(1.164000034332275390625, 0.0, 1.5959999561309814453125), vec3(1.164000034332275390625, -0.3910000026226043701171875, -0.813000023365020751953125), vec3(1.164000034332275390625, 2.0179998874664306640625, 0.0))) * var_2ed72, 1.0);
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    if (19.0 == float(var_c9987))
                                    {
                                        ...
                                        var_104d9 = mix(Data_PS[var_8998a + 1], Data_PS[var_1821c], vec4(clamp(var_3e548 - (var_31273 + var_07a02), 0.0, 1.0))) * clamp(var_3e548 - max(0.0, var_31273 - var_07a02), 0.0, 1.0);
                                    }
                                    else
                                    {
                                        if (var_c9987 == 23)
                                        {
                                            ...
                                            var_104d9 = mix(Data_PS[var_8998a + 1], Data_PS[var_1821c], vec4(smoothstep(var_8fc5c - var_d8e86.x, var_8fc5c + var_d8e86.x, var_b46de))) * var_a2aa7;
                                        }
                                        else
                                        {
                                            if (var_c9987 == 24)
                                            {
                                                ...
                                                var_104d9 = Data_PS[var_1821c] * smoothstep(0.5 - var_333b6.z, 0.5 + var_333b6.z, max(min(var_af28d.x, var_af28d.y), min(max(var_af28d.x, var_af28d.y), var_af28d.z)));
                                            }
                                            else
                                            {
                                                if (var_c9987 == 25)
                                                {
                                                    ...
                                                    var_104d9 = mix(Data_PS[var_8998a + 1], Data_PS[var_1821c], vec4(smoothstep(var_23cd3 - var_5743b.x, var_23cd3 + var_5743b.x, var_10811))) * var_fd049;
                                                }
                                            }
                                        }
                                    }
