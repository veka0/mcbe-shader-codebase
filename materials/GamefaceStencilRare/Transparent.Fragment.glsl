...
void main() {
    ...
    highp vec4 var_0931e = Data_PS[var_fedb0];
    highp float var_241aa;
    if (1 == var_f473b)
    {
        var_241aa = clamp(0.5 - (length(v_ScreenNormalPosition.xy - v_Additional.xy) - var_d6e99.z), 0.0, 1.0);
    }
    else
    {
                ...
                else
                {
                    ...
                    if (6 == var_f473b)
                    {
                        ...
                        for (; var_f6ced < var_825f8; var_2ae5d = var_b2b23, var_f6ced++)
                        {
                            ...
                            var_0931e += ((var_186b3 + var_9c734) * var_b2b23);
                        }
                    ...
                    else
                    {
                        ...
                        if (7 == var_f473b)
                        {
                            ...
                            var_6aac9 = var_729fe;
                            var_0931e.x = dot(var_729fe, Data_PS[var_f469d + 1]);
                            var_0931e.y = dot(var_729fe, Data_PS[var_f469d + 2]);
                            var_0931e.z = dot(var_729fe, Data_PS[var_f469d + 3]);
                            var_0931e.w = dot(var_729fe, Data_PS[var_f469d + 4]);
                            highp vec4 var_ea70f = var_0931e;
                            highp vec4 var_288d5 = var_ea70f + Data_PS[var_f469d + 5];
                            var_0931e = var_288d5;
                            highp vec3 var_5ad70 = var_288d5.xyz;
                            var_0931e.w = mix(clamp(((0.2125999927520751953125 * var_5ad70.x) + (0.715200006961822509765625 * var_5ad70.y)) + (0.072200000286102294921875 * var_5ad70.z), 0.0, 1.0), var_0931e.w, var_376ff.z);
                            highp float var_9f710 = var_0931e.w;
                            var_0931e.w = 1.0;
                            ...
                            else
                            {
                                ...
                                else
                                {
                                    ...
                                    if (19 == var_f473b)
                                    {
                                        ...
                                        var_0931e = mix(Data_PS[var_f469d + 1], Data_PS[var_fedb0], vec4(clamp(var_3e548 - (var_31273 + var_07a02), 0.0, 1.0))) * clamp(var_3e548 - max(0.0, var_31273 - var_07a02), 0.0, 1.0);
                                        var_ed456 = 1.0;
                                    }
                                    else
                                    {
                                        ...
                                        if ((var_f473b == 32) || (var_f473b == 35))
                                        {
                                            ...
                                            if (var_f473b == 35)
                                            {
                                                ...
                                                var_4c7e7 = var_c898c;
                                                var_0931e = texture(s_txBuffer, (var_c898c * UVTransform[0].zw) + UVTransform[0].xy);
                                            }
                                            else
                                            {
                                                var_0931e = texture(s_txBuffer, (vec2(var_4c7e7.x, 1.0 - var_4c7e7.y) * UVTransform[0].zw) + UVTransform[0].xy);
                                            }
                                            if ((var_f1761 & 2) != 0)
                                            {
                                                highp vec3 var_88946 = var_0931e.xyz;
                                                ...
                                                var_0931e = vec4(var_02fa6.x, var_02fa6.y, var_02fa6.z, var_0931e.w);
                                            }
                                            else
                                            {
                                                if ((var_f1761 & 16) != 0)
                                                {
                                                    highp vec3 var_e5842 = var_0931e.xyz;
                                                    ...
                                                    var_0931e = vec4(var_7ac79.x, var_7ac79.y, var_7ac79.z, var_0931e.w);
                                                }
                                            }
                                            var_0931e.w = mix(var_0931e.w, 1.0 - var_0931e.w, float((int(var_376ff.x) & 1) != 0));
                                            highp vec3 var_b21cc = var_0931e.xyz;
                                            var_0931e.w = mix(clamp(((0.2125999927520751953125 * var_b21cc.x) + (0.715200006961822509765625 * var_b21cc.y)) + (0.072200000286102294921875 * var_b21cc.z), 0.0, 1.0), var_0931e.w, var_376ff.z);
                                            var_0931e.w = mix(var_0931e.w, 1.0, float((int(var_376ff.x) & 2) != 0));
                                        ...
                                        else
                                        {
                                            ...
                                            if (var_f473b == 33)
                                            {
                                                ...
                                                var_0931e = texture(s_txBuffer, (((Data_PS[var_f469d + 1].zw * vec2(fract(v_Additional.zw).x, 1.0 - fract(v_Additional.zw).y)) + Data_PS[var_f469d + 1].xy) * UVTransform[0].zw) + UVTransform[0].xy);
                                                if ((var_f1761 & 2) != 0)
                                                {
                                                    highp vec3 var_f2f08 = var_0931e.xyz;
                                                    ...
                                                    var_0931e = vec4(var_87004.x, var_87004.y, var_87004.z, var_0931e.w);
                                                }
                                                else
                                                {
                                                    if ((var_f1761 & 16) != 0)
                                                    {
                                                        highp vec3 var_e3e93 = var_0931e.xyz;
                                                        ...
                                                        var_0931e = vec4(var_ce391.x, var_ce391.y, var_ce391.z, var_0931e.w);
                                                    }
                                                }
                                                var_0931e.w = mix(1.0 - var_0931e.w, var_0931e.w, var_376ff.x);
                                                highp vec3 var_b5c5f = var_0931e.xyz;
                                                var_0931e.w = mix(clamp(((0.2125999927520751953125 * var_b5c5f.x) + (0.715200006961822509765625 * var_b5c5f.y)) + (0.072200000286102294921875 * var_b5c5f.z), 0.0, 1.0), var_0931e.w, var_376ff.z);
                                                var_0931e.w = mix(var_0931e.w, 1.0, var_ea3a1.y);
                                            ...
                                            else
                                            {
                                                ...
                                                if (var_f473b == 23)
                                                {
                                                    ...
                                                    var_0931e = mix(Data_PS[var_f469d + 1], Data_PS[var_fedb0], vec4(smoothstep(var_23cd3 - var_5743b.x, var_23cd3 + var_5743b.x, var_26b24))) * var_fd049;
                                                    var_119dc = 1.0;
                                                }
                                                else
                                                {
                                                    ...
                                                    if (var_f473b == 24)
                                                    {
                                                        ...
                                                        var_0931e = Data_PS[var_fedb0] * smoothstep(0.5 - var_d6e99.z, 0.5 + var_d6e99.z, max(min(var_58b5b.x, var_58b5b.y), min(max(var_58b5b.x, var_58b5b.y), var_58b5b.z)));
                                                        var_33568 = 1.0;
                                                    }
                                                    else
                                                    {
                                                        ...
                                                        if (var_f473b == 25)
                                                        {
                                                            ...
                                                            var_0931e = mix(Data_PS[var_f469d + 1], Data_PS[var_fedb0], vec4(smoothstep(var_60d5d - var_714ab.x, var_60d5d + var_714ab.x, var_bc6ed))) * var_7f653;
                                                            var_8dc78 = 1.0;
                                                        }
                                                        else
                                                        {
                                                            ...
                                                            if (var_f473b == 31)
                                                            {
                                                                ...
                                                                var_0931e = texture(s_txBuffer, (vec2(var_e55bf.x, 1.0 - var_e55bf.y) * UVTransform[0].zw) + UVTransform[0].xy);
                                                                if ((var_f1761 & 2) != 0)
                                                                {
                                                                    highp vec3 var_14c63 = var_0931e.xyz;
                                                                    ...
                                                                    var_0931e = vec4(var_c5d9b.x, var_c5d9b.y, var_c5d9b.z, var_0931e.w);
                                                                }
                                                                else
                                                                {
                                                                    if ((var_f1761 & 16) != 0)
                                                                    {
                                                                        highp vec3 var_37e42 = var_0931e.xyz;
                                                                        ...
                                                                        var_0931e = vec4(var_3c09e.x, var_3c09e.y, var_3c09e.z, var_0931e.w);
                                                                    }
                                                                }
                                                                var_0931e.w = mix(1.0 - var_0931e.w, var_0931e.w, var_376ff.x);
                                                                highp vec3 var_7c508 = var_0931e.xyz;
                                                                var_0931e.w = mix(clamp(((0.2125999927520751953125 * var_7c508.x) + (0.715200006961822509765625 * var_7c508.y)) + (0.072200000286102294921875 * var_7c508.z), 0.0, 1.0), var_0931e.w, var_376ff.z);
                                                                var_0931e.w = mix(var_0931e.w, 1.0, var_ea3a1.y);
    ...
    if ((var_f1761 & 64) != 0)
    {
        highp vec3 var_74485 = var_0931e.xyz * var_0931e.w;
        var_0931e = vec4(var_74485.x, var_74485.y, var_74485.z, var_0931e.w);
    }
    var_e6fcd = var_0931e;
