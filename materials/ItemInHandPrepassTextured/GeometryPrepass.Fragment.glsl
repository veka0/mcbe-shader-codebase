...
void main() {
    ...
    highp vec3 var_2254b = var_7763b.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x));
#endif
#ifdef MULTI_COLOR_TINT__ON
    highp vec3 var_0bba1 = var_7763b.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x));
...
#endif
    highp vec4 var_aa0d3 = vec4(var_2254b.x, var_2254b.y, var_2254b.z, var_7763b.w);
#ifdef MULTI_COLOR_TINT__OFF
    highp vec3 var_189a9 = mix(mix(var_aa0d3, var_aa0d3 * ChangeColor, vec4(var_8b5b4.w)).xyz, OverlayColor.xyz, vec3(OverlayColor.w));
    highp vec4 var_a4120 = vec4(var_189a9.x, var_189a9.y, var_189a9.z, var_7763b.w);
