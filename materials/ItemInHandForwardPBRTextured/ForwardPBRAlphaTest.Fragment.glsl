...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_e3c4e(var_c282b, var_de9aa, var_f1c2e, var_edfc0, var_c8039, var_45daf, var_6e12b);
        highp vec3 var_92517 = var_9fdd6;
        highp vec4 var_3d9d9;
        highp vec3 var_b3e4d;
        highp vec3 var_ef9ba;
        bool var_64e2a;
        func_b7bbd(var_bbdbf, var_b65dc, var_64e2a, var_ef9ba, var_b3e4d, var_3d9d9, var_92517, var_1f150, var_9fdd6, var_f1c2e, var_45daf, var_6e12b, var_e1b04);
    ...
    bgfx_FragData[0] = vec4(var_51cd7.x, var_51cd7.y, var_51cd7.z, vec4(var_f570b, var_f570b, var_f570b, var_714e6.w * var_04b6d.w).w);
