...
layout(binding = 8, std430) buffer s_GpuEntryBuffer { GpuVolumeEntry GpuEntryBuffer[]; } var_7376b;
#ifdef POINT_LIGHT_SHADING__ON
layout(binding = 12, std430) buffer s_zLights { Light zLights[]; } var_9106f;
...
void func_daa30(inout int arg_7070b, inout highp float arg_43b7a, inout highp float arg_9499a, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c, inout highp float arg_77c90) {
    ...
    highp vec3 loc_8868e = arg_aee55 - var_9106f.zLights[arg_7070b].position.xyz;
    ...
    highp vec4 loc_87a38 = var_9106f.zLights[arg_7070b].shadowFaceUV0;
    highp vec3 loc_baa89;
    if (loc_f3fad == 1)
    {
        loc_87a38 = var_9106f.zLights[arg_7070b].shadowFaceUV1;
    ...
    else
    {
        ...
        if (loc_f3fad == 2)
        {
            loc_87a38 = var_9106f.zLights[arg_7070b].shadowFaceUV2;
        ...
        else
        {
            ...
            if (loc_f3fad == 3)
            {
                loc_87a38 = var_9106f.zLights[arg_7070b].shadowFaceUV3;
            ...
            else
            {
                ...
                if (loc_f3fad == 4)
                {
                    loc_87a38 = var_9106f.zLights[arg_7070b].shadowFaceUV4;
                ...
                else
                {
                    ...
                    if (loc_f3fad == 5)
                    {
                        loc_87a38 = var_9106f.zLights[arg_7070b].shadowFaceUV5;
...
void func_9be38(inout highp vec4 arg_e84ec, inout int arg_9327a, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_0a2b9, inout highp vec3 arg_f6a53, inout highp vec3 arg_4f9dc, inout highp float arg_8bccf) {
    ...
    highp vec3 loc_a4b3e = var_9106f.zLights[arg_9327a].position.xyz - v_worldPos;
    ...
    if (loc_9eb1a >= (var_9106f.zLights[arg_9327a].position.w * var_9106f.zLights[arg_9327a].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_0a2b9 = vec3(0.0);
    ...
    highp float loc_4c5a5 = loc_9eb1a / ((var_9106f.zLights[arg_9327a].position.w * var_9106f.zLights[arg_9327a].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_9106f.zLights[arg_9327a].color.xyz * loc_219c5;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_9eb1a / ((var_9106f.zLights[arg_9327a].position.w * var_9106f.zLights[arg_9327a].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_a011d;
    arg_7f337 = loc_cddfe;
    arg_0a2b9 = (var_9106f.zLights[arg_9327a].color.xyz * var_9106f.zLights[arg_9327a].color.w) * loc_219c5;
}
void func_8c92a(inout highp vec3 arg_33c3b, inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec4 arg_fadf1, inout highp vec3 arg_efe4b, inout highp vec3 arg_81f79, inout highp float arg_d565c, inout highp vec3 arg_58ffc, inout highp vec3 arg_cff01, inout highp float arg_5416d, inout highp vec3 arg_5a8cd, inout highp vec3 arg_4fa31, inout highp float arg_9502a) {
    ...
    for (int loc_86630 = loc_490eb; loc_86630 < loc_c476d; loc_b9311 = loc_bfd6d, loc_45a05 = loc_50935, loc_a55d6 = loc_96e3a, loc_86630++)
    {
        ...
        highp vec3 loc_ed90f = normalize((u_view * vec4(var_9106f.zLights[loc_4d5d9].position.xyz, 1.0)).xyz - arg_33c3b);
...
void main() {
    ...
    highp vec3 var_3c004 = var_e14aa.xyz;
    highp vec3 var_cde66 = (u_view * var_e14aa).xyz;
    highp vec3 var_c1070 = vec3(0.039999999105930328369140625 * (1.0 - var_d66f6)) + (var_b8af5 * var_d66f6);
    ...
    highp vec4 var_5b71e = vec4(var_bc571, 0.0);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        highp float var_11a4a = var_5e5e9 * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        ...
        func_634be(var_f6f76, var_357df, var_cde66, var_b5d88, var_3c004, var_6cfc2, var_b82c9, var_9823f, var_d2dca, var_c1070, var_b8af5, var_d66f6, var_11a4a);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_95aa8(var_e318f, var_f6f76, var_aae12, var_357df, var_05431, var_6aed3, var_0daae, var_cde66, var_9823f, var_d2dca, var_c1070, var_b8af5, var_d66f6, var_3c004, var_11a4a);
        var_98bf2 = var_e318f;
#endif
    ...
    if ((DirectionalLightToggleAndMaxDistanceAndMaxCascadesPerLightAndGPUBlockLightingEnabled.w != 0.0) && (!((var_9c6ab & 1u) != 0u)))
    {
        ...
        for (;;)
        {
            if (var_d6224 < 8)
            {
                uint var_a70f2 = uint(var_7376b.GpuEntryBuffer[var_3af73].hash) & 65535u;
                bool var_734de = var_a70f2 == var_19109;
                bool var_e4213;
                if (var_734de)
                {
                    var_e4213 = var_7376b.GpuEntryBuffer[var_3af73].packed_xy == var_ab334;
                }
                else
                {
                    var_e4213 = var_734de;
                ...
                if (var_e4213)
                {
                    var_ec5a7 = var_7376b.GpuEntryBuffer[var_3af73].packed_zw == var_76717;
                }
                else
                {
                    var_ec5a7 = var_e4213;
                ...
                else
                {
                    ...
                    if (var_ec5a7)
                    {
                        var_5ebd4 = uint(var_7376b.GpuEntryBuffer[var_3af73].user_data);
                    }
                    else
                    {
                        var_5ebd4 = var_8e0b6;
        ...
        if (var_a0c0a)
        {
            ...
            if (var_f2a9a)
            {
                var_47daf = any(greaterThanEqual(abs(var_3c004), vec3(1.0)));
            }
            else
            {
                var_47daf = var_f2a9a;
            ...
            if (var_47daf)
            {
                highp vec3 var_c2195 = var_3c004;
                highp vec3 var_3e9f3 = abs(var_3c004);
...
#ifdef POINT_LIGHT_SHADING__ON
    highp vec3 var_12456 = var_a3223.xyz + (mix((((((var_b8af5 * (1.0 - var_d66f6)) * max(((var_d1d0a + (var_02fd0.xyz * var_b63c1.w)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_123aa * var_123aa) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_21a19.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_98bf2) + var_f5e5a) + (((mix(var_b8af5, vec3(dot(var_b8af5, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_83057)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_025c1.xyz, vec3(var_0343d.w)) * var_c88f4.w);
#endif
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp vec3 var_a56d9 = reflect(normalize(var_a8715 - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_3c004);
        highp float var_0f441;
        if (int(ConvolutionType.x) == 1)
        {
            highp float var_9a0e5 = 1.0 - var_d2dca;
            var_0f441 = (1.0 - (var_9a0e5 * var_9a0e5)) * (IBLParameters.y - 1.0);
        }
        else
        {
            highp float var_c17b7 = 1.0 - var_d2dca;
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_d903a(var_5b71e, var_d66f6, var_713f8, var_26642);
        ...
        highp vec2 var_dea35 = vec2(clamp(dot(var_cde66, -normalize(var_dd3fd)), 0.0, 1.0), var_d2dca);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_769bb(var_5b71e, var_d66f6, var_da70a);
            highp vec2 var_c297e = vec2(clamp(dot(var_cde66, -normalize(var_21df9)), 0.0, 1.0), var_d2dca);
...
#ifdef POINT_LIGHT_SHADING__OFF
    highp vec3 var_54609 = vec4(var_a3223.xyz + (mix((((((var_b8af5 * (1.0 - var_d66f6)) * max((var_d1d0a * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_123aa * var_123aa) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_21a19.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_98bf2) + var_f5e5a) + (((mix(var_b8af5, vec3(dot(var_b8af5, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_83057)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_025c1.xyz, vec3(var_0343d.w)) * var_c88f4.w), 1.0).xyz + var_082f4;
#endif
#ifdef POINT_LIGHT_SHADING__ON
