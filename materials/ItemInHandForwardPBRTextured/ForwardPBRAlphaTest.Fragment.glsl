...
#endif
float var_33fae;
layout(binding = 9, std430) buffer s_PBRData { PBRTextureData PBRData[]; } var_e93c0;
layout(binding = 10, std430) buffer s_VoxelBuffer { VoxelNode VoxelBuffer[]; } var_15e90;
layout(binding = 8, std430) buffer s_GpuEntryBuffer { GpuVolumeEntry GpuEntryBuffer[]; } var_a42db;
#ifdef POINT_LIGHT_SHADING__ON
layout(binding = 12, std430) buffer s_zLights { Light zLights[]; } var_688b5;
layout(binding = 11, std430) buffer s_zLightLookupArray { LightData zLightLookupArray[]; } var_0ff9a;
#endif
...
void func_89801(inout highp float arg_6a625, inout highp float arg_9eee0, inout highp float arg_a50e1, inout highp float arg_d2a5b, inout highp vec3 arg_2dec6) {
    ...
    highp vec2 loc_e8046 = vec2(var_e93c0.PBRData[v_pbrTextureId].colourToNormalUvScale0, var_e93c0.PBRData[v_pbrTextureId].colourToNormalUvScale1);
    highp vec2 loc_3128d = vec2(var_e93c0.PBRData[v_pbrTextureId].colourToNormalUvBias0, var_e93c0.PBRData[v_pbrTextureId].colourToNormalUvBias1);
    highp vec3 loc_b4ff6;
    if ((var_e93c0.PBRData[v_pbrTextureId].flags & 4) == 4)
    {
    ...
    else
    {
        ...
        if ((var_e93c0.PBRData[v_pbrTextureId].flags & 8) == 8)
        {
            highp vec2 loc_218fe = (v_texcoord0 * loc_e8046) + loc_3128d;
            highp vec3 loc_2ae5f = vec3(0.0, 0.0, 1.0);
            highp float loc_b88fd = clamp((min(var_e93c0.PBRData[v_pbrTextureId].maxMipNormal - var_e93c0.PBRData[v_pbrTextureId].maxMipColour, var_e93c0.PBRData[v_pbrTextureId].maxMipNormal) * (-1.0)) + 2.0, 0.0, 1.0);
            if (loc_b88fd > 0.0)
            {
        ...
        else
        {
            ...
            if ((var_e93c0.PBRData[v_pbrTextureId].flags & 16) == 16)
            {
                highp vec2 loc_268f9 = (v_texcoord0 * loc_e8046) + loc_3128d;
                highp float loc_d849b = min(var_e93c0.PBRData[v_pbrTextureId].maxMipNormal - var_e93c0.PBRData[v_pbrTextureId].maxMipColour, var_e93c0.PBRData[v_pbrTextureId].maxMipNormal);
    ...
    if ((var_e93c0.PBRData[v_pbrTextureId].flags & 1) == 1)
    {
        highp vec4 loc_300fb = texture(s_MatTexture, (v_texcoord0 * vec2(var_e93c0.PBRData[v_pbrTextureId].colourToMaterialUvScale0, var_e93c0.PBRData[v_pbrTextureId].colourToMaterialUvScale1)) + vec2(var_e93c0.PBRData[v_pbrTextureId].colourToMaterialUvBias0, var_e93c0.PBRData[v_pbrTextureId].colourToMaterialUvBias1));
        highp float loc_c4db1;
        if ((var_e93c0.PBRData[v_pbrTextureId].flags & 2) == 2)
        {
            loc_c4db1 = loc_300fb.w;
        }
        else
        {
            loc_c4db1 = var_e93c0.PBRData[v_pbrTextureId].uniformSubsurface;
        }
        loc_d7d8a = loc_c4db1;
    ...
    {
        loc_d7d8a = var_e93c0.PBRData[v_pbrTextureId].uniformSubsurface;
        loc_00c14 = var_e93c0.PBRData[v_pbrTextureId].uniformEmissive;
        loc_73c14 = var_e93c0.PBRData[v_pbrTextureId].uniformMetalness;
        loc_659d6 = var_e93c0.PBRData[v_pbrTextureId].uniformRoughness;
    }
...
void func_daa30(inout int arg_7070b, inout highp float arg_43b7a, inout highp float arg_9499a, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c, inout highp float arg_77c90) {
    ...
    highp vec3 loc_8868e = arg_aee55 - var_688b5.zLights[arg_7070b].position.xyz;
    ...
    highp vec4 loc_87a38 = var_688b5.zLights[arg_7070b].shadowFaceUV0;
    highp vec3 loc_baa89;
    if (loc_f3fad == 1)
    {
        loc_87a38 = var_688b5.zLights[arg_7070b].shadowFaceUV1;
    ...
    else
    {
        ...
        if (loc_f3fad == 2)
        {
            loc_87a38 = var_688b5.zLights[arg_7070b].shadowFaceUV2;
        ...
        else
        {
            ...
            if (loc_f3fad == 3)
            {
                loc_87a38 = var_688b5.zLights[arg_7070b].shadowFaceUV3;
            ...
            else
            {
                ...
                if (loc_f3fad == 4)
                {
                    loc_87a38 = var_688b5.zLights[arg_7070b].shadowFaceUV4;
                ...
                else
                {
                    ...
                    if (loc_f3fad == 5)
                    {
                        loc_87a38 = var_688b5.zLights[arg_7070b].shadowFaceUV5;
...
void func_8e599(inout int arg_2f7cd, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_0a2b9, inout highp vec3 arg_f6a53, inout highp vec3 arg_4f9dc, inout highp float arg_8bccf) {
    ...
    highp vec3 loc_a4b3e = var_688b5.zLights[arg_2f7cd].position.xyz - v_worldPos;
    ...
    if (loc_16a27 >= (var_688b5.zLights[arg_2f7cd].position.w * var_688b5.zLights[arg_2f7cd].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_0a2b9 = vec3(0.0);
    ...
    highp float loc_4c5a5 = loc_16a27 / ((var_688b5.zLights[arg_2f7cd].position.w * var_688b5.zLights[arg_2f7cd].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    arg_43b7a = loc_22c1c;
    arg_7f337 = loc_a011d;
    arg_0a2b9 = (var_688b5.zLights[arg_2f7cd].color.xyz * var_688b5.zLights[arg_2f7cd].color.w) * loc_ae18a;
}
void func_4fd11(inout highp vec3 arg_33c3b, inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_efe4b, inout highp vec3 arg_81f79, inout highp float arg_d565c, inout highp vec3 arg_58ffc, inout highp vec3 arg_cff01, inout highp float arg_5416d, inout highp vec3 arg_3ec33, inout highp vec3 arg_8f7d6, inout highp float arg_a6fcb) {
    bool loc_a0bb1;
    int loc_5afa9;
    int loc_3379d;
    ...
    {
        int loc_95ec7 = int(var_0ff9a.zLightLookupArray[loc_6165e].lookup);
        if (loc_95ec7 < 0)
        {
            break;
        }
        highp vec3 loc_ed90f = normalize((u_view * vec4(var_688b5.zLights[loc_95ec7].position.xyz, 1.0)).xyz - arg_33c3b);
        ...
        loc_334a8 = loc_15ce8 + (((((((vec3(1.0) - loc_d5257) * mix(loc_1e1bf, max((dot(arg_efe4b, loc_ed90f) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_2d61b * loc_2d61b), 0.0), arg_a6fcb)) * (loc_b92e1 * vec3(0.3183098733425140380859375))) * loc_f5fea) + (((loc_b92e1 * vec3(0.3183098733425140380859375)) * (arg_a6fcb * max((dot(-arg_efe4b, loc_ed90f) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_c20a0 * loc_c20a0), 0.0))) * loc_458ab)) * loc_94598) * DiffuseSpecularEmissiveAmbientTermToggles.x);
...
void func_2dd06(inout highp vec3 arg_6cd76, inout highp vec3 arg_3aadd, inout highp vec3 arg_acc5b, inout highp vec3 arg_82655, inout highp vec3 arg_b40e7, inout highp vec3 arg_83a50, inout highp vec3 arg_f0c09, inout highp vec3 arg_f55d7, inout highp float arg_06c95, inout highp vec3 arg_96ff7, inout highp vec3 arg_cc5db, inout highp float arg_cc50b, inout highp vec3 arg_7d49a, inout highp float arg_39aac) {
    if (!(DirectionalShadowModeAndCloudShadowToggleAndPointLightToggle.z != 0.0))
    {
        arg_6cd76 = arg_3aadd;
        arg_acc5b = arg_82655;
    ...
    highp vec3 loc_2ce88;
    highp vec3 loc_0423f;
    func_4fd11(arg_83a50, loc_0423f, loc_2ce88, arg_f0c09, arg_f55d7, arg_06c95, arg_96ff7, arg_cc5db, arg_cc50b, loc_0424a, arg_7d49a, arg_39aac);
    arg_6cd76 = arg_3aadd + (loc_0423f * (1.0 - TransitioningAmbientScalar.x));
    arg_acc5b = arg_82655 + (loc_2ce88 * (1.0 - TransitioningAmbientScalar.x));
}
#endif
void func_33953(inout uint arg_a601e, inout highp vec3 arg_aa7d7) {
    if (var_15e90.VoxelBuffer[arg_a601e].data == 0u)
    {
        arg_aa7d7 = vec3(0.0);
        return;
    }
    highp vec4 loc_11fc1 = vec4(uvec4(var_15e90.VoxelBuffer[arg_a601e].data, var_15e90.VoxelBuffer[arg_a601e].data >> 8u, var_15e90.VoxelBuffer[arg_a601e].data >> 16u, var_15e90.VoxelBuffer[arg_a601e].data >> 24u) & uvec4(255u)) * vec4(0.0039215688593685626983642578125);
...
void func_593c8(inout highp vec3 arg_ca7c6, inout highp vec3 arg_951a8, inout uint arg_2632b, inout highp vec3 arg_e5233) {
    ...
    {
        if (!((var_15e90.VoxelBuffer[arg_2632b + 4096u].data & (1u << uint(var_7138c[loc_fa0d5]))) != 0u))
        {
            arg_e5233 = vec3(0.0);
            return;
        }
        uvec3 loc_441ec = uvec3(arg_ca7c6 - (floor(arg_ca7c6 * 0.0625) * 16.0)) & uvec3(15u);
        loc_58bb3 = (var_15e90.VoxelBuffer[(arg_2632b + 4097u) + uint(var_7138c[loc_fa0d5])].data >> 2u) + ((loc_441ec.y + (loc_441ec.z * 16u)) + (loc_441ec.x * 256u));
    }
...
void func_769bb(inout highp vec4 arg_d4081, inout highp float arg_19032, inout highp vec4 arg_85834) {
    highp vec3 loc_94d26 = (arg_d4081.xyz * BlockBaseAmbientLightColorIntensity.w) * BlockLightIndirectSpecularIntensity.x;
    highp vec3 loc_4c5f3 = mix(AmbientLightParams.xyz * AmbientLightParams.w, loc_94d26, vec3(clamp(dot(loc_94d26, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875)), 0.0, 1.0))) * arg_19032;
...
void main() {
    ...
    highp vec4 var_00f80 = vec4(var_f9ddb.x, var_f9ddb.y, var_f9ddb.z, var_0d9b4.w);
#endif
#ifdef MULTI_COLOR_TINT__OFF
    ...
    highp vec4 var_00f80 = vec4(var_99f3c.x, var_99f3c.y, var_99f3c.z, var_0d9b4.w);
#endif
    ...
    if (var_ab7ce || (var_00f80.w < 0.5))
    {
        discard;
    }
    highp vec3 var_3e08d;
    func_66b9c(var_3e08d, var_00f80);
    highp vec3 var_d2ce2;
    highp float var_5e5e9;
    highp float var_b5039;
    highp float var_6245d;
    highp float var_c1af9;
    func_89801(var_c1af9, var_6245d, var_b5039, var_5e5e9, var_d2ce2);
    ...
    highp vec3 var_d5e8a = (var_219ab + (var_fddd0 - (var_322a5 * dot(var_fddd0, var_322a5)))) + WorldOrigin.xyz;
    highp vec3 var_f783d = var_e14aa.xyz;
    highp vec3 var_3ad69 = (u_view * var_e14aa).xyz;
    highp vec3 var_2266d = vec3(0.039999999105930328369140625 * (1.0 - var_c1af9)) + (var_3e08d * var_c1af9);
    ...
    highp vec3 var_48867;
    highp vec3 var_1163d;
    highp vec3 var_e51b8;
    highp vec3 var_f7210;
    if (var_5bd0a.z != 1.0)
    {
        highp vec3 var_dfcb4 = -(var_86c43 / vec3(length(var_86c43) + 9.9999997473787516355514526367188e-05));
        highp float var_de864 = var_5e5e9 * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        highp vec3 var_6cfc2 = var_86c43;
        ...
        highp vec3 var_59d8b;
        highp vec3 var_57594;
        func_634be(var_57594, var_59d8b, var_3ad69, var_b5d88, var_f783d, var_6cfc2, var_b82c9, var_dfcb4, var_6245d, var_2266d, var_3e08d, var_c1af9, var_de864);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec3 var_0edfc;
        highp vec3 var_3cf91;
        func_2dd06(var_3cf91, var_57594, var_0edfc, var_59d8b, var_d5e8a, var_86c43, var_3ad69, var_dfcb4, var_6245d, var_2266d, var_3e08d, var_c1af9, var_f783d, var_de864);
#endif
...
#endif
        {
            highp vec3 var_36ee9 = ((v_worldPos - WorldOrigin.xyz) - vec3(0.5)) + (var_f783d * 0.20000000298023223876953125);
            ...
            for (;;)
            {
                if (var_4bfc3 < 8)
                {
                    uint var_b3275 = uint(var_a42db.GpuEntryBuffer[var_1bd82].hash) & 65535u;
                    bool var_079e7 = var_b3275 == var_0b021;
                    bool var_88b02;
                    if (var_079e7)
                    {
                        var_88b02 = var_a42db.GpuEntryBuffer[var_1bd82].packed_xy == var_8282d;
                    }
                    else
                    {
                        var_88b02 = var_079e7;
                    ...
                    if (var_88b02)
                    {
                        var_4f663 = var_a42db.GpuEntryBuffer[var_1bd82].packed_zw == var_db019;
                    }
                    else
                    {
                        var_4f663 = var_88b02;
                    ...
                    else
                    {
                        ...
                        if (var_4f663)
                        {
                            var_fbc90 = uint(var_a42db.GpuEntryBuffer[var_1bd82].user_data);
                        }
                        else
                        {
                            var_fbc90 = var_e4d40;
            ...
            if (var_4680b)
            {
                ...
                if (var_cdbb7)
                {
                    var_32d93 = any(greaterThanEqual(abs(var_f783d), vec3(1.0)));
                }
                else
                {
                    var_32d93 = var_cdbb7;
                ...
                if (var_32d93)
                {
                    highp vec3 var_523e6 = var_f783d;
                    highp vec3 var_34a44 = abs(var_f783d);
        ...
        {
            var_b9249 = var_a8c9c.xyz;
        }
        highp vec4 var_3df32 = SkyAmbientLightColorIntensity;
        highp float var_fc65f = TileLightIntensity.y * TileLightIntensity.y;
#ifdef POINT_LIGHT_SHADING__ON
        var_f7210 = var_3cf91;
#endif
#ifdef POINT_LIGHT_SHADING__OFF
        ...
        var_e51b8 = var_59d8b;
#endif
        var_1163d = ((var_3e08d * (1.0 - var_c1af9)) * max((var_b9249 * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_fc65f * var_fc65f) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_3df32.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w;
        var_48867 = ((mix(var_3e08d, vec3(dot(var_3e08d, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_b5039)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x;
    }
    else
    {
        var_f7210 = vec3(0.0);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        {
            var_dd3fd = (u_view * vec4(var_d5e8a, 1.0)).xyz;
            var_a8715 = var_d5e8a;
        }
        else
        {
        ...
        highp vec3 var_a56d9 = reflect(normalize(var_a8715 - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_f783d);
        highp float var_0f441;
        if (int(ConvolutionType.x) == 1)
        {
            highp float var_9a0e5 = 1.0 - var_6245d;
            var_0f441 = (1.0 - (var_9a0e5 * var_9a0e5)) * (IBLParameters.y - 1.0);
        }
        else
        {
            highp float var_c17b7 = 1.0 - var_6245d;
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_d903a(var_a8c9c, var_c1af9, var_713f8, var_26642);
        ...
        highp vec2 var_dea35 = vec2(clamp(dot(var_3ad69, -normalize(var_dd3fd)), 0.0, 1.0), var_6245d);
        var_dea35.y = 1.0 - var_dea35.y;
        highp vec2 var_7d2be = texture(s_BrdfLUT, var_dea35).xy;
        highp vec3 var_fe0f6 = var_da3af * ((var_2266d * var_7d2be.x) + vec3(var_7d2be.y));
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            if (QuantizationParameters.w > 0.0)
            {
                var_21df9 = (u_view * vec4(var_d5e8a, 1.0)).xyz;
            }
            else
            {
                var_21df9 = var_86c43;
            ...
            func_769bb(var_a8c9c, var_c1af9, var_da70a);
            highp vec2 var_c297e = vec2(clamp(dot(var_3ad69, -normalize(var_21df9)), 0.0, 1.0), var_6245d);
            var_c297e.y = 1.0 - var_c297e.y;
            highp vec2 var_864a0 = texture(s_BrdfLUT, var_c297e).xy;
            var_e2657 = var_da70a.xyz * ((var_2266d * var_864a0.x) + vec3(var_864a0.y));
        }
        else
        {
            var_e2657 = vec3(0.0);
    ...
    highp vec3 var_edfc1 = vec4(var_bde45.xyz + (mix(((var_1163d + var_f7210) + var_e51b8) + var_48867, var_164a6.xyz, vec3(var_45187.w)) * var_063c9.w), 1.0).xyz + var_083e8;
    ...
    var_96bda = var_cd007;
    bgfx_FragData0 = vec4(var_d523d, var_00f80.w);
