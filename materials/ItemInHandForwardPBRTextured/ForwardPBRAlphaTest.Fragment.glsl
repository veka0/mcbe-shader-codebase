...
void main() {
    ...
    highp float var_8a88b;
    highp float var_6f25b;
    func_c1ba0(var_6f25b, var_8a88b, var_3d822, var_5e5e9, var_89d26);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_2accd(var_7a98e, var_c2621, var_c4126, var_d7db8, var_5e4ab, var_6cfc2, var_29002, var_53f62, var_8a88b, var_cac1d, var_1c679, var_6f25b, var_83276);
        ...
        func_f8e98(var_bf718, var_5423d, var_bb1ac, var_da80f, var_e4833, var_cdcc9, var_a6bd2, var_d0f2d, var_c4126, var_53f62, var_8a88b, var_cac1d, var_1c679, var_6f25b, var_83276, var_d7db8, var_5e4ab);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        {
            highp float var_9a0e5 = 1.0 - var_8a88b;
            var_0f441 = (1.0 - (var_9a0e5 * var_9a0e5)) * (IBLParameters.y - 1.0);
        }
        else
        {
            highp float var_c17b7 = 1.0 - var_8a88b;
        ...
        highp vec2 var_280ac = vec2(clamp(dot(var_c4126, -(var_d0f2d / vec3(var_27d11))), 0.0, 1.0), var_8a88b);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            highp vec2 var_dcda4 = vec2(clamp(dot(var_c4126, -(var_d0f2d / vec3(var_27d11))), 0.0, 1.0), var_8a88b);
