...
void main() {
    ...
    highp vec4 var_159b5 = vec4(var_f9ddb.x, var_f9ddb.y, var_f9ddb.z, var_3801b.w);
#endif
    ...
    highp vec4 var_159b5 = vec4(var_99f3c.x, var_99f3c.y, var_99f3c.z, var_3801b.w);
#endif
    if (var_159b5.w < 0.5)
    {
        discard;
