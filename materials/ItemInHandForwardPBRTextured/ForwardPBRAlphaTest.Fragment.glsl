...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_011b2(var_211cd, var_c7b8f, var_26b5f, var_f49d3, var_a7d68, var_b7ced, var_e0782, var_b626c);
        highp vec3 var_8bbda = var_81d72;
        highp vec4 var_9536d;
        highp vec3 var_62261;
        highp vec3 var_7aa4c;
        bool var_c0cc5;
        func_5ab89(var_25152, var_f4e52, var_c0cc5, var_7aa4c, var_62261, var_9536d, var_8bbda, var_bed13, var_81d72, var_26b5f, var_e0782, var_b626c, var_f49d3, var_4d6b6);
