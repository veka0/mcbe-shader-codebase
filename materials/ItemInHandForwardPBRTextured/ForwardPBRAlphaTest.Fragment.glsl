...
void main() {
...
#ifdef MULTI_COLOR_TINT__OFF
    highp vec3 var_df222 = pow(max(var_abd27.xyz * v_color0.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
#endif
#ifdef MULTI_COLOR_TINT__ON
    highp vec3 var_df222 = pow(max(var_0f504.xyz * v_color0.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
#endif
    highp vec3 var_89d26;
    highp float var_48756;
    highp float var_62adf;
    highp float var_a1a5d;
    highp float var_08b15;
    func_c1ba0(var_08b15, var_a1a5d, var_62adf, var_48756, var_89d26);
    ...
    highp vec3 var_22e87 = vec3(0.039999999105930328369140625 * (1.0 - var_08b15)) + (var_df222 * var_08b15);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_c423e(var_7a98e, var_c2621, var_0c2a0, var_c8e4d, var_b1992, var_84dfb, var_29002, var_2bfc1, var_a1a5d, var_22e87, var_df222, var_08b15, var_edbf2);
        highp vec3 var_23d9a = var_6fbeb;
        highp vec4 var_8fd40;
        highp vec3 var_fa062;
        highp vec3 var_38603;
        bool var_902e5;
        func_92124(var_512b6, var_c0bfd, var_902e5, var_38603, var_fa062, var_8fd40, var_23d9a, var_d70da, var_6fbeb, var_0c2a0, var_2bfc1, var_a1a5d, var_22e87, var_df222, var_08b15, var_edbf2, var_c8e4d, var_b1992);
    ...
    highp vec4 var_64cae = var_9a0a9;
    ...
    highp vec3 var_8417f = (((((var_df222 * (1.0 - var_08b15)) * max(((clamp(vec3(var_2670b + (var_64cae.x * var_64cae.w), (var_2670b * ((((var_2670b * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_64cae.y * var_64cae.w), (var_2670b * (((var_2670b * var_2670b) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_64cae.z * var_64cae.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_ebff3) + ((SkyAmbientLightColorIntensity.xyz * mix((var_b762f * var_b762f) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_d4cc2.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_45cfc) + var_39e4b) + (((mix(var_df222, vec3(dot(var_df222, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_62adf)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_619f7(var_08b15, var_84ff0, var_617d6);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_f46e7(var_08b15, var_6eb02);
