...
void main() {
    ...
    highp vec4 var_5351b = vec4(var_f9ddb.x, var_f9ddb.y, var_f9ddb.z, var_48e86.w);
#endif
    ...
    highp vec4 var_5351b = vec4(var_99f3c.x, var_99f3c.y, var_99f3c.z, var_48e86.w);
#endif
    if (var_5351b.w < 0.5)
    {
        discard;
    ...
    if (!var_7320a)
    {
        highp vec3 var_d5484 = var_5351b.xyz * v_color0.xyz;
        var_5351b = vec4(var_d5484.x, var_d5484.y, var_d5484.z, var_5351b.w);
        var_5351b.w *= var_1e556.w;
    }
    highp vec3 var_c9532;
    func_66b9c(var_c9532, var_5351b);
    ...
    var_96bda = var_cd007;
    bgfx_FragData0 = vec4(var_d523d, var_5351b.w);
