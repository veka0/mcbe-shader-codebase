...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_2c95e(var_f6f76, var_357df, var_cde66, var_b5d88, var_62f02, var_6cfc2, var_b82c9, var_9823f, var_d2dca, var_c1070, var_b8af5, var_d66f6, var_11a4a);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_d7f93(var_e318f, var_f6f76, var_aae12, var_357df, var_05431, var_6aed3, var_0daae, var_cde66, var_9823f, var_d2dca, var_c1070, var_b8af5, var_d66f6, var_62f02, var_11a4a);
        var_98bf2 = var_e318f;
#endif
    ...
    highp vec4 var_a7452 = var_5b71e;
