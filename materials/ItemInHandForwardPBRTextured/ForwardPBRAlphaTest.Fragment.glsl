...
void func_c1ba0(inout highp float arg_6a625, inout highp float arg_9eee0, inout highp float arg_a50e1, inout highp float arg_d2a5b, inout highp vec3 arg_2dec6) {
    ...
    highp vec2 loc_59055 = vec2(var_907b9.PBRData[v_pbrTextureId].colourToNormalUvScale0, var_907b9.PBRData[v_pbrTextureId].colourToNormalUvScale1);
    highp vec2 loc_39ca3 = vec2(var_907b9.PBRData[v_pbrTextureId].colourToNormalUvBias0, var_907b9.PBRData[v_pbrTextureId].colourToNormalUvBias1);
    highp vec3 loc_b4ff6;
    if ((var_907b9.PBRData[v_pbrTextureId].flags & 4) == 4)
    {
    ...
    else
    {
        ...
        if ((var_907b9.PBRData[v_pbrTextureId].flags & 8) == 8)
        {
            highp vec2 loc_218fe = (v_texcoord0 * loc_59055) + loc_39ca3;
            highp vec3 loc_2ae5f = vec3(0.0, 0.0, 1.0);
            highp float loc_b88fd = clamp((min(var_907b9.PBRData[v_pbrTextureId].maxMipNormal - var_907b9.PBRData[v_pbrTextureId].maxMipColour, var_907b9.PBRData[v_pbrTextureId].maxMipNormal) * (-1.0)) + 2.0, 0.0, 1.0);
            if (loc_b88fd > 0.0)
            {
    ...
    if ((var_907b9.PBRData[v_pbrTextureId].flags & 1) == 1)
    {
        highp vec4 loc_300fb = texture(s_MatTexture, (v_texcoord0 * vec2(var_907b9.PBRData[v_pbrTextureId].colourToMaterialUvScale0, var_907b9.PBRData[v_pbrTextureId].colourToMaterialUvScale1)) + vec2(var_907b9.PBRData[v_pbrTextureId].colourToMaterialUvBias0, var_907b9.PBRData[v_pbrTextureId].colourToMaterialUvBias1));
        highp float loc_c4db1;
        if ((var_907b9.PBRData[v_pbrTextureId].flags & 2) == 2)
        {
            loc_c4db1 = loc_300fb.w;
        }
        else
        {
            loc_c4db1 = var_907b9.PBRData[v_pbrTextureId].uniformSubsurface;
        }
        loc_d7d8a = loc_c4db1;
    ...
    {
        loc_d7d8a = var_907b9.PBRData[v_pbrTextureId].uniformSubsurface;
        loc_00c14 = var_907b9.PBRData[v_pbrTextureId].uniformEmissive;
        loc_73c14 = var_907b9.PBRData[v_pbrTextureId].uniformMetalness;
        loc_659d6 = var_907b9.PBRData[v_pbrTextureId].uniformRoughness;
    }
...
void main() {
...
#ifdef MULTI_COLOR_TINT__OFF
    highp vec3 var_81228 = pow(max(var_abd27.xyz * v_color0.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
#endif
#ifdef MULTI_COLOR_TINT__ON
    highp vec3 var_81228 = pow(max(var_0f504.xyz * v_color0.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
#endif
    highp vec3 var_d2ce2;
    highp float var_5e5e9;
    highp float var_f810b;
    highp float var_8e899;
    highp float var_024d3;
    func_c1ba0(var_024d3, var_8e899, var_f810b, var_5e5e9, var_d2ce2);
    ...
    highp vec3 var_c1d82 = normalize(var_d2ce2);
    ...
    highp vec3 var_1f10d = vec3(0.039999999105930328369140625 * (1.0 - var_024d3)) + (var_81228 * var_024d3);
    ...
    highp vec3 var_03c38;
    highp vec3 var_fc401;
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_867f5(var_909e9, var_e4584, var_25187, var_b5d88, var_1d5ac, var_6cfc2, var_16236, var_c0c2b, var_8e899, var_1f10d, var_81228, var_024d3, var_039d7);
        highp vec4 var_b2434;
        highp vec3 var_79a86;
        highp vec3 var_7ac75;
        func_25f4a(var_7ac75, var_909e9, var_79a86, var_e4584, var_b2434, var_de9ef, var_b7611, var_88136, var_25187, var_c0c2b, var_8e899, var_1f10d, var_81228, var_024d3, var_039d7, var_1d5ac);
        var_fc401 = var_7ac75;
        var_03c38 = var_79a86;
        var_9a0a9 = var_b2434;
    }
    ...
    highp vec4 var_b39a9 = var_9a0a9;
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_c697e(var_024d3, var_84ff0, var_617d6);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_17044(var_024d3, var_6eb02);
    ...
    highp vec3 var_c2d26 = vec4(var_54603.xyz + (mix(var_9c539, var_4dd80.xyz, vec3(var_942b2.w)) * var_a7d79.w), 1.0).xyz + var_38f4f;
    highp vec3 var_09481;
    if (PreExposureEnabled.x > 0.0)
    {
        var_09481 = var_c2d26 * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_09481 = var_c2d26;
