...
void main() {
...
#ifdef MULTI_COLOR_TINT__OFF
    highp vec3 var_07eac = pow(max(var_abd27.xyz * v_color0.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
#endif
#ifdef MULTI_COLOR_TINT__ON
    highp vec3 var_07eac = pow(max(var_0f504.xyz * v_color0.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
#endif
    highp vec3 var_89d26;
    highp float var_48756;
    highp float var_51753;
    highp float var_a1a5d;
    highp float var_7ae66;
    func_c1ba0(var_7ae66, var_a1a5d, var_51753, var_48756, var_89d26);
    ...
    highp vec3 var_22e87 = vec3(0.039999999105930328369140625 * (1.0 - var_7ae66)) + (var_07eac * var_7ae66);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_d47d2(var_7a98e, var_c2621, var_0c2a0, var_c8e4d, var_b1992, var_84dfb, var_29002, var_2bfc1, var_a1a5d, var_22e87, var_07eac, var_7ae66, var_edbf2);
        highp vec3 var_23d9a = var_6fbeb;
        highp vec4 var_8fd40;
        highp vec3 var_fa062;
        highp vec3 var_38603;
        bool var_902e5;
        func_d5e06(var_512b6, var_c0bfd, var_902e5, var_38603, var_fa062, var_8fd40, var_23d9a, var_d70da, var_6fbeb, var_0c2a0, var_2bfc1, var_a1a5d, var_22e87, var_07eac, var_7ae66, var_edbf2, var_c8e4d, var_b1992);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp float var_12c15 = 1.0 - var_a1a5d;
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_619f7(var_7ae66, var_3aee6, var_617d6);
        ...
        highp vec2 var_280ac = vec2(clamp(dot(var_0c2a0, -(var_6fbeb / vec3(var_27d11))), 0.0, 1.0), var_a1a5d);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_f46e7(var_7ae66, var_6eb02);
            highp vec2 var_dcda4 = vec2(clamp(dot(var_0c2a0, -(var_6fbeb / vec3(var_27d11))), 0.0, 1.0), var_a1a5d);
