...
void main() {
    ...
    highp vec4 var_714e6 = vec4(var_0f504.x, var_0f504.y, var_0f504.z, var_d9c64.w);
#endif
#ifdef MULTI_COLOR_TINT__OFF
    ...
    highp vec4 var_714e6 = vec4(var_abd27.x, var_abd27.y, var_abd27.z, var_d9c64.w);
#endif
    if (var_714e6.w < 0.5)
    {
        discard;
...
#ifdef MULTI_COLOR_TINT__OFF
    highp vec3 var_a9d86 = pow(max(var_abd27.xyz * v_color0.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
#endif
#ifdef MULTI_COLOR_TINT__ON
    highp vec3 var_a9d86 = pow(max(var_0f504.xyz * v_color0.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
#endif
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_011b2(var_211cd, var_c7b8f, var_26b5f, var_f49d3, var_a7d68, var_b7ced, var_e0782, var_a9d86);
        highp vec3 var_8bbda = var_81d72;
        highp vec4 var_9536d;
        highp vec3 var_62261;
        highp vec3 var_7aa4c;
        bool var_c0cc5;
        func_5ab89(var_25152, var_f4e52, var_c0cc5, var_7aa4c, var_62261, var_9536d, var_8bbda, var_bed13, var_81d72, var_26b5f, var_e0782, var_a9d86, var_f49d3, var_4d6b6);
