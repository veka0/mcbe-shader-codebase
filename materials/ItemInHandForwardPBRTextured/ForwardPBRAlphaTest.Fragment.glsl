...
void main() {
    ...
    highp vec3 var_5351f;
    func_66b9c(var_5351f, var_00f80);
    highp vec3 var_d2ce2;
    highp float var_5e5e9;
    highp float var_b5039;
    highp float var_d2dca;
    highp float var_141e7;
    func_89801(var_141e7, var_d2dca, var_b5039, var_5e5e9, var_d2ce2);
    ...
    highp vec3 var_8bebe = var_e14aa.xyz;
    highp vec3 var_cde66 = (u_view * var_e14aa).xyz;
    highp vec3 var_c1070 = vec3(0.039999999105930328369140625 * (1.0 - var_141e7)) + (var_5351f * var_141e7);
    ...
    highp vec4 var_a8c9c = vec4(var_bc571, 0.0);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_634be(var_f6f76, var_357df, var_cde66, var_b5d88, var_8bebe, var_6cfc2, var_b82c9, var_9823f, var_d2dca, var_c1070, var_5351f, var_141e7, var_11a4a);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_24fc3;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_95aa8(var_e318f, var_f6f76, var_aae12, var_357df, var_24fc3, var_6aed3, var_0daae, var_cde66, var_9823f, var_d2dca, var_c1070, var_5351f, var_141e7, var_8bebe, var_11a4a);
#endif
        highp vec4 var_829bb = var_a8c9c;
        uint var_08c07 = uint(floor(var_829bb.w * 255.0));
        highp vec3 var_62212;
        if ((DirectionalLightToggleAndMaxDistanceAndMaxCascadesPerLightAndGPUBlockLightingEnabled.w != 0.0) && (!((var_08c07 & 1u) != 0u)))
        {
            highp vec3 var_81aaa = ((v_worldPos - WorldOrigin.xyz) - vec3(0.5)) + (var_8bebe * 0.20000000298023223876953125);
            highp vec3 var_e55a8 = floor(var_81aaa * 0.0625) * 16.0;
            highp vec3 var_65d52 = var_81aaa - var_e55a8;
            ivec4 var_7f823 = ivec4(ivec3(floor(vec3(ivec3(floor(var_81aaa))) * vec3(0.0625))), 0);
            ivec4 var_a2c78 = var_7f823;
            int var_8282d = (var_a2c78.x & 65535) | (var_a2c78.y << 16);
            int var_db019 = (var_a2c78.z & 65535) | (var_a2c78.w << 16);
            ivec4 var_e83d2 = var_7f823;
            ...
            if (var_4680b)
            {
                bool var_cdbb7 = !((var_08c07 & 2u) != 0u);
                bool var_32d93;
                if (var_cdbb7)
                {
                    var_32d93 = any(greaterThanEqual(abs(var_8bebe), vec3(1.0)));
                }
                else
                {
                    var_32d93 = var_cdbb7;
                ...
                if (var_32d93)
                {
                    highp vec3 var_523e6 = var_8bebe;
                    highp vec3 var_34a44 = abs(var_8bebe);
        ...
        {
            var_62212 = var_a8c9c.xyz;
        }
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_890ad = var_24fc3;
#endif
        highp vec4 var_a73c9 = SkyAmbientLightColorIntensity;
        highp float var_8f051 = TileLightIntensity.y * TileLightIntensity.y;
#ifdef POINT_LIGHT_SHADING__ON
        var_f7210 = var_e318f;
#endif
...
#ifdef POINT_LIGHT_SHADING__OFF
        var_e51b8 = var_357df;
        var_f2114 = ((var_5351f * (1.0 - var_141e7)) * max((var_62212 * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_8f051 * var_8f051) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_a73c9.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w;
#endif
#ifdef POINT_LIGHT_SHADING__ON
        var_f2114 = ((var_5351f * (1.0 - var_141e7)) * max(((var_62212 + (var_24fc3.xyz * var_890ad.w)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_8f051 * var_8f051) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_a73c9.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w;
#endif
        var_48867 = ((mix(var_5351f, vec3(dot(var_5351f, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_b5039)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x;
    }
    else
    {
        var_f7210 = vec3(0.0);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp vec3 var_a56d9 = reflect(normalize(var_a8715 - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_8bebe);
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_d903a(var_a8c9c, var_141e7, var_713f8, var_26642);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_769bb(var_a8c9c, var_141e7, var_da70a);
    ...
    highp vec3 var_edfc1 = vec4(var_bde45.xyz + (mix(((var_f2114 + var_f7210) + var_e51b8) + var_48867, var_164a6.xyz, vec3(var_45187.w)) * var_063c9.w), 1.0).xyz + var_083e8;
