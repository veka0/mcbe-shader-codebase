...
void func_bbb6d(inout int arg_826b5, inout highp float arg_9eee0, inout highp float arg_6b488, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c, inout highp float arg_77c90) {
    if (var_9152e.zLights[arg_826b5].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        arg_6b488 = 1.0;
        return;
    }
    highp vec3 loc_44ea9 = arg_aee55 - var_9152e.zLights[arg_826b5].position.xyz;
    ...
    highp float loc_e670f = (textureLod(s_PointLightShadowTextureArray, vec4(loc_f715f, float(var_9152e.zLights[arg_826b5].shadowProbeIndex)), 0.0).x * 2.0) - 1.0;
...
void func_a474e(inout highp vec4 arg_e84ec, inout int arg_9327a, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_0a2b9, inout highp vec3 arg_f6a53, inout highp vec3 arg_4f9dc, inout highp float arg_8bccf) {
    ...
    highp vec3 loc_a4b3e = var_9152e.zLights[arg_9327a].position.xyz - v_worldPos;
    ...
    if (loc_3a449 >= (var_9152e.zLights[arg_9327a].position.w * var_9152e.zLights[arg_9327a].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_0a2b9 = vec3(0.0);
    ...
    highp float loc_4c5a5 = loc_3a449 / ((var_9152e.zLights[arg_9327a].position.w * var_9152e.zLights[arg_9327a].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_9152e.zLights[arg_9327a].color.xyz * loc_219c5;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_3a449 / ((var_9152e.zLights[arg_9327a].position.w * var_9152e.zLights[arg_9327a].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_a011d;
    arg_7f337 = loc_cddfe;
    arg_0a2b9 = (var_9152e.zLights[arg_9327a].color.xyz * var_9152e.zLights[arg_9327a].color.w) * loc_219c5;
}
void func_e9ab7(inout bool arg_9a2b4, inout bool arg_b6724, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_33e52, inout highp vec3 arg_33c3b, inout highp vec3 arg_e4e64, inout highp vec3 arg_061f9, inout highp float arg_e8ed0, inout highp vec3 arg_04538, inout highp vec3 arg_dd9d3, inout highp float arg_f859b, inout highp float arg_105b9, inout highp vec3 arg_5a8cd, inout highp vec3 arg_4fa31) {
    ...
    for (int loc_86630 = loc_490eb; loc_86630 < loc_c476d; loc_983e3 = loc_7c75a, loc_33c65 = loc_ed2f2, loc_23246 = loc_62c27, loc_86630++)
    {
        ...
        highp vec3 loc_287bb = normalize((u_view * vec4(var_9152e.zLights[loc_4d5d9].position.xyz, 1.0)).xyz - arg_33c3b);
...
void main() {
    ...
    highp vec4 var_a6e92 = vec4(var_ffb2a.x, var_ffb2a.y, var_ffb2a.z, var_fa883.w);
#endif
#ifdef MULTI_COLOR_TINT__OFF
    ...
    highp vec4 var_a6e92 = vec4(var_ee97a.x, var_ee97a.y, var_ee97a.z, var_fa883.w);
    ...
    highp float var_b9975;
    func_c1ba0(var_b9975, var_d2dca, var_ed23d, var_5e5e9, var_d2ce2);
    ...
    highp vec3 var_c1070 = vec3(0.039999999105930328369140625 * (1.0 - var_b9975)) + (var_a1b79 * var_b9975);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_867f5(var_e3304, var_904fd, var_cde66, var_b5d88, var_6c01a, var_6cfc2, var_b82c9, var_9823f, var_d2dca, var_c1070, var_a1b79, var_b9975, var_49d92);
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_323af(var_e318f, var_e3304, var_aae12, var_904fd, var_05431, var_f8af5, var_14922, var_cde66, var_9823f, var_d2dca, var_c1070, var_a1b79, var_b9975, var_49d92, var_6c01a);
        var_5f2c3 = var_e318f;
        var_a81bf = var_aae12;
        var_9a0a9 = var_05431;
    }
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_c697e(var_b9975, var_84ff0, var_617d6);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_17044(var_b9975, var_6eb02);
            ...
            var_e2657 = var_6eb02.xyz * ((var_c1070 * var_864a0.x) + vec3(var_864a0.y));
        }
        else
        {
            var_e2657 = vec3(0.0);
