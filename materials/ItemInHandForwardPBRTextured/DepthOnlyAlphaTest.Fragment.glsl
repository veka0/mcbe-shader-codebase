...
void main() {
    ...
    highp vec4 var_bf853 = vec4(var_9489a.x, var_9489a.y, var_9489a.z, vec4(1.0).w);
#endif
#ifdef MULTI_COLOR_TINT__OFF
    ...
    highp vec4 var_bf853 = vec4(var_a7fd7.x, var_a7fd7.y, var_a7fd7.z, vec4(1.0).w);
#endif
