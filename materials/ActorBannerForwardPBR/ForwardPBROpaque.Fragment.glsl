...
void func_06d27(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_02c40, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_470f5, inout highp vec2 arg_c288e, inout highp vec3 arg_99739, inout highp float arg_2bc6f, inout highp vec3 arg_85276, inout highp vec4 arg_c403c, inout highp float arg_207c8, inout highp float arg_24e02) {
...
void main() {
    ...
    highp vec4 var_a8b23 = vec4(var_a0775.x, var_a0775.y, var_a0775.z, var_1e2a8.w);
    var_a8b23.w *= HudOpacity.x;
    highp vec4 var_d4180 = var_a8b23;
    ...
    highp vec3 var_e4f6a = vec3(0.039999999105930328369140625 * (1.0 - var_677d5)) + (var_a8b23.xyz * var_677d5);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_06d27(var_7a98e, var_c2621, var_0c2a0, var_c8e4d, var_b1992, var_84dfb, var_29002, var_2bfc1, var_ce882, var_e4f6a, var_a8b23, var_677d5, var_edbf2);
        highp vec3 var_23d9a = var_6fbeb;
        highp vec4 var_8fd40;
        highp vec3 var_fa062;
        highp vec3 var_38603;
        bool var_902e5;
        func_7e55d(var_512b6, var_c0bfd, var_902e5, var_38603, var_fa062, var_8fd40, var_23d9a, var_d70da, var_6fbeb, var_0c2a0, var_2bfc1, var_ce882, var_e4f6a, var_a8b23, var_677d5, var_edbf2, var_c8e4d, var_b1992);
        var_09bdb = var_7a98e + (var_38603 * (1.0 - var_f3062));
        var_87f73 = var_c2621 + (var_fa062 * (1.0 - var_5d160));
        var_9a0a9 = var_8fd40;
        var_5a6e4 = var_902e5;
    }
    else
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_619f7(var_677d5, var_3aee6, var_617d6);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_f46e7(var_677d5, var_6eb02);
