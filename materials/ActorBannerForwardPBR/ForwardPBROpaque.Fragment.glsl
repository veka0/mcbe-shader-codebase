...
void func_63c56(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_02c40, inout highp vec3 arg_abe00, inout highp vec2 arg_c288e, inout highp vec3 arg_99739, inout highp float arg_2bc6f, inout highp vec3 arg_85276, inout highp vec4 arg_c403c, inout highp float arg_207c8, inout highp float arg_24e02) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        if (arg_b6724)
        {
            ...
            if (arg_9a2b4)
            {
                ...
                highp vec3 loc_89d3b = arg_d70d9.xyz * (1.0 - arg_dd893);
                ...
                loc_31e9d = (loc_89d3b * vec3(0.3183098733425140380859375)) * (arg_fe933 * max((dot(-arg_6ff9e, loc_a3520) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / ((1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) * (1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y)), 0.0));
                loc_e0df3 = ((vec3(1.0) - loc_481af) * mix(loc_a6fcb, max((dot(arg_6ff9e, loc_a3520) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / ((1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) * (1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y)), 0.0), arg_fe933)) * (loc_89d3b * vec3(0.3183098733425140380859375));
            }
            else
            {
                highp vec3 loc_78b93 = arg_d70d9.xyz * (1.0 - arg_dd893);
                loc_0a326 = vec3(0.0);
                loc_31e9d = (loc_78b93 * vec3(0.3183098733425140380859375)) * (arg_fe933 * max((dot(-arg_6ff9e, loc_a3520) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / ((1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) * (1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y)), 0.0));
                loc_e0df3 = (loc_78b93 * vec3(0.3183098733425140380859375)) * mix(max(dot(arg_6ff9e, loc_a3520), 0.0), max((dot(arg_6ff9e, loc_a3520) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / ((1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) * (1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y)), 0.0), arg_fe933);
            }
            loc_b2ace = loc_0a326;
            loc_05c79 = loc_31e9d;
            loc_12949 = loc_e0df3;
...
void main() {
    ...
    highp float var_1317e;
    highp float var_9e955;
    ...
    if ((var_f71fc & 1) == 1)
    {
        ...
        var_9e955 = var_4035b.y;
        var_1317e = var_4035b.x;
    }
    else
    {
        var_76cb9 = SubsurfaceUniform.x;
        var_d2a1f = RoughnessUniform.x;
        var_9e955 = EmissiveUniform.x;
        var_1317e = MetalnessUniform.x;
    }
    ...
    highp vec4 var_0cc13 = vec4(var_a0775.x, var_a0775.y, var_a0775.z, var_1e2a8.w);
    var_0cc13.w *= HudOpacity.x;
    highp vec4 var_d4180 = var_0cc13;
    ...
    highp vec3 var_ea300 = vec3(0.039999999105930328369140625 * (1.0 - var_1317e)) + (var_0cc13.xyz * var_1317e);
    ...
    highp vec3 var_7a83c;
    highp vec3 var_6a73d;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_c062c = vec2(var_49182, var_280ef);
        highp vec3 var_2a503;
        highp vec3 var_8efb6;
        func_63c56(var_8efb6, var_2a503, var_489d8, var_c35eb, var_c062c, var_34c46, var_d2a1f, var_ea300, var_0cc13, var_1317e, var_f9967);
        highp vec3 var_6bb48 = var_e0815;
        highp vec4 var_1b4da;
        highp vec3 var_c1a13;
        highp vec3 var_da80f;
        bool var_716f8;
        func_8e85f(var_37230, var_8ba1b, var_716f8, var_da80f, var_c1a13, var_1b4da, var_6bb48, var_adfcf, var_e0815, var_489d8, var_34c46, var_d2a1f, var_ea300, var_0cc13, var_1317e, var_f9967, var_9058a);
        var_6a73d = var_8efb6 + (var_da80f * (1.0 - var_f3062));
        var_7a83c = var_2a503 + (var_c1a13 * (1.0 - var_5d160));
        var_9a0a9 = var_1b4da;
        var_5a6e4 = var_716f8;
    }
    else
    ...
    highp float var_a898d;
    if (var_5a6e4)
    {
        var_a898d = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_a898d = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_71135 = var_9a0a9;
    highp vec4 var_0d560 = SkyAmbientLightColorIntensity;
    highp float var_3e561 = TileLightIntensity.x * TileLightIntensity.x;
    highp vec3 var_22417 = (((((var_0cc13.xyz * (1.0 - var_1317e)) * max(((clamp(vec3(var_3e561 + (var_71135.x * var_71135.w), (var_3e561 * ((((var_3e561 * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_71135.y * var_71135.w), (var_3e561 * (((var_3e561 * var_3e561) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_71135.z * var_71135.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_a898d) + ((SkyAmbientLightColorIntensity.xyz * pow(TileLightIntensity.y, mix(5.0, 3.0, CameraLightIntensity.y))) * var_0d560.w), vec3(0.02999999932944774627685546875))) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_6a73d) + var_7a83c) + (((mix(var_0cc13.xyz, vec3(dot(var_0cc13.xyz, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_9e955)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x);
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_22417, var_a6488, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_22417;
    ...
    {
        var_7e3dc = mix(var_22417, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp vec3 var_94472 = ((var_9aad8 * (pow(clamp(((TileLightIntensity.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0), 3.0) * IBLParameters.x)) * IBLParameters.z) * ((var_ea300 * var_c040f.x) + vec3(var_c040f.y));
    ...
    bgfx_FragData[0] = vec4(var_7610b.x, var_7610b.y, var_7610b.z, vec4(var_aaae6, var_aaae6, var_aaae6, var_d4180.w).w);
}
