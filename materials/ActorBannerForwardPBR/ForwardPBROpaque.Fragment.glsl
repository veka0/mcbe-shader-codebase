...
void func_98942(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_218ea, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_a9fca, inout highp vec2 arg_f36e7, inout highp vec3 arg_81f79, inout highp float arg_d565c, inout highp vec3 arg_58ffc, inout highp vec4 arg_c403c, inout highp float arg_207c8, inout highp float arg_cdb42) {
    ...
    for (int loc_0c559 = 0; loc_0c559 < loc_29e34; loc_6ee08 = loc_f20d9, loc_7d7d3 = loc_fde0c, loc_0c559++, loc_a7108 = loc_f3340)
    {
        ...
        loc_fde0c = loc_7d7d3 + (((((((vec3(1.0) - loc_d5257) * mix(loc_1e1bf, max((dot(arg_218ea, loc_921fd) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_2d61b * loc_2d61b), 0.0), arg_cdb42)) * (loc_82c84 * vec3(0.3183098733425140380859375))) * loc_c6386) + (((loc_82c84 * vec3(0.3183098733425140380859375)) * (arg_cdb42 * max((dot(-arg_218ea, loc_921fd) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_c20a0 * loc_c20a0), 0.0))) * loc_a416a)) * loc_49071) * DiffuseSpecularEmissiveAmbientTermToggles.x);
...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_98942(var_7a98e, var_c2621, var_7298f, var_b5d88, var_2b8e0, var_6cfc2, var_29002, var_53f62, var_1d7df, var_ab59e, var_8b20c, var_f06d1, var_83276);
