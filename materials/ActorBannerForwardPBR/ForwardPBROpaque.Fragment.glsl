...
void func_b329c(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_218ea, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_470f5, inout highp vec2 arg_c288e, inout highp vec3 arg_81f79, inout highp float arg_d565c, inout highp vec3 arg_58ffc, inout highp vec4 arg_c403c, inout highp float arg_207c8, inout highp float arg_cdb42) {
    ...
    for (int loc_a5f76 = 0; loc_a5f76 < loc_a14ca; loc_0bf4d = loc_3ac48, loc_9d63a = loc_f1b97, loc_7a912 = loc_f5dfb, loc_bd26f = loc_1a85e, loc_a5f76++)
    {
        ...
        loc_f1b97 = loc_9d63a + (((((((vec3(1.0) - loc_d5257) * mix(loc_1e1bf, max((dot(arg_218ea, loc_921fd) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_2d61b * loc_2d61b), 0.0), arg_cdb42)) * (loc_82c84 * vec3(0.3183098733425140380859375))) * loc_f1dc4) + (((loc_82c84 * vec3(0.3183098733425140380859375)) * (arg_cdb42 * max((dot(-arg_218ea, loc_921fd) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_c20a0 * loc_c20a0), 0.0))) * loc_a416a)) * loc_cf53a) * DiffuseSpecularEmissiveAmbientTermToggles.x);
...
void main() {
    ...
    highp vec3 var_d0f2d = var_9f386.xyz;
    highp vec3 var_5e4ab = var_7c164.xyz;
    highp vec3 var_c4126 = (u_view * var_7c164).xyz;
    ...
    highp float var_27d11 = length(var_d0f2d);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        if (ShadowQuantizationParameters.y > 0.0)
        {
            ...
            highp vec3 var_96336 = normalize(round(normalize((u_invView * vec4(normalize(cross(normalize(dFdx(var_d0f2d)), normalize(dFdy(var_d0f2d)))), 0.0)).xyz) / vec3(ShadowPrecisionRoundingParameters.x)) * ShadowPrecisionRoundingParameters.x);
        ...
        highp vec3 var_53f62 = -(var_d0f2d / vec3(length(var_d0f2d) + 9.9999997473787516355514526367188e-05));
        highp float var_83276 = var_6757b * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        highp vec3 var_6cfc2 = var_d0f2d;
        highp vec2 var_29002 = vec2(var_49182, var_280ef);
        highp vec3 var_c2621;
        highp vec3 var_7a98e;
        func_b329c(var_7a98e, var_c2621, var_c4126, var_d7db8, var_5e4ab, var_6cfc2, var_29002, var_53f62, var_dae62, var_ab59e, var_8b20c, var_f06d1, var_83276);
        highp vec3 var_850d6 = var_d0f2d;
        ...
        highp vec3 var_cdcc9 = var_d0f2d;
        highp vec4 var_e4833;
        highp vec3 var_da80f;
        highp vec3 var_bb1ac;
        func_5a169(var_bf718, var_5423d, var_bb1ac, var_da80f, var_e4833, var_cdcc9, var_a6bd2, var_d0f2d, var_c4126, var_53f62, var_dae62, var_ab59e, var_8b20c, var_f06d1, var_83276, var_d7db8, var_5e4ab);
    ...
    {
        highp float var_79b3e = clamp((((length(var_d0f2d) / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) * FogAndDistanceControl.y, 0.0, 1.0);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        {
            highp float var_9a0e5 = 1.0 - var_dae62;
            var_0f441 = (1.0 - (var_9a0e5 * var_9a0e5)) * (IBLParameters.y - 1.0);
        }
        else
        {
            highp float var_c17b7 = 1.0 - var_dae62;
        ...
        highp vec2 var_280ac = vec2(clamp(dot(var_c4126, -(var_d0f2d / vec3(var_27d11))), 0.0, 1.0), var_dae62);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            highp vec2 var_dcda4 = vec2(clamp(dot(var_c4126, -(var_d0f2d / vec3(var_27d11))), 0.0, 1.0), var_dae62);
