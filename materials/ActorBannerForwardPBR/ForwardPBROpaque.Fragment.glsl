...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_63c56(var_8efb6, var_2a503, var_489d8, var_c35eb, var_c062c, var_19589, var_d2a1f, var_ea300, var_0cc13, var_1317e, var_f9967);
        highp vec3 var_6bb48 = var_9f2c1;
        highp vec4 var_1b4da;
        highp vec3 var_c1a13;
        highp vec3 var_da80f;
        bool var_716f8;
        func_8e85f(var_37230, var_8ba1b, var_716f8, var_da80f, var_c1a13, var_1b4da, var_6bb48, var_adfcf, var_9f2c1, var_489d8, var_19589, var_d2a1f, var_ea300, var_0cc13, var_1317e, var_f9967, var_9058a);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp vec3 var_94472 = ((var_b1eea * (pow(clamp(((TileLightIntensity.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0), 3.0) * IBLParameters.x)) * IBLParameters.z) * ((var_ea300 * var_c040f.x) + vec3(var_c040f.y));
