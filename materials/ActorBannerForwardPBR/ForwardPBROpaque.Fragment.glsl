...
void func_da0e7(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_02c40, inout highp vec3 arg_326a5, inout highp vec3 arg_abe00, inout highp vec2 arg_c288e, inout highp vec3 arg_99739, inout highp float arg_2bc6f, inout highp vec3 arg_85276, inout highp vec4 arg_c403c, inout highp float arg_207c8, inout highp float arg_24e02) {
...
void main() {
    ...
    highp float var_98438;
    highp float var_9e955;
    highp float var_ced53;
    ...
    if ((var_f71fc & 1) == 1)
    {
        ...
        var_76cb9 = var_ae1fa;
        var_ced53 = var_4035b.z;
        var_9e955 = var_4035b.y;
        var_98438 = var_4035b.x;
    }
    else
    {
        var_76cb9 = SubsurfaceUniform.x;
        var_ced53 = RoughnessUniform.x;
        var_9e955 = EmissiveUniform.x;
        var_98438 = MetalnessUniform.x;
    }
    ...
    highp vec4 var_70e13 = vec4(var_a0775.x, var_a0775.y, var_a0775.z, var_1e2a8.w);
    var_70e13.w *= HudOpacity.x;
    highp vec4 var_d4180 = var_70e13;
    ...
    highp vec3 var_93a61 = var_9f386.xyz;
    highp vec3 var_c71ce = var_7c164.xyz;
    highp vec3 var_3d062 = (u_view * var_7c164).xyz;
    highp vec3 var_1fbac = vec3(0.039999999105930328369140625 * (1.0 - var_98438)) + (var_70e13.xyz * var_98438);
    ...
    highp float var_5be7c = length(var_93a61);
    highp vec3 var_0d894 = var_93a61;
    highp vec3 var_5bd0a = var_d70da;
    highp vec3 var_811e1 = var_93a61;
    ...
    highp vec3 var_4eacb = -(var_93a61 / vec3(length(var_93a61) + 9.9999997473787516355514526367188e-05));
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_da0e7(var_3d209, var_1d975, var_3d062, var_9e07f, var_0d894, var_537c2, var_4eacb, var_ced53, var_1fbac, var_70e13, var_98438, var_9024c);
        highp vec3 var_23d9a = var_93a61;
        highp vec4 var_8fd40;
        highp vec3 var_fa062;
        highp vec3 var_38603;
        bool var_902e5;
        func_7e55d(var_512b6, var_c0bfd, var_902e5, var_38603, var_fa062, var_8fd40, var_23d9a, var_d70da, var_93a61, var_3d062, var_4eacb, var_ced53, var_1fbac, var_70e13, var_98438, var_9024c, var_9e07f, var_c71ce);
        var_6a73d = var_3d209 + (var_38603 * (1.0 - var_f3062));
        var_7a83c = var_1d975 + (var_fa062 * (1.0 - var_5d160));
        var_9a0a9 = var_8fd40;
        var_5a6e4 = var_902e5;
    }
    else
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_22417, var_08c70, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_22417;
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp float var_12c15 = 1.0 - var_ced53;
        ...
        func_fc162(var_98438, var_76060, var_20f77);
        ...
        highp vec2 var_29c15 = texture(s_BrdfLUT, vec2(clamp(dot(var_3d062, -(var_93a61 / vec3(var_5be7c))), 0.0, 1.0), var_ced53)).xy;
        highp vec3 var_fe0f6 = var_d97f1 * ((var_1fbac * var_29c15.x) + vec3(var_29c15.y));
        highp vec3 var_67472;
        if (AtmosphericScatteringToggles.x != 0.0)
        {
            var_67472 = var_fe0f6 * (1.0 - clamp((((var_5be7c / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) * FogAndDistanceControl.y, 0.0, 1.0));
        }
        else
        {
            var_67472 = var_fe0f6 * (1.0 - clamp((((var_5be7c / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0));
        }
    ...
    {
        highp vec2 var_87c62 = texture(s_BrdfLUT, vec2(clamp(dot(var_3d062, -(var_93a61 / vec3(var_5be7c))), 0.0, 1.0), var_ced53)).xy;
        var_64293 = ((AmbientLightParams.xyz * var_98438) * AmbientLightParams.w) * ((var_1fbac * var_87c62.x) + vec3(var_87c62.y));
    }
