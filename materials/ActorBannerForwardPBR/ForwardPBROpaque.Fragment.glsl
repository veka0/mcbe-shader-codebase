...
layout(binding = 5, std430) buffer s_Lights { Light Lights[]; } var_7b377;
...
void func_94caa(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_218ea, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_470f5, inout highp vec2 arg_f36e7, inout highp vec3 arg_81f79, inout highp float arg_d565c, inout highp vec3 arg_58ffc, inout highp vec4 arg_c403c, inout highp float arg_207c8, inout highp float arg_cdb42) {
    ...
    for (int loc_e68b0 = 0; loc_e68b0 < loc_a14ca; loc_0bf4d = loc_3ac48, loc_9d63a = loc_f1b97, loc_7a912 = loc_f5dfb, loc_bd26f = loc_1a85e, loc_e68b0++)
    {
        ...
        {
            highp float loc_0b0a1 = max(dot(arg_218ea, normalize((u_view * DirectionalLightSourceShadowDirection[loc_e68b0]).xyz)), 0.0);
            highp vec4 loc_bbaca = NdLFloor;
            highp vec3 loc_78075 = arg_016ce + ((arg_68e47 * ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.w) * clamp(1.0 - loc_0b0a1, 0.0, 1.0));
            int loc_640a7;
            highp vec4 loc_d73c9;
            highp mat4 loc_b250f;
            func_9040f(loc_e68b0, loc_78075, loc_b250f, loc_d73c9, loc_640a7, loc_bd26f);
            highp vec4 loc_08b3b = loc_d73c9;
            highp float loc_2f871;
            highp float loc_be413;
            if (loc_640a7 != (-1))
            {
                highp float loc_aaff4 = clamp(loc_0b0a1, loc_bbaca[loc_640a7], 1.0);
                highp float loc_c2b4e = ShadowBias[loc_640a7] + (ShadowSlopeBias[loc_640a7] * (sqrt(1.0 - (loc_aaff4 * loc_aaff4)) / loc_aaff4));
                ...
                func_6ab74(loc_82d7a, loc_079c0, loc_47769, loc_640a7, loc_08b3b, loc_9a3cf, loc_c2b4e);
                highp float loc_ad256;
                if (int(FirstPersonPlayerShadowsEnabledAndResolutionAndFilterWidthAndTextureDimensions.x) > 0)
                {
                    highp vec4 loc_52fa6 = NdLFloor;
                    highp float loc_92468;
                    func_36c14(loc_78075, loc_0b0a1, loc_52fa6, loc_92468);
                    loc_ad256 = min(loc_47769, loc_92468);
                }
                else
                {
                    loc_ad256 = loc_47769;
                ...
                if (loc_643a4)
                {
                    ...
                    highp vec4 loc_1a6df = CloudShadowProj * vec4(loc_78075, 1.0);
        ...
        highp vec3 loc_82c84 = arg_c403c.xyz * (1.0 - arg_207c8);
        loc_f1b97 = loc_9d63a + (((((((vec3(1.0) - loc_d5257) * mix(loc_1e1bf, max((dot(arg_218ea, loc_921fd) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_2d61b * loc_2d61b), 0.0), arg_cdb42)) * (loc_82c84 * vec3(0.3183098733425140380859375))) * loc_f1dc4) + (((loc_82c84 * vec3(0.3183098733425140380859375)) * (arg_cdb42 * max((dot(-arg_218ea, loc_921fd) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_c20a0 * loc_c20a0), 0.0))) * loc_a416a)) * loc_49071) * DiffuseSpecularEmissiveAmbientTermToggles.x);
...
void func_590f5(inout int arg_5232b, inout highp float arg_9eee0, inout highp float arg_6b488, inout highp vec3 arg_c4b3d, inout highp vec3 arg_3efda, inout highp float arg_77c90) {
    if (var_7b377.Lights[arg_5232b].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        arg_6b488 = 1.0;
        return;
    }
    highp vec3 loc_8d02b = arg_c4b3d - var_7b377.Lights[arg_5232b].position.xyz;
    ...
    highp float loc_4c50b = (textureLod(s_PointLightShadowTextureArray, vec4(loc_778fd, float(var_7b377.Lights[arg_5232b].shadowProbeIndex)), 0.0).x * 2.0) - 1.0;
...
void func_2c6c7(inout highp vec4 arg_86e96, inout int arg_3df6f, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_24936, inout highp vec3 arg_f6a53, inout highp vec3 arg_4f9dc, inout highp float arg_8bccf) {
    ...
    highp vec3 loc_569de = var_7b377.Lights[arg_3df6f].position.xyz - v_worldPos;
    ...
    if (loc_4343f >= (var_7b377.Lights[arg_3df6f].position.w * var_7b377.Lights[arg_3df6f].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_24936 = vec3(0.0);
    ...
    if (DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.w != 0.0)
    {
        ...
        func_590f5(arg_3df6f, loc_b2a04, loc_412fd, arg_f6a53, arg_4f9dc, arg_8bccf);
        loc_a011d = loc_b2a04;
        loc_cddfe = loc_412fd;
    }
    else
    ...
    highp float loc_fd676 = loc_4343f / ((var_7b377.Lights[arg_3df6f].position.w * var_7b377.Lights[arg_3df6f].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_e1408 = var_7b377.Lights[arg_3df6f].color.xyz * loc_a0a0b;
        arg_86e96 = vec4(loc_e1408.x, loc_e1408.y, loc_e1408.z, arg_86e96.w);
        arg_86e96.w = 1.0 - (loc_4343f / ((var_7b377.Lights[arg_3df6f].position.w * var_7b377.Lights[arg_3df6f].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_a011d;
    arg_7f337 = loc_cddfe;
    arg_24936 = ((var_7b377.Lights[arg_3df6f].color.xyz * var_7b377.Lights[arg_3df6f].color.w) * loc_a0a0b) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_5a169(inout bool arg_9a2b4, inout bool arg_b6724, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_33e52, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_e4e64, inout highp vec3 arg_061f9, inout highp float arg_e8ed0, inout highp vec3 arg_04538, inout highp vec4 arg_d70d9, inout highp float arg_dd893, inout highp float arg_105b9, inout highp vec3 arg_5a8cd, inout highp vec3 arg_4fa31) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_983e3 = loc_7c75a, loc_33c65 = loc_ed2f2, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_8c356 = normalize((u_view * vec4(var_7b377.Lights[loc_fb87b].position.xyz, 1.0)).xyz - arg_89c41);
        ...
        if (arg_b6724)
        {
            ...
            if (arg_9a2b4)
            {
                ...
                loc_577c9 = (loc_356a1 * vec3(0.3183098733425140380859375)) * (arg_105b9 * max((dot(-arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_2e0cd * loc_2e0cd), 0.0));
                loc_6cd2d = ((vec3(1.0) - loc_1800c) * mix(loc_dad67, max((dot(arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_57238 * loc_57238), 0.0), arg_105b9)) * (loc_356a1 * vec3(0.3183098733425140380859375));
            }
            else
            {
                ...
                loc_0a326 = vec3(0.0);
                loc_577c9 = (loc_35649 * vec3(0.3183098733425140380859375)) * (arg_105b9 * max((dot(-arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_0a512 * loc_0a512), 0.0));
                loc_6cd2d = (loc_35649 * vec3(0.3183098733425140380859375)) * mix(max(dot(arg_e4e64, loc_8c356), 0.0), max((dot(arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_36134 * loc_36134), 0.0), arg_105b9);
            }
            loc_20211 = loc_0a326;
            loc_07fc6 = loc_577c9;
            loc_6691c = loc_6cd2d;
...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        highp vec2 var_29002 = vec2(var_30c68, var_ba9ef);
        highp vec3 var_c2621;
        highp vec3 var_7a98e;
        func_94caa(var_7a98e, var_c2621, var_7298f, var_b5d88, var_2b8e0, var_6cfc2, var_29002, var_53f62, var_1d7df, var_ab59e, var_8b20c, var_f06d1, var_83276);
        ...
        func_5a169(var_bf718, var_5423d, var_bb1ac, var_da80f, var_e4833, var_cdcc9, var_a6bd2, var_f0b86, var_7298f, var_53f62, var_1d7df, var_ab59e, var_8b20c, var_f06d1, var_83276, var_2c7f3, var_2b8e0);
