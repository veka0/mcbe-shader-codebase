    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        if (arg_b6724)
        {
            ...
            if (arg_9a2b4)
            {
                ...
                loc_577c9 = (loc_356a1 * vec3(0.3183098733425140380859375)) * (arg_c50ac * max((dot(-arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_2e0cd * loc_2e0cd), 0.0));
                loc_6cd2d = ((vec3(1.0) - loc_1800c) * mix(loc_dad67, max((dot(arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_57238 * loc_57238), 0.0), arg_c50ac)) * (loc_356a1 * vec3(0.3183098733425140380859375));
            }
            else
            {
                ...
                loc_0a326 = vec3(0.0);
                loc_577c9 = (loc_35649 * vec3(0.3183098733425140380859375)) * (arg_c50ac * max((dot(-arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_0a512 * loc_0a512), 0.0));
                loc_6cd2d = (loc_35649 * vec3(0.3183098733425140380859375)) * mix(max(dot(arg_e4e64, loc_8c356), 0.0), max((dot(arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_36134 * loc_36134), 0.0), arg_c50ac);
            }
            loc_b2ace = loc_0a326;
            loc_05c79 = loc_577c9;
            loc_12949 = loc_6cd2d;
...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_fc01a(var_7a98e, var_c2621, var_c4126, var_d7db8, var_5e4ab, var_6cfc2, var_29002, var_53f62, var_824a7, var_ab59e, var_8b20c, var_f06d1, var_83276);
        ...
        func_c6b15(var_bf718, var_5423d, var_bb1ac, var_da80f, var_e4833, var_cdcc9, var_a6bd2, var_d0f2d, var_c4126, var_53f62, var_824a7, var_ab59e, var_8b20c, var_f06d1, var_83276, var_d7db8, var_5e4ab);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp float var_12c15 = 1.0 - var_824a7;
        highp float var_59d83 = (1.0 - (var_12c15 * var_12c15)) * (IBLParameters.y - 1.0);
        int var_ae27f = int(LastSpecularIBLIdx.x);
        highp vec3 var_67eb4 = mix(textureLod(s_SpecularIBLRecords, vec4(var_7914f, float((var_ae27f + 2) % 3)), var_59d83).xyz, textureLod(s_SpecularIBLRecords, vec4(var_7914f, float(var_ae27f)), var_59d83).xyz, vec3(IBLParameters.w));
        ...
        highp vec2 var_280ac = vec2(clamp(dot(var_c4126, -(var_d0f2d / vec3(var_27d11))), 0.0, 1.0), var_824a7);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            highp vec2 var_dcda4 = vec2(clamp(dot(var_c4126, -(var_d0f2d / vec3(var_27d11))), 0.0, 1.0), var_824a7);
