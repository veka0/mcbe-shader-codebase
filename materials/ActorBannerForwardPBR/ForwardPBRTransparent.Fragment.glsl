...
void main() {
    ...
    highp float var_9e696;
    highp float var_23a08;
    ...
    if ((var_f71fc & 1) == 1)
    {
        ...
        var_23a08 = var_4035b.y;
        var_9e696 = var_4035b.x;
    }
    else
    {
        var_76cb9 = SubsurfaceUniform.x;
        var_ce882 = RoughnessUniform.x;
        var_23a08 = EmissiveUniform.x;
        var_9e696 = MetalnessUniform.x;
    }
    ...
    highp vec4 var_3ef42 = vec4(var_a0775.x, var_a0775.y, var_a0775.z, var_1e2a8.w);
    var_3ef42.w *= HudOpacity.x;
    highp vec4 var_d4180 = var_3ef42;
    ...
    highp vec3 var_e4f6a = vec3(0.039999999105930328369140625 * (1.0 - var_9e696)) + (var_3ef42.xyz * var_9e696);
    ...
    highp vec3 var_5472e;
    highp vec3 var_72cdf;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_29002 = vec2(var_49182, var_280ef);
        highp vec3 var_c2621;
        highp vec3 var_7a98e;
        func_fc01a(var_7a98e, var_c2621, var_0c2a0, var_c8e4d, var_b1992, var_84dfb, var_29002, var_2bfc1, var_ce882, var_e4f6a, var_3ef42, var_9e696, var_edbf2);
        highp vec3 var_23d9a = var_6fbeb;
        highp vec4 var_8fd40;
        highp vec3 var_fa062;
        highp vec3 var_38603;
        bool var_902e5;
        func_be6f2(var_512b6, var_c0bfd, var_902e5, var_38603, var_fa062, var_8fd40, var_23d9a, var_d70da, var_6fbeb, var_0c2a0, var_2bfc1, var_ce882, var_e4f6a, var_3ef42, var_9e696, var_edbf2, var_c8e4d, var_b1992);
        var_72cdf = var_7a98e + (var_38603 * (1.0 - var_f3062));
        var_5472e = var_c2621 + (var_fa062 * (1.0 - var_5d160));
        var_9a0a9 = var_8fd40;
        var_5a6e4 = var_902e5;
    }
    else
    ...
    highp float var_67297;
    if (var_5a6e4)
    {
        var_67297 = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_67297 = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_5172f = var_9a0a9;
    highp float var_7ea5a = TileLightIntensity.x * TileLightIntensity.x;
    highp vec4 var_4a5bf = SkyAmbientLightColorIntensity;
    highp float var_962e8 = TileLightIntensity.y * TileLightIntensity.y;
    highp vec3 var_19487 = (((((var_3ef42.xyz * (1.0 - var_9e696)) * max(((clamp(vec3(var_7ea5a + (var_5172f.x * var_5172f.w), (var_7ea5a * ((((var_7ea5a * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_5172f.y * var_5172f.w), (var_7ea5a * (((var_7ea5a * var_7ea5a) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_5172f.z * var_5172f.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_67297) + ((SkyAmbientLightColorIntensity.xyz * mix((var_962e8 * var_962e8) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_4a5bf.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_72cdf) + var_5472e) + (((mix(var_3ef42.xyz, vec3(dot(var_3ef42.xyz, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_23a08)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x);
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_19487, var_9d9e1, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_19487;
    ...
    {
        var_7e3dc = mix(var_19487, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_619f7(var_9e696, var_84ff0, var_617d6);
        ...
        highp vec3 var_fe0f6 = var_da3af * ((var_e4f6a * var_7d2be.x) + vec3(var_7d2be.y));
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_f46e7(var_9e696, var_6eb02);
            ...
            var_e2657 = var_6eb02.xyz * ((var_e4f6a * var_864a0.x) + vec3(var_864a0.y));
        }
        else
        {
            var_e2657 = vec3(0.0);
