...
void main() {
    ...
    highp float var_f06d1;
    highp float var_11914;
    highp float var_1d7df;
    ...
    if ((var_f71fc & 1) == 1)
    {
        ...
        var_6757b = var_ae1fa;
        var_1d7df = var_4035b.z;
        var_11914 = var_4035b.y;
        var_f06d1 = var_4035b.x;
    }
    else
    {
        var_6757b = SubsurfaceUniform.x;
        var_1d7df = RoughnessUniform.x;
        var_11914 = EmissiveUniform.x;
        var_f06d1 = MetalnessUniform.x;
    }
    ...
    highp vec4 var_8b20c = vec4(var_a0775.x, var_a0775.y, var_a0775.z, var_1e2a8.w);
    var_8b20c.w *= HudOpacity.x;
    highp vec4 var_d4180 = var_8b20c;
    ...
    highp vec3 var_f0b86 = var_9f386.xyz;
    highp vec3 var_239fe = v_worldPos - WorldOrigin.xyz;
    highp vec3 var_eebcb = dFdx(var_f0b86);
    highp vec3 var_211c8 = dFdy(var_f0b86);
    ...
    highp vec3 var_2b8e0 = var_7c164.xyz;
    highp vec3 var_7298f = (u_view * var_7c164).xyz;
    highp vec3 var_ab59e = vec3(0.039999999105930328369140625 * (1.0 - var_f06d1)) + (var_8b20c.xyz * var_f06d1);
    ...
    if (var_94c07)
    {
        ...
        var_b1591 = pow(var_057f4, float(int(CausticsParameters.z))) * float(int(CausticsParameters.z) + 1);
    }
    else
    {
        var_b1591 = 1.0;
    ...
    highp float var_106e2 = length(var_f0b86);
    highp vec3 var_5bd0a = var_a6bd2;
    highp float var_2a1b2;
    highp vec4 var_9a0a9;
    highp vec3 var_3019f;
    highp vec3 var_cc780;
    if (var_5bd0a.z != 1.0)
    {
        highp vec3 var_53f62 = -(var_f0b86 / vec3(length(var_f0b86) + 9.9999997473787516355514526367188e-05));
        highp float var_83276 = var_6757b * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        highp vec3 var_6cfc2 = var_f0b86;
        ...
        func_6bdcc(var_7a98e, var_c2621, var_7298f, var_b5d88, var_2b8e0, var_6cfc2, var_b1591, var_53f62, var_1d7df, var_ab59e, var_8b20c, var_f06d1, var_83276);
        highp vec3 var_850d6 = var_f0b86;
        ...
        highp vec3 var_cdcc9 = var_f0b86;
        highp vec4 var_e4833;
        highp vec3 var_da80f;
        highp vec3 var_bb1ac;
        func_bd0d0(var_bf718, var_5423d, var_bb1ac, var_da80f, var_e4833, var_cdcc9, var_a6bd2, var_f0b86, var_7298f, var_53f62, var_1d7df, var_ab59e, var_8b20c, var_f06d1, var_83276, var_2c7f3, var_2b8e0);
        var_cc780 = var_7a98e + (var_bb1ac * (1.0 - var_8de40));
        var_3019f = var_c2621 + (var_da80f * (1.0 - var_f999d));
        var_9a0a9 = var_e4833;
        var_2a1b2 = var_8de40;
    }
    else
    ...
    highp float var_505bc;
    if (true)
    {
        var_505bc = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_505bc = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_2a1b2);
    }
    highp vec4 var_dc271 = var_9a0a9;
    highp float var_b3887 = TileLightIntensity.x * TileLightIntensity.x;
    highp vec4 var_7a046 = SkyAmbientLightColorIntensity;
    highp float var_ae708 = TileLightIntensity.y * TileLightIntensity.y;
    ...
    {
        highp float var_79b3e = clamp((((length(var_f0b86) / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) * FogAndDistanceControl.y, 0.0, 1.0);
    ...
    highp vec4 var_69c3c = vec4(var_1bb57, var_bdb1d);
    highp vec4 var_4d2b4 = var_69c3c;
    highp vec4 var_37bc6;
    if (VolumeScatteringEnabledAndPointLightVolumetricsEnabled.x != 0.0)
    {
        ...
        var_37bc6 = mix(textureLod(s_ScatteringBuffer, vec3(var_8cf8f, var_115ba.y, float(var_0e80b)), 0.0), textureLod(s_ScatteringBuffer, vec3(var_8cf8f, var_115ba.y, float(var_0e80b + 1)), 0.0), vec4(clamp(var_14f4f - float(var_0e80b), 0.0, 1.0)));
    }
    else
    {
        var_37bc6 = vec4(0.0, 0.0, 0.0, 1.0);
    }
    highp vec4 var_163c0 = var_37bc6;
    highp vec3 var_642f4;
    if (IBLParameters.x != 0.0)
    {
        ...
        {
            var_dd3fd = (u_view * vec4(var_1d25a, 1.0)).xyz;
            var_a8715 = var_1d25a;
        }
        else
        {
        ...
        highp vec3 var_a56d9 = reflect(normalize(var_a8715 - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_2b8e0);
        highp float var_0f441;
        if (int(ConvolutionType.x) == 1)
        {
            highp float var_9a0e5 = 1.0 - var_1d7df;
            var_0f441 = (1.0 - (var_9a0e5 * var_9a0e5)) * (IBLParameters.y - 1.0);
        }
        else
        {
            highp float var_c17b7 = 1.0 - var_1d7df;
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_619f7(var_f06d1, var_84ff0, var_617d6);
        ...
        highp vec2 var_dea35 = vec2(clamp(dot(var_7298f, -normalize(var_dd3fd)), 0.0, 1.0), var_1d7df);
        var_dea35.y = 1.0 - var_dea35.y;
        highp vec2 var_7d2be = texture(s_BrdfLUT, var_dea35).xy;
        highp vec3 var_fe0f6 = var_da3af * ((var_ab59e * var_7d2be.x) + vec3(var_7d2be.y));
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            if (QuantizationParameters.w > 0.0)
            {
                var_21df9 = (u_view * vec4(var_1d25a, 1.0)).xyz;
            }
            else
            {
                var_21df9 = var_f0b86;
            ...
            func_f46e7(var_f06d1, var_6eb02);
            highp vec2 var_c297e = vec2(clamp(dot(var_7298f, -normalize(var_21df9)), 0.0, 1.0), var_1d7df);
            var_c297e.y = 1.0 - var_c297e.y;
            highp vec2 var_864a0 = texture(s_BrdfLUT, var_c297e).xy;
            var_e2657 = var_6eb02.xyz * ((var_ab59e * var_864a0.x) + vec3(var_864a0.y));
        }
        else
        {
            var_e2657 = vec3(0.0);
    ...
    highp vec3 var_77ab2 = vec4(var_37bc6.xyz + (mix((((((var_8b20c.xyz * (1.0 - var_f06d1)) * max(((clamp(vec3(var_b3887 + (var_dc271.x * var_dc271.w), (var_b3887 * ((((var_b3887 * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_dc271.y * var_dc271.w), (var_b3887 * (((var_b3887 * var_b3887) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_dc271.z * var_dc271.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_505bc) + ((SkyAmbientLightColorIntensity.xyz * mix((var_ae708 * var_ae708) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_7a046.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_cc780) + var_3019f) + (((mix(var_8b20c.xyz, vec3(dot(var_8b20c.xyz, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_11914)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_69c3c.xyz, vec3(var_4d2b4.w)) * var_163c0.w), 1.0).xyz + var_642f4;
    highp vec3 var_cb832;
    if (PreExposureEnabled.x > 0.0)
    {
        var_cb832 = var_77ab2 * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_cb832 = var_77ab2;
