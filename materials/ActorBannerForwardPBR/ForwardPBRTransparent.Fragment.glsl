...
void main() {
    ...
    else
    {
        ...
        var_e2a0f = BannerBasePBRTextureData[2].w;
    ...
    highp vec4 var_00ffb = vec4(var_a0775.x, var_a0775.y, var_a0775.z, var_1e2a8.w);
    var_00ffb.w *= HudOpacity.x;
    highp vec4 var_d4180 = var_00ffb;
    ...
    highp vec3 var_4e1b0 = normalize(transpose(transpose(mat3(normalize(v_tangent), normalize(v_bitangent), normalize(var_276aa)))) * var_7291d);
    highp vec4 var_e72e2 = vec4(var_4e1b0, 1.0);
    ...
    highp vec3 var_5e66d = vec3(0.039999999105930328369140625 * (1.0 - var_e2a0f)) + (var_00ffb.xyz * var_e2a0f);
    ...
    if (var_94c07)
    {
        var_b82c9 = pow((texture(s_CausticsTexture, vec3((v_worldPos - WorldOrigin.xyz).xz * CausticsParameters.y, CausticsTextureParameters.y)).x * 2.0) * clamp(var_4e1b0.y, 0.0, 1.0), CausticsParameters.z) * (CausticsParameters.z + 1.0);
    }
    else
    {
        var_b82c9 = 1.0;
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_b49c3(var_e3304, var_904fd, var_cde66, var_b5d88, var_6c01a, var_6cfc2, var_b82c9, var_9823f, var_7d585, var_5e66d, var_00ffb, var_e2a0f, var_49d92);
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_00725(var_e318f, var_e3304, var_aae12, var_904fd, var_05431, var_f8af5, var_14922, var_cde66, var_9823f, var_7d585, var_5e66d, var_00ffb, var_e2a0f, var_49d92, var_6c01a);
        var_18d46 = var_e318f;
        var_b11a7 = var_aae12;
        var_9a0a9 = var_05431;
    }
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_c697e(var_e2a0f, var_84ff0, var_617d6);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_17044(var_e2a0f, var_6eb02);
    ...
    highp vec3 var_e2e18 = vec4(var_fb193.xyz + (mix(var_90ad7 + (((mix(var_00ffb.xyz, vec3(dot(var_00ffb.xyz, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_b2d9c)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_e43ae.xyz, vec3(var_0fca0.w)) * var_909f4.w), 1.0).xyz + var_ea036;
