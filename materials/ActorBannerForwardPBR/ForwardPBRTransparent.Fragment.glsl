...
void main() {
    ...
    highp float var_a809f;
    highp float var_1f8a8;
    ...
    if ((var_95bcd & 1) == 1)
    {
        ...
        var_5581f = var_0c75b;
        var_1f8a8 = var_fb54f.y;
        var_a809f = var_fb54f.x;
        var_7d585 = var_fb54f.z;
    }
    else
    {
        var_5581f = BannerBasePBRTextureData[3].x;
        var_1f8a8 = BannerBasePBRTextureData[2].z;
        var_a809f = BannerBasePBRTextureData[2].w;
    ...
    highp vec4 var_52721 = vec4(var_0fefe.x, var_0fefe.y, var_0fefe.z, var_1e2a8.w);
    var_52721.w *= HudOpacity.x;
    highp vec4 var_d5ac7 = var_52721;
    ...
    highp vec4 var_ff809;
    highp vec3 var_03a37;
    highp vec3 var_ecb3b;
    if (var_5bd0a.z != 1.0)
    {
        highp vec3 var_9823f = -(var_f8af5 / vec3(length(var_f8af5) + 9.9999997473787516355514526367188e-05));
        highp float var_49d92 = var_5581f * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        ...
        func_1ae9b(var_e3304, var_904fd, var_cde66, var_b5d88, var_6c01a, var_6cfc2, var_b82c9, var_9823f, var_7d585, var_5e66d, var_52721, var_a809f, var_49d92);
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_00725(var_e318f, var_e3304, var_aae12, var_904fd, var_05431, var_f8af5, var_1b088, var_cde66, var_9823f, var_7d585, var_5e66d, var_52721, var_a809f, var_49d92, var_6c01a);
        var_ecb3b = var_e318f;
        var_03a37 = var_aae12;
        var_ff809 = var_05431;
    }
    else
    {
        var_ecb3b = vec3(0.0);
        var_03a37 = vec3(0.0);
        var_ff809 = vec4(0.0, 0.0, 0.0, 1.0);
    }
    highp vec4 var_572e5 = var_ff809;
    highp vec4 var_bdc5c = SkyAmbientLightColorIntensity;
    highp float var_f4fcf = TileLightIntensity.y * TileLightIntensity.y;
    ...
    highp vec4 var_7f6ee = vec4(var_1bb57, var_bdb1d);
    highp vec4 var_2b8d1 = var_7f6ee;
    highp vec4 var_65627;
    if (VolumeScatteringEnabledAndPointLightVolumetricsEnabled.x != 0.0)
    {
        ...
        var_65627 = mix(textureLod(s_ScatteringBuffer, vec3(var_8cf8f, var_115ba.y, float(var_0e80b)), 0.0), textureLod(s_ScatteringBuffer, vec3(var_8cf8f, var_115ba.y, float(var_0e80b + 1)), 0.0), vec4(clamp(var_14f4f - float(var_0e80b), 0.0, 1.0)));
    }
    else
    {
        var_65627 = vec4(0.0, 0.0, 0.0, 1.0);
    }
    highp vec4 var_bf1d2 = var_65627;
    highp vec3 var_80d95 = var_65627.xyz + (mix((((((var_52721.xyz * (1.0 - var_a809f)) * max(((var_bff5e + (var_ff809.xyz * var_572e5.w)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_f4fcf * var_f4fcf) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_bdc5c.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_ecb3b) + var_03a37) + (((mix(var_52721.xyz, vec3(dot(var_52721.xyz, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_1f8a8)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_7f6ee.xyz, vec3(var_2b8d1.w)) * var_bf1d2.w);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_a67e3(var_bff5e, var_a809f, var_713f8, var_26642);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_190ed(var_bff5e, var_a809f, var_da70a);
            ...
            var_e2657 = var_da70a.xyz * ((var_5e66d * var_864a0.x) + vec3(var_864a0.y));
        }
        else
        {
            var_e2657 = vec3(0.0);
    ...
    highp vec3 var_cdd60 = vec4(var_80d95, 1.0).xyz + var_ed4b5;
