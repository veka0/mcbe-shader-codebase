...
layout(std430, binding = 9)buffer s_DirectionalLightSources { LightSourceWorldInfo DirectionalLightSources[]; };
layout(std430, binding = 11)buffer s_LightLookupArray { LightData LightLookupArray[]; };
layout(std430, binding = 12)buffer s_Lights { Light Lights[]; };
...
#endif
#ifndef FORWARD_PBR_ALPHA_TEST_PASS
