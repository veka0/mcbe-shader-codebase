...
void main() {
...
#ifdef CHANGE_COLOR__MULTI
    if (var_e1a93 || (mix(var_f9652.w, var_f9652.w * OverlayColor.w, TintedAlphaTestEnabled.x) < ActorFPEpsilon.x))
#endif
#ifdef CHANGE_COLOR__OFF
    if (var_e1a93 || (mix(var_f9652.w, var_f9652.w * OverlayColor.w, TintedAlphaTestEnabled.x) < 0.5))
#endif
    {
        discard;
    }
    ...
    highp vec4 var_6eb7c = vec4(var_491ab.x, var_491ab.y, var_491ab.z, var_f9652.w);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_3ff27(var_e3304, var_904fd, var_cde66, var_b5d88, var_6c01a, var_6cfc2, var_b82c9, var_9823f, var_d0296, var_c1070, var_c9532, var_c0b30, var_49d92);
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_323af(var_e318f, var_e3304, var_aae12, var_904fd, var_05431, var_f8af5, var_1b088, var_cde66, var_9823f, var_d0296, var_c1070, var_c9532, var_c0b30, var_49d92, var_6c01a);
        var_20513 = var_e318f;
        var_01e0d = var_aae12;
        var_02fd0 = var_05431;
    }
