...
void main() {
    ...
    highp vec3 var_0c9ba = var_491ab.xyz;
    int var_f71fc = int(PBRTextureFlags.x);
    highp float var_cd893;
    highp float var_22953;
    ...
    if ((var_f71fc & 1) == 1)
    {
        ...
        var_22953 = var_4035b.y;
        var_cd893 = var_4035b.x;
    }
    else
    {
        var_6757b = SubsurfaceUniform.x;
        var_99886 = RoughnessUniform.x;
        var_22953 = EmissiveUniform.x;
        var_cd893 = MetalnessUniform.x;
    }
    ...
    highp vec3 var_1f10d = vec3(0.039999999105930328369140625 * (1.0 - var_cd893)) + (var_0c9ba * var_cd893);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_867f5(var_909e9, var_e4584, var_25187, var_b5d88, var_1d5ac, var_6cfc2, var_16236, var_c0c2b, var_99886, var_1f10d, var_0c9ba, var_cd893, var_039d7);
        highp vec4 var_b2434;
        highp vec3 var_79a86;
        highp vec3 var_7ac75;
        func_25f4a(var_7ac75, var_909e9, var_79a86, var_e4584, var_b2434, var_de9ef, var_b7611, var_88136, var_25187, var_c0c2b, var_99886, var_1f10d, var_0c9ba, var_cd893, var_039d7, var_1d5ac);
        var_fc401 = var_7ac75;
        var_03c38 = var_79a86;
        var_9a0a9 = var_b2434;
    }
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_c697e(var_cd893, var_84ff0, var_617d6);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_17044(var_cd893, var_6eb02);
