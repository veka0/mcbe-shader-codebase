...
void main() {
    ...
    highp vec4 var_3b2a6 = vec4(var_1099e.x, var_1099e.y, var_1099e.z, var_a81bc.w);
#endif
#ifdef CHANGE_COLOR__OFF
    highp vec4 var_3b2a6 = var_a81bc;
#endif
    var_3b2a6.w = max(UseAlphaRewrite.x, var_3b2a6.w);
    var_a81bc = var_3b2a6;
    highp vec3 var_491ab = mix((var_3b2a6.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w));
    highp vec4 var_f039a = vec4(var_491ab.x, var_491ab.y, var_491ab.z, var_3b2a6.w);
