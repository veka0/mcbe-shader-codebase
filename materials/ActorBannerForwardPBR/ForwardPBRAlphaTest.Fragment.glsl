...
void main() {
    ...
    highp vec4 var_77f4a = var_2a22e;
    ...
    highp float var_a70a6;
    highp float var_f8913;
    highp float var_c1e72;
    ...
    if ((var_16e32 & 1) == 1)
    {
        ...
        var_5581f = var_0c75b;
        var_c1e72 = var_fb54f.y;
        var_f8913 = var_fb54f.x;
        var_a70a6 = var_fb54f.z;
    }
    else
    {
        var_5581f = BannerBasePBRTextureData[3].x;
        var_c1e72 = BannerBasePBRTextureData[2].z;
        var_f8913 = BannerBasePBRTextureData[2].w;
        var_a70a6 = BannerBasePBRTextureData[2].y;
    }
    ...
    func_66b9c(var_3e08d, var_77f4a);
    ...
    highp vec3 var_2266d = vec3(0.039999999105930328369140625 * (1.0 - var_f8913)) + (var_3e08d * var_f8913);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        highp float var_de864 = var_5581f * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        ...
        func_634be(var_57594, var_59d8b, var_3ad69, var_b5d88, var_f783d, var_6cfc2, var_b82c9, var_dfcb4, var_a70a6, var_2266d, var_3e08d, var_f8913, var_de864);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec3 var_0edfc;
        highp vec3 var_3cf91;
        func_2dd06(var_3cf91, var_57594, var_0edfc, var_59d8b, var_d5e8a, var_86c43, var_3ad69, var_dfcb4, var_a70a6, var_2266d, var_3e08d, var_f8913, var_f783d, var_de864);
#endif
        ...
        var_e51b8 = var_59d8b;
#endif
        var_1163d = ((var_3e08d * (1.0 - var_f8913)) * max((var_b9249 * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_fc65f * var_fc65f) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_3df32.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w;
        var_48867 = ((mix(var_3e08d, vec3(dot(var_3e08d, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_c1e72)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x;
    }
    else
    {
        var_f7210 = vec3(0.0);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        {
            highp float var_9a0e5 = 1.0 - var_a70a6;
            var_0f441 = (1.0 - (var_9a0e5 * var_9a0e5)) * (IBLParameters.y - 1.0);
        }
        else
        {
            highp float var_c17b7 = 1.0 - var_a70a6;
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_d903a(var_a8c9c, var_f8913, var_713f8, var_26642);
        ...
        highp vec2 var_dea35 = vec2(clamp(dot(var_3ad69, -normalize(var_dd3fd)), 0.0, 1.0), var_a70a6);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_769bb(var_a8c9c, var_f8913, var_da70a);
            highp vec2 var_c297e = vec2(clamp(dot(var_3ad69, -normalize(var_21df9)), 0.0, 1.0), var_a70a6);
