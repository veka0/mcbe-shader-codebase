...
void main() {
    ...
    else
    {
        ...
        var_e2390 = BannerBasePBRTextureData[2].w;
    ...
    func_66b9c(var_5351f, var_77f4a);
    ...
    highp vec3 var_c1070 = vec3(0.039999999105930328369140625 * (1.0 - var_e2390)) + (var_5351f * var_e2390);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_634be(var_f6f76, var_357df, var_cde66, var_b5d88, var_8bebe, var_6cfc2, var_b82c9, var_9823f, var_7d585, var_c1070, var_5351f, var_e2390, var_11a4a);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_24fc3;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_95aa8(var_e318f, var_f6f76, var_aae12, var_357df, var_24fc3, var_6aed3, var_0daae, var_cde66, var_9823f, var_7d585, var_c1070, var_5351f, var_e2390, var_8bebe, var_11a4a);
#endif
...
#ifdef POINT_LIGHT_SHADING__OFF
        var_e51b8 = var_357df;
        var_f2114 = ((var_5351f * (1.0 - var_e2390)) * max((var_62212 * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_8f051 * var_8f051) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_a73c9.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w;
#endif
#ifdef POINT_LIGHT_SHADING__ON
        var_f2114 = ((var_5351f * (1.0 - var_e2390)) * max(((var_62212 + (var_24fc3.xyz * var_890ad.w)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_8f051 * var_8f051) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_a73c9.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w;
#endif
        var_48867 = ((mix(var_5351f, vec3(dot(var_5351f, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_c1e72)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x;
    }
    else
    {
        var_f7210 = vec3(0.0);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_d903a(var_a8c9c, var_e2390, var_713f8, var_26642);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_769bb(var_a8c9c, var_e2390, var_da70a);
