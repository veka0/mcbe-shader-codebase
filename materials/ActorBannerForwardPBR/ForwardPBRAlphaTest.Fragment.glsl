...
void main() {
    ...
    if ((var_16e32 & 1) == 1)
    {
        ...
        var_5581f = var_0c75b;
        var_a8f5c = var_fb54f.y;
        var_c35ea = var_fb54f.x;
        var_7d585 = var_fb54f.z;
    }
    else
    {
        var_5581f = BannerBasePBRTextureData[3].x;
        var_a8f5c = BannerBasePBRTextureData[2].z;
        var_c35ea = BannerBasePBRTextureData[2].w;
    ...
    func_66b9c(var_b8af5, var_77f4a);
    ...
    highp vec3 var_c1070 = vec3(0.039999999105930328369140625 * (1.0 - var_c35ea)) + (var_b8af5 * var_c35ea);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_634be(var_f6f76, var_357df, var_cde66, var_b5d88, var_3c004, var_6cfc2, var_b82c9, var_9823f, var_7d585, var_c1070, var_b8af5, var_c35ea, var_11a4a);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_95aa8(var_e318f, var_f6f76, var_aae12, var_357df, var_05431, var_6aed3, var_0daae, var_cde66, var_9823f, var_7d585, var_c1070, var_b8af5, var_c35ea, var_3c004, var_11a4a);
        var_98bf2 = var_e318f;
#endif
...
#ifdef POINT_LIGHT_SHADING__ON
    highp vec3 var_12456 = var_a3223.xyz + (mix((((((var_b8af5 * (1.0 - var_c35ea)) * max(((var_d1d0a + (var_02fd0.xyz * var_b63c1.w)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_123aa * var_123aa) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_21a19.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_98bf2) + var_f5e5a) + (((mix(var_b8af5, vec3(dot(var_b8af5, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_a8f5c)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_025c1.xyz, vec3(var_0343d.w)) * var_c88f4.w);
#endif
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_d903a(var_5b71e, var_c35ea, var_713f8, var_26642);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_769bb(var_5b71e, var_c35ea, var_da70a);
...
#ifdef POINT_LIGHT_SHADING__OFF
    highp vec3 var_54609 = vec4(var_a3223.xyz + (mix((((((var_b8af5 * (1.0 - var_c35ea)) * max((var_d1d0a * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_123aa * var_123aa) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_21a19.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_98bf2) + var_f5e5a) + (((mix(var_b8af5, vec3(dot(var_b8af5, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_a8f5c)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_025c1.xyz, vec3(var_0343d.w)) * var_c88f4.w), 1.0).xyz + var_082f4;
#endif
#ifdef POINT_LIGHT_SHADING__ON
