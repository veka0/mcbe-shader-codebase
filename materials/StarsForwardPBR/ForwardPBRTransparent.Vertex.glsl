...
* - layout(binding = 6, std430) buffer s_zGpuEntryBufferBuffer { GpuVolumeEntry s_zGpuEntryBuffer[]; };
...
* - layout(binding = 9, std430) buffer s_zVoxelBufferBuffer { VoxelNode s_zVoxelBuffer[]; };
*
* Uniforms:
...
#endif
    vec4 var_e600e = u_viewProj * vec4(var_12727.xyz, 1.0);
    vec4 var_52536 = var_e600e;
    v_color0 = a_color0;
    v_ndcPosition = var_e600e.xyz / vec3(var_52536.w);
    v_texcoord0 = a_texcoord0;
    v_worldPos = var_12727.xyz;
    gl_Position = var_e600e;
}
