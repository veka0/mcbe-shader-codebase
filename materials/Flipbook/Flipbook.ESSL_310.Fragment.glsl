...
void Frag(FragmentInput fragInput, inout FragmentOutput fragOutput) {
    vec4 colorFrom = textureSample(s_BlitTexture, fragInput.texcoord0);
    vec4 colorTo = textureSample(s_BlitTexture, fragInput.texcoord1);
...
void main() {
    ...
    fragmentInput.texcoord1 = v_texcoord1;
