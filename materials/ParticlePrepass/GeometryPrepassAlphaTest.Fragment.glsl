...
void main() {
    ...
    highp float var_47961;
    highp float var_a5026;
    ...
    if ((var_bec18 & 1) == 1)
    {
        ...
        var_46b2c = var_b362d;
        var_a5026 = var_4035b.z;
        var_47961 = var_4035b.y;
        var_b8805 = var_4035b.x;
    }
    else
    {
        var_46b2c = MERSUniforms.w;
        var_a5026 = MERSUniforms.z;
        var_47961 = MERSUniforms.y;
    ...
    highp vec2 var_b3cde = v_ambientLight;
    ...
    bgfx_FragData2 = vec4(var_47961, var_b3cde.x, var_b3cde.y, var_a5026);
}
