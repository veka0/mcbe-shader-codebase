...
void main() {
    ...
    highp vec3 var_dc301 = var_9f386.xyz;
    ...
    highp vec3 var_52077 = var_dc301;
    highp vec3 var_5bd0a = var_9bf42;
    highp vec3 var_811e1 = var_dc301;
    ...
    highp vec3 var_5e63f = -(var_dc301 / vec3(length(var_dc301) + 9.9999997473787516355514526367188e-05));
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_41385(var_c65bf, var_9aeed, var_d502d, var_52077, var_2e47d, var_5e63f, var_c6556, var_90cb8, var_e9457);
        highp vec3 var_37f56 = var_dc301;
        highp vec4 var_80f9e;
        highp vec3 var_e56ac;
        highp vec3 var_dab42;
        bool var_b8e14;
        func_0666b(var_23ea0, var_7b52a, var_b8e14, var_dab42, var_e56ac, var_80f9e, var_37f56, var_9bf42, var_dc301, var_d502d, var_5e63f, var_c6556, var_90cb8, var_e9457, var_beb41);
    ...
    highp float var_7d5ab = length(var_dc301);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp vec2 var_d0ceb = texture(s_BrdfLUT, vec2(clamp(dot(var_d502d, -(var_dc301 / vec3(length(var_dc301)))), 0.0, 1.0), MERSUniforms.z)).xy;
        highp vec3 var_94472 = ((var_b1eea * (pow(clamp(((TileLightIntensity.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0), 3.0) * IBLParameters.x)) * IBLParameters.z) * ((var_c6556 * var_d0ceb.x) + vec3(var_d0ceb.y));
        highp float var_96068 = length(var_dc301);
