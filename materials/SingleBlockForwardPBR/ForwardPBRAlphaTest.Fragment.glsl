...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_2c95e(var_e3304, var_904fd, var_25fea, var_b5d88, var_62f02, var_6cfc2, var_b82c9, var_9823f, var_03647, var_ba11f, var_0a3e4, var_23f09, var_11a4a);
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_d7f93(var_e318f, var_e3304, var_aae12, var_904fd, var_05431, var_8e673, var_78725, var_25fea, var_9823f, var_03647, var_ba11f, var_0a3e4, var_23f09, var_62f02, var_11a4a);
        var_20513 = var_e318f;
        var_01e0d = var_aae12;
        var_02fd0 = var_05431;
    }
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_f1037(var_1a27a, var_23f09, var_713f8, var_26642);
