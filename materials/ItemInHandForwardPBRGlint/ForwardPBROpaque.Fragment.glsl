...
layout(binding = 4, std430) buffer s_Lights { Light Lights[]; } var_67ee9;
layout(binding = 3, std430) buffer s_LightLookupArray { LightData LightLookupArray[]; } var_72e22;
...
void func_b006e(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_02c40, inout highp vec3 arg_326a5, inout highp vec3 arg_abe00, inout highp vec2 arg_c288e, inout highp vec3 arg_99739, inout highp vec4 arg_99edd, inout highp vec3 arg_85276, inout highp vec3 arg_df759, inout highp float arg_24e02) {
...
void func_1799c(inout int arg_47a77, inout highp float arg_9eee0, inout highp vec3 arg_0623c, inout highp vec3 arg_1bb2e) {
    if (var_67ee9.Lights[arg_47a77].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        return;
    }
    highp vec3 loc_2b15e = arg_0623c - var_67ee9.Lights[arg_47a77].position.xyz;
    ...
    if (((textureLod(s_PointLightShadowTextureArray, vec4(loc_ad23e, float(var_67ee9.Lights[arg_47a77].shadowProbeIndex)), 0.0).x * 2.0) - 1.0) >= loc_f7c8d.z)
    {
        loc_591c8 = 1.0;
    }
    else
...
void func_deced(inout highp vec4 arg_83841, inout int arg_50e58, inout highp vec3 arg_62394, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_569de = var_67ee9.Lights[arg_50e58].position.xyz - v_worldPos;
    ...
    if (loc_95cea >= (var_67ee9.Lights[arg_50e58].position.w * var_67ee9.Lights[arg_50e58].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_fd676 = loc_95cea / ((var_67ee9.Lights[arg_50e58].position.w * var_67ee9.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    highp vec3 loc_13960 = var_67ee9.Lights[arg_50e58].color.xyz * loc_3d192;
    arg_83841 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_83841.w);
    arg_83841.w = 1.0 - (loc_95cea / ((var_67ee9.Lights[arg_50e58].position.w * var_67ee9.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05));
    arg_62394 = (((var_67ee9.Lights[arg_50e58].color.xyz * var_67ee9.Lights[arg_50e58].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_b86b4(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_6ff9e, inout highp vec3 arg_901f6, inout highp vec4 arg_336ff, inout highp vec3 arg_20396, inout highp vec3 arg_ef8ef, inout highp float arg_fe933, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    {
        int loc_2cc07 = int(var_72e22.LightLookupArray[loc_0ad25].lookup);
        if (loc_2cc07 < 0)
        {
            break;
        }
        highp vec3 loc_a3520 = normalize((u_view * vec4(var_67ee9.Lights[loc_2cc07].position.xyz, 1.0)).xyz - arg_89c41);
...
void func_66c95(inout highp vec4 arg_53721, inout highp vec3 arg_ec4b7, inout highp vec4 arg_85834) {
    highp vec3 loc_4e0d1 = (AmbientLightParams.xyz * arg_53721.x) * AmbientLightParams.w;
    if (dot(arg_ec4b7, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875)) >= dot(loc_4e0d1, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875)))
    {
        arg_85834 = vec4(0.0);
        return;
    }
    arg_85834 = vec4(loc_4e0d1, 1.0);
}
void main() {
#ifdef MULTI_COLOR_TINT__OFF
    highp vec4 var_6f02f = v_color0;
#endif
    highp vec4 var_ad0eb = v_mers;
...
#endif
    var_2d773.w = 1.0;
    highp vec3 var_ef784 = pow(max(var_2d773.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    ...
    highp vec3 var_5f5a7 = var_9f386.xyz;
    highp vec3 var_9058a = var_89669.xyz;
    highp vec3 var_89d84 = (u_view * var_89669).xyz;
    highp vec3 var_5b7fb = vec3(0.039999999105930328369140625 * (1.0 - var_ad0eb.x)) + (var_ef784 * var_ad0eb.x);
    ...
    highp float var_b1b50 = length(var_5f5a7);
    highp vec3 var_ff1bd = var_5f5a7;
    highp vec3 var_5bd0a = var_adfcf;
    highp vec3 var_811e1 = var_5f5a7;
    ...
    highp vec3 var_16ec3 = -(var_5f5a7 / vec3(length(var_5f5a7) + 9.9999997473787516355514526367188e-05));
    highp float var_bd7bd = var_ad0eb.w * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
    highp vec3 var_5a0c9;
    if (ShadowQuantizationParameters.y > 0.0)
    {
        ...
        var_5a0c9 = (var_8ae03 - (var_24b50 - (var_ce28e * dot(var_24b50, var_ce28e)))) + WorldOrigin.xyz;
    }
    else
    {
        var_5a0c9 = v_worldPos;
    }
    bool var_5a6e4;
    highp vec4 var_9a0a9;
    highp vec3 var_e16ff;
    highp vec3 var_47bcf;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_d9f8b = vec2(var_49182, var_280ef);
        highp vec3 var_2a503;
        highp vec3 var_8efb6;
        func_b006e(var_8efb6, var_2a503, var_89d84, var_5a0c9, var_ff1bd, var_d9f8b, var_16ec3, var_ad0eb, var_5b7fb, var_ef784, var_bd7bd);
        highp vec3 var_6bb48 = var_5f5a7;
        highp vec4 var_1b4da;
        highp vec3 var_c1a13;
        highp vec3 var_da80f;
        bool var_716f8;
        func_b86b4(var_37230, var_8ba1b, var_716f8, var_da80f, var_c1a13, var_1b4da, var_6bb48, var_adfcf, var_5f5a7, var_89d84, var_16ec3, var_ad0eb, var_5b7fb, var_ef784, var_bd7bd, var_5a0c9, var_9058a);
        var_47bcf = var_8efb6 + (var_da80f * (1.0 - var_f3062));
        var_e16ff = var_2a503 + (var_c1a13 * (1.0 - var_5d160));
        var_9a0a9 = var_1b4da;
        var_5a6e4 = var_716f8;
    }
    else
    ...
    highp float var_7e012;
    if (var_5a6e4)
    {
        var_7e012 = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_7e012 = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_97c31 = var_9a0a9;
    highp vec4 var_093c6 = SkyAmbientLightColorIntensity;
    highp float var_473c0 = TileLightIntensity.x * TileLightIntensity.x;
    highp vec3 var_efe25 = (((((var_ef784 * (1.0 - var_ad0eb.x)) * max(((clamp(vec3(var_473c0 + (var_97c31.x * var_97c31.w), (var_473c0 * ((((var_473c0 * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_97c31.y * var_97c31.w), (var_473c0 * (((var_473c0 * var_473c0) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_97c31.z * var_97c31.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_7e012) + ((SkyAmbientLightColorIntensity.xyz * pow(TileLightIntensity.y, mix(5.0, 3.0, CameraLightIntensity.y))) * var_093c6.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_47bcf) + var_e16ff) + (((mix(var_ef784, vec3(dot(var_ef784, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_ad0eb.y)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x);
    highp float var_7d5ab = length(var_5f5a7);
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_efe25, var_08c70, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_efe25;
    ...
    {
        var_7e3dc = mix(var_efe25, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp float var_31f67 = 1.0 - var_ad0eb.z;
        ...
        func_66c95(var_ad0eb, var_76060, var_20f77);
        ...
        highp vec2 var_745fd = vec2(clamp(dot(var_89d84, -(var_5f5a7 / vec3(var_b1b50))), 0.0, 1.0), var_ad0eb.z);
        var_745fd.y = 1.0 - var_745fd.y;
        highp vec2 var_7d2be = texture(s_BrdfLUT, var_745fd).xy;
        highp vec3 var_fe0f6 = var_d97f1 * ((var_5b7fb * var_7d2be.x) + vec3(var_7d2be.y));
        highp vec3 var_67472;
        if (AtmosphericScatteringToggles.x != 0.0)
        {
            var_67472 = var_fe0f6 * (1.0 - clamp((((var_b1b50 / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) * FogAndDistanceControl.y, 0.0, 1.0));
        }
        else
        {
            var_67472 = var_fe0f6 * (1.0 - clamp((((var_b1b50 / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0));
        }
    ...
    {
        highp vec2 var_d109b = vec2(clamp(dot(var_89d84, -(var_5f5a7 / vec3(var_b1b50))), 0.0, 1.0), var_ad0eb.z);
        var_d109b.y = 1.0 - var_d109b.y;
        highp vec2 var_e1a71 = texture(s_BrdfLUT, var_d109b).xy;
        var_4256a = ((AmbientLightParams.xyz * var_ad0eb.x) * AmbientLightParams.w) * ((var_5b7fb * var_e1a71.x) + vec3(var_e1a71.y));
    }
    highp vec3 var_cdd60 = vec4(var_28cb8, 1.0).xyz + var_4256a;
    highp vec3 var_bbce3;
    if (PreExposureEnabled.x > 0.0)
    {
        var_bbce3 = var_cdd60 * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_bbce3 = var_cdd60;
