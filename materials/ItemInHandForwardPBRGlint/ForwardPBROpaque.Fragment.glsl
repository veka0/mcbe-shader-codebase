...
layout(binding = 4, std430) buffer s_Lights { Light Lights[]; } var_7daa1;
layout(binding = 3, std430) buffer s_LightLookupArray { LightData LightLookupArray[]; } var_5ca60;
...
void func_418d3(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_02c40, inout highp vec3 arg_abe00, inout highp vec2 arg_c288e, inout highp vec3 arg_99739, inout highp vec4 arg_99edd, inout highp vec3 arg_85276, inout highp vec3 arg_df759, inout highp float arg_24e02) {
    ...
    for (int loc_a5f76 = 0; loc_a5f76 < loc_a14ca; loc_0bf4d = loc_3ac48, loc_122db = loc_12766, loc_7a912 = loc_f5dfb, loc_bd26f = loc_1a85e, loc_a5f76++)
    {
        ...
        highp float loc_65ed4 = arg_99edd.z * arg_99edd.z;
        highp float loc_e5081 = loc_65ed4 * loc_65ed4;
...
void func_51637(inout int arg_3cd09, inout highp float arg_c05a6, inout highp vec3 arg_214f6) {
    if (var_7daa1.Lights[arg_3cd09].shadowProbeIndex < 0)
    {
        arg_c05a6 = 1.0;
        return;
    }
    highp vec3 loc_3566a = v_worldPos - var_7daa1.Lights[arg_3cd09].position.xyz;
    ...
    for (int loc_1139b = 0; loc_1139b < 4; loc_54d10 = loc_f6f3d, loc_1139b++)
    {
        ...
        for (int loc_79fcd = 0; loc_79fcd < 4; loc_f6f3d = loc_bbf51, loc_79fcd++)
        {
            ...
            loc_7004c.z = float(var_7daa1.Lights[arg_3cd09].shadowProbeIndex * 6) + loc_7004c.z;
...
void func_79cb8(inout highp vec4 arg_22524, inout int arg_c8e98, inout highp vec3 arg_62394, inout highp vec3 arg_154f5) {
    ...
    highp vec3 loc_569de = var_7daa1.Lights[arg_c8e98].position.xyz - v_worldPos;
    ...
    if (loc_3bcb9 >= (var_7daa1.Lights[arg_c8e98].position.w * var_7daa1.Lights[arg_c8e98].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_8a6f3 = loc_3bcb9 / (var_7daa1.Lights[arg_c8e98].position.w * var_7daa1.Lights[arg_c8e98].position.w);
    ...
    highp vec3 loc_13960 = var_7daa1.Lights[arg_c8e98].color.xyz * loc_3d192;
    arg_22524 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_22524.w);
    arg_22524.w = 1.0 - (loc_3bcb9 / (var_7daa1.Lights[arg_c8e98].position.w * var_7daa1.Lights[arg_c8e98].position.w));
    arg_62394 = (((var_7daa1.Lights[arg_c8e98].color.xyz * var_7daa1.Lights[arg_c8e98].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_2955f(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_6ff9e, inout highp vec3 arg_901f6, inout highp vec4 arg_336ff, inout highp vec3 arg_20396, inout highp vec3 arg_ef8ef, inout highp float arg_fe933, inout highp vec3 arg_81f82) {
    ...
    {
        int loc_ee051 = int(var_5ca60.LightLookupArray[loc_0ad25].lookup);
        if (loc_ee051 < 0)
        {
            break;
        }
        highp vec3 loc_a3520 = normalize((u_view * vec4(var_7daa1.Lights[loc_ee051].position.xyz, 1.0)).xyz - arg_89c41);
        ...
        if (arg_b6724)
        {
            ...
            if (arg_9a2b4)
            {
                ...
                highp float loc_d0615 = arg_336ff.z * arg_336ff.z;
                highp float loc_3f332 = loc_d0615 * loc_d0615;
                ...
                loc_31e9d = (loc_e2c52 * vec3(0.3183098733425140380859375)) * (arg_fe933 * max((dot(-arg_6ff9e, loc_a3520) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / ((1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) * (1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y)), 0.0));
                loc_e0df3 = ((vec3(1.0) - loc_481af) * mix(loc_a6fcb, max((dot(arg_6ff9e, loc_a3520) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / ((1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) * (1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y)), 0.0), arg_fe933)) * (loc_e2c52 * vec3(0.3183098733425140380859375));
            }
            else
            {
                highp vec3 loc_0f410 = arg_ef8ef * (1.0 - arg_336ff.x);
                loc_0a326 = vec3(0.0);
                loc_31e9d = (loc_0f410 * vec3(0.3183098733425140380859375)) * (arg_fe933 * max((dot(-arg_6ff9e, loc_a3520) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / ((1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) * (1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y)), 0.0));
                loc_e0df3 = (loc_0f410 * vec3(0.3183098733425140380859375)) * mix(max(dot(arg_6ff9e, loc_a3520), 0.0), max((dot(arg_6ff9e, loc_a3520) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / ((1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) * (1.0 + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y)), 0.0), arg_fe933);
            }
            loc_b2ace = loc_0a326;
            loc_05c79 = loc_31e9d;
            loc_12949 = loc_e0df3;
        ...
        else
        {
            ...
            if (arg_9a2b4)
            {
                ...
                highp float loc_7685b = arg_336ff.z * arg_336ff.z;
                highp float loc_dc1e8 = loc_7685b * loc_7685b;
                ...
                highp float loc_04f70 = loc_7685b * 0.5;
...
void main() {
...
#endif
    var_2d773.w = 1.0;
    highp vec3 var_f4930 = pow(max(var_2d773.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    ...
    highp vec3 var_dde88 = var_9f386.xyz;
    highp vec3 var_660ac = var_89669.xyz;
    highp vec3 var_76f6c = (u_view * var_89669).xyz;
    highp vec3 var_4746f = vec3(0.039999999105930328369140625 * (1.0 - var_3b20b.x)) + (var_f4930 * var_3b20b.x);
    ...
    highp vec3 var_01682 = var_dde88;
    highp vec3 var_5bd0a = var_88136;
    highp vec3 var_811e1 = var_dde88;
    ...
    if (!var_49ba4)
    {
        var_97950 = var_464cb && (var_3707d < PointLightSpecularFadeOutParameters.y);
    }
    else
    {
        var_97950 = var_49ba4;
    ...
    if (!var_70859)
    {
        var_9f936 = var_686c7 && (var_3707d < PointLightDiffuseFadeOutParameters.y);
    }
    else
    {
        var_9f936 = var_70859;
    }
    highp vec3 var_e1519 = -(var_dde88 / vec3(length(var_dde88)));
    highp float var_dff00 = var_3b20b.w * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
    bool var_5a6e4;
    highp vec4 var_9a0a9;
    highp vec3 var_ffc6a;
    highp vec3 var_67c32;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_ab011 = vec2(var_49182, var_280ef);
        highp vec3 var_d35f7;
        highp vec3 var_eddfe;
        func_418d3(var_eddfe, var_d35f7, var_76f6c, var_01682, var_ab011, var_e1519, var_3b20b, var_4746f, var_f4930, var_dff00);
        highp vec3 var_6844f = var_dde88;
        highp vec4 var_20f7d;
        highp vec3 var_bb3e9;
        highp vec3 var_5aa7a;
        bool var_f26f2;
        func_2955f(var_97950, var_9f936, var_f26f2, var_5aa7a, var_bb3e9, var_20f7d, var_6844f, var_88136, var_dde88, var_76f6c, var_e1519, var_3b20b, var_4746f, var_f4930, var_dff00, var_660ac);
        var_67c32 = var_eddfe + (var_5aa7a * (1.0 - var_f3062));
        var_ffc6a = var_d35f7 + (var_bb3e9 * (1.0 - var_5d160));
        var_9a0a9 = var_20f7d;
        var_5a6e4 = var_f26f2;
    }
    else
    ...
    highp float var_e5086;
    if (var_5a6e4)
    {
        var_e5086 = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_e5086 = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_37619 = var_9a0a9;
    highp vec4 var_a52b3 = SkyAmbientLightColorIntensity;
    highp float var_5e767 = TileLightIntensity.x * TileLightIntensity.x;
    highp vec3 var_fa234 = (((((var_f4930 * (1.0 - var_3b20b.x)) * max(((clamp(vec3(var_5e767 + (var_37619.x * var_37619.w), (var_5e767 * ((((var_5e767 * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_37619.y * var_37619.w), (var_5e767 * (((var_5e767 * var_5e767) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_37619.z * var_37619.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_e5086) + ((SkyAmbientLightColorIntensity.xyz * pow(TileLightIntensity.y, mix(5.0, 3.0, CameraLightIntensity.y))) * var_a52b3.w), vec3(0.02999999932944774627685546875))) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_67c32) + var_ffc6a) + (((mix(var_f4930, vec3(dot(var_f4930, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_3b20b.y)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x);
    highp float var_7d5ab = length(var_dde88);
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_fa234, var_a6488, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_fa234;
    ...
    {
        var_7e3dc = mix(var_fa234, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
    highp vec3 var_28cb8;
    if (VolumeScatteringEnabledAndPointLightVolumetricsEnabled.x != 0.0)
    {
        highp vec2 var_65315 = VolumeNearFar.xy;
        highp vec2 var_7d045 = (var_88136.xy + vec2(1.0)) * 0.5;
    ...
    {
        highp vec3 var_7914f = reflect(normalize(v_worldPos - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_660ac);
        ...
        highp float var_31f67 = 1.0 - var_3b20b.z;
        highp float var_59d83 = (1.0 - (var_31f67 * var_31f67)) * (IBLParameters.y - 1.0);
        ...
        highp vec2 var_f0e43 = texture(s_BrdfLUT, vec2(clamp(dot(var_76f6c, -(var_dde88 / vec3(length(var_dde88)))), 0.0, 1.0), var_3b20b.z)).xy;
        highp vec3 var_94472 = ((var_9aad8 * (pow(clamp(((TileLightIntensity.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0), 3.0) * IBLParameters.x)) * IBLParameters.z) * ((var_4746f * var_f0e43.x) + vec3(var_f0e43.y));
        highp float var_96068 = length(var_dde88);
    ...
    highp vec3 var_b2ac7;
    if (PreExposureEnabled.x > 0.0)
    {
        var_b2ac7 = var_be237 * (0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x);
    }
    else
    {
        var_b2ac7 = var_be237;
    ...
    bgfx_FragData[0] = vec4(var_b2ac7.x, var_b2ac7.y, var_b2ac7.z, vec4(var_5e514, var_5e514, var_5e514, 1.0).w);
