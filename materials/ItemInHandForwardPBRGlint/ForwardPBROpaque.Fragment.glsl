...
void main() {
    ...
    func_66b9c(var_cbc5c, var_f5c7b);
    ...
    if (PreExposureEnabled.x > 0.0)
    {
        var_ff289 = var_edfc1 * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_ff289 = var_edfc1;
