...
void main() {
...
#endif
    var_2d773.w = 1.0;
    highp vec3 var_67277 = pow(max(var_2d773.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    ...
    highp vec3 var_437cc = vec3(0.039999999105930328369140625 * (1.0 - var_27969.x)) + (var_67277 * var_27969.x);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_a661a(var_e1a09, var_b3aa0, var_44af1, var_0b07e, var_3a700, var_1bccf, var_b5763, var_3b401, var_27969, var_437cc, var_67277, var_5668f);
        highp vec4 var_648c3;
        highp vec3 var_0edfc;
        highp vec3 var_3cf91;
        func_dda62(var_3cf91, var_e1a09, var_0edfc, var_b3aa0, var_648c3, var_86c43, var_58684, var_44af1, var_3b401, var_27969, var_437cc, var_67277, var_5668f, var_3a700);
        var_dffc0 = var_3cf91;
        var_b83d3 = var_0edfc;
        var_9a0a9 = var_648c3;
    }
    ...
    highp vec3 var_a708f = vec4(var_c3571.xyz + (mix((var_d8dd8 + var_b83d3) + (((mix(var_67277, vec3(dot(var_67277, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_27969.y)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_08b37.xyz, vec3(var_522ce.w)) * var_219a1.w), 1.0).xyz + var_4a21f;
