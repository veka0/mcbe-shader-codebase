...
void main() {
...
#endif
    var_2d773.w = 1.0;
    highp vec3 var_5d568 = pow(max(var_2d773.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    ...
    highp vec3 var_5b7fb = vec3(0.039999999105930328369140625 * (1.0 - var_0df36.x)) + (var_5d568 * var_0df36.x);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_b006e(var_8efb6, var_2a503, var_89d84, var_5a0c9, var_ff1bd, var_d9f8b, var_16ec3, var_0df36, var_5b7fb, var_5d568, var_bd7bd);
        highp vec3 var_6bb48 = var_5f5a7;
        highp vec4 var_1b4da;
        highp vec3 var_c1a13;
        highp vec3 var_da80f;
        bool var_716f8;
        func_b86b4(var_37230, var_8ba1b, var_716f8, var_da80f, var_c1a13, var_1b4da, var_6bb48, var_adfcf, var_5f5a7, var_89d84, var_16ec3, var_0df36, var_5b7fb, var_5d568, var_bd7bd, var_5a0c9, var_9058a);
