...
layout(binding = 4, std430) buffer s_Lights { Light Lights[]; } var_62c13;
...
void func_9cbf2(inout int arg_47a77, inout highp float arg_9eee0, inout highp vec3 arg_0623c, inout highp vec3 arg_147a6) {
    if (var_62c13.Lights[arg_47a77].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        return;
    }
    highp vec3 loc_8d02b = arg_0623c - var_62c13.Lights[arg_47a77].position.xyz;
    ...
    if (((textureLod(s_PointLightShadowTextureArray, vec4(loc_ad23e, float(var_62c13.Lights[arg_47a77].shadowProbeIndex)), 0.0).x * 2.0) - 1.0) >= loc_61d0d.z)
    {
        loc_591c8 = 1.0;
    }
    else
...
void func_deced(inout highp vec4 arg_83841, inout int arg_50e58, inout highp vec3 arg_62394, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_569de = var_62c13.Lights[arg_50e58].position.xyz - v_worldPos;
    ...
    if (loc_95cea >= (var_62c13.Lights[arg_50e58].position.w * var_62c13.Lights[arg_50e58].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_fd676 = loc_95cea / ((var_62c13.Lights[arg_50e58].position.w * var_62c13.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    highp vec3 loc_13960 = var_62c13.Lights[arg_50e58].color.xyz * loc_3d192;
    arg_83841 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_83841.w);
    arg_83841.w = 1.0 - (loc_95cea / ((var_62c13.Lights[arg_50e58].position.w * var_62c13.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05));
    arg_62394 = (((var_62c13.Lights[arg_50e58].color.xyz * var_62c13.Lights[arg_50e58].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_904b6(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_e4e64, inout highp vec3 arg_061f9, inout highp vec4 arg_0791b, inout highp vec3 arg_04538, inout highp vec3 arg_ef8ef, inout highp float arg_c50ac, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_8c356 = normalize((u_view * vec4(var_62c13.Lights[loc_2cc07].position.xyz, 1.0)).xyz - arg_89c41);
        ...
        if (arg_b6724)
        {
            ...
            if (arg_9a2b4)
            {
                ...
                loc_577c9 = (loc_3fba7 * vec3(0.3183098733425140380859375)) * (arg_c50ac * max((dot(-arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_2e0cd * loc_2e0cd), 0.0));
                loc_6cd2d = ((vec3(1.0) - loc_1800c) * mix(loc_dad67, max((dot(arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_57238 * loc_57238), 0.0), arg_c50ac)) * (loc_3fba7 * vec3(0.3183098733425140380859375));
            }
            else
            {
                ...
                loc_0a326 = vec3(0.0);
                loc_577c9 = (loc_37b65 * vec3(0.3183098733425140380859375)) * (arg_c50ac * max((dot(-arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_0a512 * loc_0a512), 0.0));
                loc_6cd2d = (loc_37b65 * vec3(0.3183098733425140380859375)) * mix(max(dot(arg_e4e64, loc_8c356), 0.0), max((dot(arg_e4e64, loc_8c356) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_36134 * loc_36134), 0.0), arg_c50ac);
            }
            loc_b2ace = loc_0a326;
            loc_05c79 = loc_577c9;
            loc_12949 = loc_6cd2d;
...
void main() {
...
#endif
    var_2d773.w = 1.0;
    highp vec3 var_05a8d = pow(max(var_2d773.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    ...
    highp vec3 var_7a7d4 = vec3(0.039999999105930328369140625 * (1.0 - var_dbfa1.x)) + (var_05a8d * var_dbfa1.x);
    ...
    highp float var_c7a69 = var_dbfa1.w * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
    ...
    highp vec3 var_1a92a;
    highp vec3 var_711ed;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_1e6e5 = vec2(var_49182, var_280ef);
        highp vec3 var_1d975;
        highp vec3 var_3d209;
        func_7a41e(var_3d209, var_1d975, var_0c980, var_01411, var_7e127, var_2adb7, var_1e6e5, var_bb868, var_dbfa1, var_7a7d4, var_05a8d, var_c7a69);
        highp vec3 var_6bb48 = var_5ae75;
        highp vec4 var_1b4da;
        highp vec3 var_c1a13;
        highp vec3 var_da80f;
        bool var_716f8;
        func_904b6(var_37230, var_8ba1b, var_716f8, var_da80f, var_c1a13, var_1b4da, var_6bb48, var_adfcf, var_5ae75, var_0c980, var_bb868, var_dbfa1, var_7a7d4, var_05a8d, var_c7a69, var_01411, var_7e127);
        var_711ed = var_3d209 + (var_da80f * (1.0 - var_f3062));
        var_1a92a = var_1d975 + (var_c1a13 * (1.0 - var_5d160));
        var_9a0a9 = var_1b4da;
        var_5a6e4 = var_716f8;
    }
    else
    ...
    highp float var_8f3a5;
    if (var_5a6e4)
    {
        var_8f3a5 = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_8f3a5 = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_03f07 = var_9a0a9;
    highp float var_9bce6 = TileLightIntensity.x * TileLightIntensity.x;
    highp vec4 var_f1a0e = SkyAmbientLightColorIntensity;
    highp float var_51d39 = TileLightIntensity.y * TileLightIntensity.y;
    highp vec3 var_b7f78 = (((((var_05a8d * (1.0 - var_dbfa1.x)) * max(((clamp(vec3(var_9bce6 + (var_03f07.x * var_03f07.w), (var_9bce6 * ((((var_9bce6 * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_03f07.y * var_03f07.w), (var_9bce6 * (((var_9bce6 * var_9bce6) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_03f07.z * var_03f07.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_8f3a5) + ((SkyAmbientLightColorIntensity.xyz * mix((var_51d39 * var_51d39) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_f1a0e.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_711ed) + var_1a92a) + (((mix(var_05a8d, vec3(dot(var_05a8d, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_dbfa1.y)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x);
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_b7f78, var_9d9e1, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_b7f78;
    ...
    {
        var_7e3dc = mix(var_b7f78, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp float var_31f67 = 1.0 - var_dbfa1.z;
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_59d20(var_dbfa1, var_84ff0, var_617d6);
        ...
        highp vec2 var_745fd = vec2(clamp(dot(var_0c980, -(var_5ae75 / vec3(var_7e163))), 0.0, 1.0), var_dbfa1.z);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_fa624(var_dbfa1, var_6eb02);
            highp vec2 var_6d176 = vec2(clamp(dot(var_0c980, -(var_5ae75 / vec3(var_7e163))), 0.0, 1.0), var_dbfa1.z);
