...
void main() {
    ...
    func_66b9c(var_38d97, var_f5c7b);
    ...
    if (PreExposureEnabled.x > 0.0)
    {
        var_0ff92 = var_4c605 * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_0ff92 = var_4c605;
