...
void main() {
...
#endif
    var_f5c7b.w = 1.0;
    highp vec4 var_b580a = var_f5c7b;
    if (var_b580a.w < 0.5)
    {
        discard;
    }
    highp vec3 var_da02a;
    func_66b9c(var_da02a, var_f5c7b);
    ...
    if (PreExposureEnabled.x > 0.0)
    {
        var_bbce3 = var_b1929 * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_bbce3 = var_b1929;
