...
void func_c89f6(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_69e1b, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_470f5, inout highp vec2 arg_c288e, inout highp vec3 arg_81f79, inout highp vec3 arg_78faf) {
...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_c89f6(var_c65bf, var_9aeed, var_1eba0, var_ea310, var_313fd, var_163cf, var_c6b5c, var_17a13, var_7e075);
        ...
        func_3fa9c(var_da382, var_d1b0b, var_e1a8f, var_ef9ba, var_36252, var_6cfc2, var_729bd, var_c2f06, var_1eba0, var_17a13, var_7e075, var_ea310, var_313fd);
