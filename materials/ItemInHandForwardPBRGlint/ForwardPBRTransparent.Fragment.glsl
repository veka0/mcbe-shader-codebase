...
void func_011b2(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_69e1b, inout highp vec3 arg_58517, inout highp vec3 arg_abe00, inout highp vec2 arg_c288e, inout highp vec3 arg_a3604, inout highp vec3 arg_78faf) {
...
void main() {
...
#endif
    var_2d773.w = 1.0;
    highp vec3 var_eab6e = pow(max(var_2d773.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_011b2(var_211cd, var_c7b8f, var_26b5f, var_f49d3, var_a7d68, var_b7ced, var_e0782, var_eab6e);
        highp vec3 var_8bbda = var_81d72;
        highp vec4 var_9536d;
        highp vec3 var_62261;
        highp vec3 var_7aa4c;
        bool var_c0cc5;
        func_5ab89(var_25152, var_f4e52, var_c0cc5, var_7aa4c, var_62261, var_9536d, var_8bbda, var_bed13, var_81d72, var_26b5f, var_e0782, var_eab6e, var_f49d3, var_4d6b6);
        var_bf751 = var_211cd + (var_7aa4c * (1.0 - var_f3062));
        var_92af6 = var_c7b8f + (var_62261 * (1.0 - var_5d160));
        var_9a0a9 = var_9536d;
        var_5a6e4 = var_c0cc5;
    }
    else
