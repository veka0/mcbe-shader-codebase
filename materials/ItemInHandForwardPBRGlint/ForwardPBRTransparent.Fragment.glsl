...
layout(binding = 4, std430) buffer s_Lights { Light Lights[]; } var_44b22;
...
void func_9cbf2(inout int arg_47a77, inout highp float arg_9eee0, inout highp vec3 arg_0623c, inout highp vec3 arg_147a6) {
    if (var_44b22.Lights[arg_47a77].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        return;
    }
    highp vec3 loc_8d02b = arg_0623c - var_44b22.Lights[arg_47a77].position.xyz;
    ...
    if (((textureLod(s_PointLightShadowTextureArray, vec4(loc_ad23e, float(var_44b22.Lights[arg_47a77].shadowProbeIndex)), 0.0).x * 2.0) - 1.0) >= loc_61d0d.z)
    {
        loc_591c8 = 1.0;
    }
    else
...
void func_deced(inout highp vec4 arg_83841, inout int arg_50e58, inout highp vec3 arg_62394, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_569de = var_44b22.Lights[arg_50e58].position.xyz - v_worldPos;
    ...
    if (loc_95cea >= (var_44b22.Lights[arg_50e58].position.w * var_44b22.Lights[arg_50e58].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_fd676 = loc_95cea / ((var_44b22.Lights[arg_50e58].position.w * var_44b22.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    highp vec3 loc_13960 = var_44b22.Lights[arg_50e58].color.xyz * loc_3d192;
    arg_83841 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_83841.w);
    arg_83841.w = 1.0 - (loc_95cea / ((var_44b22.Lights[arg_50e58].position.w * var_44b22.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05));
    arg_62394 = (((var_44b22.Lights[arg_50e58].color.xyz * var_44b22.Lights[arg_50e58].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_a2947(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_01a6b, inout highp vec3 arg_061f9, inout highp vec3 arg_c8c10, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_c98e5 = normalize((u_view * vec4(var_44b22.Lights[loc_2cc07].position.xyz, 1.0)).xyz - arg_89c41);
...
void main() {
...
#endif
    var_2d773.w = 1.0;
    highp vec3 var_1465f = pow(max(var_2d773.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    ...
    highp vec3 var_335f9;
    highp vec3 var_8c9cf;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_c6b5c = vec2(var_49182, var_280ef);
        highp vec3 var_9aeed;
        highp vec3 var_c65bf;
        func_bfd3e(var_c65bf, var_9aeed, var_84209, var_cab08, var_6ec0d, var_d49b9, var_c6b5c, var_fc705, var_1465f);
        highp vec3 var_8bbda = var_f8775;
        highp vec4 var_9536d;
        highp vec3 var_62261;
        highp vec3 var_7aa4c;
        bool var_c0cc5;
        func_a2947(var_25152, var_f4e52, var_c0cc5, var_7aa4c, var_62261, var_9536d, var_8bbda, var_bed13, var_f8775, var_84209, var_fc705, var_1465f, var_cab08, var_6ec0d);
        var_8c9cf = var_c65bf + (var_7aa4c * (1.0 - var_f3062));
        var_335f9 = var_9aeed + (var_62261 * (1.0 - var_5d160));
        var_9a0a9 = var_9536d;
        var_5a6e4 = var_c0cc5;
    }
    else
    ...
    highp float var_aee17;
    if (var_5a6e4)
    {
        var_aee17 = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_aee17 = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_612b2 = var_9a0a9;
    highp float var_f0025 = TileLightIntensity.x * TileLightIntensity.x;
    highp vec4 var_33b29 = SkyAmbientLightColorIntensity;
    highp float var_e9950 = TileLightIntensity.y * TileLightIntensity.y;
    highp vec3 var_dcb98 = ((((var_1465f * 1.0) * max(((clamp(vec3(var_f0025 + (var_612b2.x * var_612b2.w), (var_f0025 * ((((var_f0025 * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_612b2.y * var_612b2.w), (var_f0025 * (((var_f0025 * var_f0025) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_612b2.z * var_612b2.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_aee17) + ((SkyAmbientLightColorIntensity.xyz * mix((var_e9950 * var_e9950) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_33b29.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_8c9cf) + var_335f9;
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_dcb98, var_9d9e1, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_dcb98;
    ...
    {
        var_7e3dc = mix(var_dcb98, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
