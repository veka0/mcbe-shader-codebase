...
void main() {
...
#endif
    var_2d773.w = 1.0;
    highp vec3 var_9e2c4 = pow(max(var_2d773.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_011b2(var_211cd, var_c7b8f, var_4a39c, var_f49d3, var_a7d68, var_b7ced, var_e0782, var_9e2c4);
        highp vec3 var_8bbda = var_68c1c;
        highp vec4 var_9536d;
        highp vec3 var_62261;
        highp vec3 var_7aa4c;
        bool var_c0cc5;
        func_5ab89(var_25152, var_f4e52, var_c0cc5, var_7aa4c, var_62261, var_9536d, var_8bbda, var_bed13, var_68c1c, var_4a39c, var_e0782, var_9e2c4, var_f49d3, var_4d6b6);
        var_fc9c0 = var_211cd + (var_7aa4c * (1.0 - var_f3062));
        var_99d4d = var_c7b8f + (var_62261 * (1.0 - var_5d160));
        var_9a0a9 = var_9536d;
        var_5a6e4 = var_c0cc5;
    }
    else
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_b1d21, var_08c70, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_b1d21;
