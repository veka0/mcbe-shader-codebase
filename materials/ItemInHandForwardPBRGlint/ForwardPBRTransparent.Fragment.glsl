...
layout(binding = 4, std430) buffer s_Lights { Light Lights[]; } var_7fa9f;
...
void func_97548(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_69e1b, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_470f5, inout highp vec2 arg_c288e, inout highp vec3 arg_a3604, inout highp vec3 arg_78faf) {
...
void func_1799c(inout int arg_47a77, inout highp float arg_9eee0, inout highp vec3 arg_0623c, inout highp vec3 arg_1bb2e) {
    if (var_7fa9f.Lights[arg_47a77].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        return;
    }
    highp vec3 loc_2b15e = arg_0623c - var_7fa9f.Lights[arg_47a77].position.xyz;
    ...
    if (((textureLod(s_PointLightShadowTextureArray, vec4(loc_ad23e, float(var_7fa9f.Lights[arg_47a77].shadowProbeIndex)), 0.0).x * 2.0) - 1.0) >= loc_f7c8d.z)
    {
        loc_591c8 = 1.0;
    }
    else
...
void func_deced(inout highp vec4 arg_83841, inout int arg_50e58, inout highp vec3 arg_62394, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_569de = var_7fa9f.Lights[arg_50e58].position.xyz - v_worldPos;
    ...
    if (loc_95cea >= (var_7fa9f.Lights[arg_50e58].position.w * var_7fa9f.Lights[arg_50e58].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_fd676 = loc_95cea / ((var_7fa9f.Lights[arg_50e58].position.w * var_7fa9f.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    highp vec3 loc_13960 = var_7fa9f.Lights[arg_50e58].color.xyz * loc_3d192;
    arg_83841 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_83841.w);
    arg_83841.w = 1.0 - (loc_95cea / ((var_7fa9f.Lights[arg_50e58].position.w * var_7fa9f.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05));
    arg_62394 = (((var_7fa9f.Lights[arg_50e58].color.xyz * var_7fa9f.Lights[arg_50e58].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_5ab89(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_01a6b, inout highp vec3 arg_21ff0, inout highp vec3 arg_c8c10, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_c98e5 = normalize((u_view * vec4(var_7fa9f.Lights[loc_2cc07].position.xyz, 1.0)).xyz - arg_89c41);
...
void main() {
...
#endif
    var_2d773.w = 1.0;
    highp vec3 var_b1ac3 = pow(max(var_2d773.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    ...
    highp vec3 var_92af6;
    highp vec3 var_bf751;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_c6b5c = vec2(var_49182, var_280ef);
        highp vec3 var_9aeed;
        highp vec3 var_c65bf;
        func_97548(var_c65bf, var_9aeed, var_84209, var_cab08, var_6ec0d, var_d49b9, var_c6b5c, var_fc705, var_b1ac3);
        highp vec3 var_8bbda = var_f8775;
        highp vec4 var_9536d;
        highp vec3 var_62261;
        highp vec3 var_7aa4c;
        bool var_c0cc5;
        func_5ab89(var_25152, var_f4e52, var_c0cc5, var_7aa4c, var_62261, var_9536d, var_8bbda, var_bed13, var_f8775, var_84209, var_fc705, var_b1ac3, var_cab08, var_6ec0d);
        var_bf751 = var_c65bf + (var_7aa4c * (1.0 - var_f3062));
        var_92af6 = var_9aeed + (var_62261 * (1.0 - var_5d160));
        var_9a0a9 = var_9536d;
        var_5a6e4 = var_c0cc5;
    }
    else
    ...
    highp float var_a8c4f;
    if (var_5a6e4)
    {
        var_a8c4f = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_a8c4f = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_9e56b = var_9a0a9;
    highp float var_cf36b = TileLightIntensity.x * TileLightIntensity.x;
    highp vec4 var_88551 = SkyAmbientLightColorIntensity;
    highp vec3 var_52fa1 = ((((var_b1ac3 * 1.0) * max(((clamp(vec3(var_cf36b + (var_9e56b.x * var_9e56b.w), (var_cf36b * ((((var_cf36b * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_9e56b.y * var_9e56b.w), (var_cf36b * (((var_cf36b * var_cf36b) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_9e56b.z * var_9e56b.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_a8c4f) + ((SkyAmbientLightColorIntensity.xyz * pow(TileLightIntensity.y, mix(5.0, 3.0, CameraLightIntensity.y))) * var_88551.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_bf751) + var_92af6;
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_52fa1, var_08c70, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_52fa1;
    ...
    {
        var_7e3dc = mix(var_52fa1, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
