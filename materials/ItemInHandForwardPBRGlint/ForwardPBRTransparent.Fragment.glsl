...
#ifdef POINT_LIGHT_SHADING__ON
layout(binding = 11, std430) buffer s_zLights { Light zLights[]; } var_465eb;
layout(binding = 10, std430) buffer s_zLightLookupArray { LightData zLightLookupArray[]; } var_efbe5;
#endif
...
void func_4e8d4(inout int arg_7070b, inout highp float arg_9499a, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c) {
    ...
    highp vec3 loc_8868e = arg_aee55 - var_465eb.zLights[arg_7070b].position.xyz;
    ...
    highp vec4 loc_332aa = var_465eb.zLights[arg_7070b].shadowFaceUV0;
    highp vec3 loc_a2a55;
    if (loc_f3fad == 1)
    {
        loc_332aa = var_465eb.zLights[arg_7070b].shadowFaceUV1;
    ...
    else
    {
        ...
        if (loc_f3fad == 2)
        {
            loc_332aa = var_465eb.zLights[arg_7070b].shadowFaceUV2;
        ...
        else
        {
            ...
            if (loc_f3fad == 3)
            {
                loc_332aa = var_465eb.zLights[arg_7070b].shadowFaceUV3;
            ...
            else
            {
                ...
                if (loc_f3fad == 4)
                {
                    loc_332aa = var_465eb.zLights[arg_7070b].shadowFaceUV4;
                ...
                else
                {
                    ...
                    if (loc_f3fad == 5)
                    {
                        loc_332aa = var_465eb.zLights[arg_7070b].shadowFaceUV5;
...
void func_e0216(inout int arg_d97ba, inout highp float arg_43b7a, inout highp vec3 arg_0a2b9, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_a4b3e = var_465eb.zLights[arg_d97ba].position.xyz - v_worldPos;
    ...
    if (loc_16a27 >= (var_465eb.zLights[arg_d97ba].position.w * var_465eb.zLights[arg_d97ba].position.w))
    {
        arg_43b7a = 1.0;
        arg_0a2b9 = vec3(0.0);
        return;
    ...
    highp float loc_4c5a5 = loc_16a27 / ((var_465eb.zLights[arg_d97ba].position.w * var_465eb.zLights[arg_d97ba].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    arg_43b7a = loc_a011d;
    arg_0a2b9 = (var_465eb.zLights[arg_d97ba].color.xyz * var_465eb.zLights[arg_d97ba].color.w) * loc_ae18a;
}
void func_2f1a5(inout highp vec3 arg_33c3b, inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_c2c08, inout highp vec3 arg_81f79, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7, inout highp vec3 arg_78faf) {
    ...
    {
        int loc_a6f2a = int(var_efbe5.zLightLookupArray[loc_6165e].lookup);
        if (loc_a6f2a < 0)
        {
            break;
        }
        highp vec3 loc_82c7f = normalize((u_view * vec4(var_465eb.zLights[loc_a6f2a].position.xyz, 1.0)).xyz - arg_33c3b);
...
void main() {
    ...
    func_66b9c(var_a942f, var_f5c7b);
    ...
    if (PreExposureEnabled.x > 0.0)
    {
        var_ff289 = var_79073 * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_ff289 = var_79073;
