...
int var_e7b23;
float var_5e514;
layout(binding = 9, std430) buffer s_zLights { Light zLights[]; } var_1c49d;
layout(binding = 8, std430) buffer s_zLightLookupArray { LightData zLightLookupArray[]; } var_17768;
...
void func_47b35(inout highp vec3 arg_2ea20, inout highp vec3 arg_1bae0, inout highp vec3 arg_488fe, inout highp vec3 arg_adf73, inout highp vec3 arg_c100b, inout highp vec3 arg_ae81a, inout highp float arg_485b3, inout highp vec3 arg_c7286, inout highp vec3 arg_f6312) {
...
void func_5b6a6(inout int arg_826b5, inout highp float arg_9eee0, inout highp float arg_6b488, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c) {
    if (var_1c49d.zLights[arg_826b5].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        arg_6b488 = 1.0;
        return;
    }
    highp vec3 loc_44ea9 = arg_aee55 - var_1c49d.zLights[arg_826b5].position.xyz;
    ...
    highp float loc_e670f = (textureLod(s_PointLightShadowTextureArray, vec4(loc_f715f, float(var_1c49d.zLights[arg_826b5].shadowProbeIndex)), 0.0).x * 2.0) - 1.0;
...
void func_06ed4(inout highp vec4 arg_e84ec, inout int arg_fb63f, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_0a2b9, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    highp vec3 loc_a4b3e = var_1c49d.zLights[arg_fb63f].position.xyz - v_worldPos;
    ...
    if (loc_3a449 >= (var_1c49d.zLights[arg_fb63f].position.w * var_1c49d.zLights[arg_fb63f].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_0a2b9 = vec3(0.0);
    ...
    highp float loc_4c5a5 = loc_3a449 / ((var_1c49d.zLights[arg_fb63f].position.w * var_1c49d.zLights[arg_fb63f].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_1c49d.zLights[arg_fb63f].color.xyz * loc_219c5;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_3a449 / ((var_1c49d.zLights[arg_fb63f].position.w * var_1c49d.zLights[arg_fb63f].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_a011d;
    arg_7f337 = loc_cddfe;
    arg_0a2b9 = (var_1c49d.zLights[arg_fb63f].color.xyz * var_1c49d.zLights[arg_fb63f].color.w) * loc_219c5;
}
void func_c25da(inout bool arg_9a2b4, inout bool arg_b6724, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_33e52, inout highp vec3 arg_33c3b, inout highp vec3 arg_01a6b, inout highp vec3 arg_061f9, inout highp vec3 arg_c8c10, inout highp vec3 arg_8f7d6, inout highp vec3 arg_115ae) {
    ...
    {
        int loc_959ae = int(var_17768.zLightLookupArray[loc_86630].lookup);
        if (loc_959ae < 0)
        {
            break;
        }
        highp vec3 loc_dfb9f = normalize((u_view * vec4(var_1c49d.zLights[loc_959ae].position.xyz, 1.0)).xyz - arg_33c3b);
...
void func_ff80f(inout highp vec3 arg_4f139, inout highp vec3 arg_d5e4d, inout highp vec3 arg_5b214, inout highp vec3 arg_2f16d, inout highp vec4 arg_d4ca2, inout highp vec3 arg_4570a, inout highp vec3 arg_b40e7, inout highp vec3 arg_a9ada, inout highp vec3 arg_cd082, inout highp vec3 arg_a0fcd, inout highp vec3 arg_02667) {
    ...
    highp vec3 loc_88b27 = arg_4570a;
    ...
    if (!loc_49ba4)
    {
        loc_2b389 = loc_464cb && (loc_3707d < PointLightSpecularFadeOutParameters.y);
    }
    else
    {
        loc_2b389 = loc_49ba4;
    ...
    if (!loc_70859)
    {
        loc_a196a = loc_686c7 && (loc_3707d < PointLightDiffuseFadeOutParameters.y);
    }
    else
    {
        loc_a196a = loc_70859;
    ...
    highp vec4 loc_5ae6c;
    highp vec3 loc_53bc5;
    highp vec3 loc_f3788;
    func_c25da(loc_2b389, loc_a196a, loc_f3788, loc_53bc5, loc_5ae6c, arg_4570a, arg_a9ada, arg_cd082, arg_a0fcd, loc_b6871, arg_02667);
    arg_4f139 = arg_d5e4d + (loc_f3788 * (1.0 - loc_deef1));
    arg_5b214 = arg_2f16d + (loc_53bc5 * (1.0 - loc_f4966));
    arg_d4ca2 = loc_5ae6c;
}
...
void main() {
...
#endif
    var_2d773.w = 1.0;
    highp vec3 var_cec0f = pow(max(var_2d773.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    ...
    highp vec3 var_71959 = var_9f386.xyz;
    highp vec3 var_239fe = v_worldPos - WorldOrigin.xyz;
    highp vec3 var_eebcb = dFdx(var_71959);
    highp vec3 var_211c8 = dFdy(var_71959);
    ...
    highp vec3 var_9f71d = (var_239fe - (var_7d782 - (var_5acf5 * dot(var_7d782, var_5acf5)))) + WorldOrigin.xyz;
    highp vec3 var_0d2dd = var_e72e2.xyz;
    highp vec3 var_a43ed = (u_view * var_e72e2).xyz;
    ...
    if (var_94c07)
    {
        var_0d88f = pow((texture(s_CausticsTexture, vec3((v_worldPos - WorldOrigin.xyz).xz * CausticsParameters.y, CausticsTextureParameters.y)).x * 2.0) * clamp(var_c40e7.y, 0.0, 1.0), CausticsParameters.z) * (CausticsParameters.z + 1.0);
    }
    else
    {
        var_0d88f = 1.0;
    ...
    highp float var_106e2 = length(var_71959);
    highp vec3 var_5bd0a = var_12830;
    highp vec4 var_9a0a9;
    highp vec3 var_be249;
    highp vec3 var_c7a61;
    if (var_5bd0a.z != 1.0)
    {
        highp vec3 var_242e3 = -(var_71959 / vec3(length(var_71959) + 9.9999997473787516355514526367188e-05));
        highp vec3 var_163cf = var_71959;
        ...
        func_47b35(var_42385, var_4b21a, var_a43ed, var_0ae9b, var_0d2dd, var_163cf, var_0d88f, var_242e3, var_cec0f);
        highp vec4 var_b0736;
        highp vec3 var_0702c;
        highp vec3 var_965c6;
        func_ff80f(var_965c6, var_42385, var_0702c, var_4b21a, var_b0736, var_71959, var_9f71d, var_a43ed, var_242e3, var_cec0f, var_0d2dd);
        var_c7a61 = var_965c6;
        var_be249 = var_0702c;
        var_9a0a9 = var_b0736;
    }
    ...
    highp vec4 var_f3576 = var_9a0a9;
    highp float var_a705e = TileLightIntensity.x * TileLightIntensity.x;
    highp vec4 var_83dc3 = SkyAmbientLightColorIntensity;
    highp float var_b065b = TileLightIntensity.y * TileLightIntensity.y;
    ...
    {
        highp float var_79b3e = clamp((((length(var_71959) / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) * FogAndDistanceControl.y, 0.0, 1.0);
    ...
    highp vec4 var_ed97a = vec4(var_1bb57, var_bdb1d);
    highp vec4 var_1dac1 = var_ed97a;
    ...
    highp vec4 var_53b38 = var_89da1;
    highp vec3 var_1845d = mix(((((var_cec0f * 1.0) * max((clamp(vec3(var_a705e + (var_f3576.x * var_f3576.w), (var_a705e * ((((var_a705e * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_f3576.y * var_f3576.w), (var_a705e * (((var_a705e * var_a705e) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_f3576.z * var_f3576.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_b065b * var_b065b) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_83dc3.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_c7a61) + var_be249, var_ed97a.xyz, vec3(var_1dac1.w)) * var_53b38.w;
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        {
            var_2216c = (u_view * vec4(var_9f71d, 1.0)).xyz;
            var_a8715 = var_9f71d;
        }
        else
        {
        ...
        highp vec3 var_a56d9 = reflect(normalize(var_a8715 - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_0d2dd);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            if (QuantizationParameters.w > 0.0)
            {
                var_26c5c = (u_view * vec4(var_9f71d, 1.0)).xyz;
            }
            else
            {
                var_26c5c = var_71959;
    ...
    highp vec3 var_4c605 = vec4(var_89da1.xyz + var_1845d, 1.0).xyz + var_69409;
