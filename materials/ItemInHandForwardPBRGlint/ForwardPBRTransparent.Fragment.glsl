...
layout(binding = 6, std430) buffer s_Lights { Light Lights[]; } var_333ff;
layout(binding = 5, std430) buffer s_LightLookupArray { LightData LightLookupArray[]; } var_de800;
...
void func_217ce(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_69e1b, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_a9fca, inout highp vec2 arg_f36e7, inout highp vec3 arg_81f79, inout highp vec3 arg_78faf) {
    ...
    for (int loc_2ed25 = 0; loc_2ed25 < loc_a58f1; loc_81561 = loc_4f500, loc_9ff3b = loc_2b3c7, loc_2ed25++)
    {
        highp float loc_4847c;
        if (int(DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.x) == 1)
        {
            ...
            loc_4847c = mix(loc_70c88, 1.0, smoothstep(max(0.0, ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.y - 8.0), ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.y, -arg_a9fca.z));
        }
        else
        {
            loc_4847c = 1.0;
        ...
        highp vec3 loc_85782 = ((DirectionalLightSourceDiffuseColorAndIlluminance[loc_2ed25].xyz * loc_fe4ce.w) * arg_f36e7[loc_2ed25]) * DirectionalLightToggleAndCountAndMaxDistanceAndMaxCascadesPerLight.x;
...
void func_e61a4(inout int arg_60bb3, inout highp float arg_9eee0, inout highp float arg_6b488, inout highp vec3 arg_0623c, inout highp vec3 arg_147a6) {
    if (var_333ff.Lights[arg_60bb3].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        arg_6b488 = 1.0;
        return;
    }
    highp vec3 loc_8d02b = arg_0623c - var_333ff.Lights[arg_60bb3].position.xyz;
    ...
    highp float loc_4c50b = (textureLod(s_PointLightShadowTextureArray, vec4(loc_778fd, float(var_333ff.Lights[arg_60bb3].shadowProbeIndex)), 0.0).x * 2.0) - 1.0;
...
void func_8a542(inout highp vec4 arg_86e96, inout int arg_027e7, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_24936, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    highp vec3 loc_569de = var_333ff.Lights[arg_027e7].position.xyz - v_worldPos;
    ...
    if (loc_4343f >= (var_333ff.Lights[arg_027e7].position.w * var_333ff.Lights[arg_027e7].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_24936 = vec3(0.0);
    ...
    highp float loc_fd676 = loc_4343f / ((var_333ff.Lights[arg_027e7].position.w * var_333ff.Lights[arg_027e7].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_e1408 = var_333ff.Lights[arg_027e7].color.xyz * loc_a0a0b;
        arg_86e96 = vec4(loc_e1408.x, loc_e1408.y, loc_e1408.z, arg_86e96.w);
        arg_86e96.w = 1.0 - (loc_4343f / ((var_333ff.Lights[arg_027e7].position.w * var_333ff.Lights[arg_027e7].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_a011d;
    arg_7f337 = loc_cddfe;
    arg_24936 = ((var_333ff.Lights[arg_027e7].color.xyz * var_333ff.Lights[arg_027e7].color.w) * loc_a0a0b) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_3fa9c(inout bool arg_9a2b4, inout bool arg_b6724, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_33e52, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_01a6b, inout highp vec3 arg_061f9, inout highp vec3 arg_c8c10, inout highp vec3 arg_8f7d6, inout highp vec3 arg_115ae) {
    ...
    {
        int loc_17fca = int(var_de800.LightLookupArray[loc_0ad25].lookup);
        if (loc_17fca < 0)
        {
            break;
        }
        highp vec3 loc_c98e5 = normalize((u_view * vec4(var_333ff.Lights[loc_17fca].position.xyz, 1.0)).xyz - arg_89c41);
...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_217ce(var_c65bf, var_9aeed, var_f993c, var_0ae9b, var_f9f35, var_163cf, var_c6b5c, var_17a13, var_7e075);
        ...
        func_3fa9c(var_da382, var_d1b0b, var_e1a8f, var_ef9ba, var_36252, var_6cfc2, var_729bd, var_e7e52, var_f993c, var_17a13, var_7e075, var_fe3d5, var_f9f35);
