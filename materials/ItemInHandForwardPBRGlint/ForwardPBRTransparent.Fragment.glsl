...
layout(binding = 4, std430) buffer s_Lights { Light Lights[]; } var_5529c;
...
void func_73db9(inout int arg_aec91, inout highp float arg_28e67, inout highp vec3 arg_0623c, inout highp vec3 arg_214f6) {
    if (var_5529c.Lights[arg_aec91].shadowProbeIndex < 0)
    {
        arg_28e67 = 1.0;
        return;
    }
    highp vec3 loc_7f355 = arg_0623c - var_5529c.Lights[arg_aec91].position.xyz;
    ...
    for (int loc_1139b = 0; loc_1139b < 4; loc_b74da = loc_ab1a2, loc_1139b++)
    {
        ...
        for (int loc_79fcd = 0; loc_79fcd < 4; loc_ab1a2 = loc_ad4ff, loc_79fcd++)
        {
            ...
            loc_3d9e2.z = float(var_5529c.Lights[arg_aec91].shadowProbeIndex * 6) + loc_3d9e2.z;
...
void func_deced(inout highp vec4 arg_83841, inout int arg_50e58, inout highp vec3 arg_62394, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_569de = var_5529c.Lights[arg_50e58].position.xyz - v_worldPos;
    ...
    if (loc_95cea >= (var_5529c.Lights[arg_50e58].position.w * var_5529c.Lights[arg_50e58].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_fd676 = loc_95cea / ((var_5529c.Lights[arg_50e58].position.w * var_5529c.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    highp vec3 loc_13960 = var_5529c.Lights[arg_50e58].color.xyz * loc_3d192;
    arg_83841 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_83841.w);
    arg_83841.w = 1.0 - (loc_95cea / ((var_5529c.Lights[arg_50e58].position.w * var_5529c.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05));
    arg_62394 = (((var_5529c.Lights[arg_50e58].color.xyz * var_5529c.Lights[arg_50e58].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_5ab89(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_01a6b, inout highp vec3 arg_21ff0, inout highp vec3 arg_c8c10, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_c98e5 = normalize((u_view * vec4(var_5529c.Lights[loc_2cc07].position.xyz, 1.0)).xyz - arg_89c41);
