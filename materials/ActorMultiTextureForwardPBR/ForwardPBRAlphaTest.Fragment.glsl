...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_e3c4e(var_c282b, var_de9aa, var_f1c2e, var_edfc0, var_c8039, var_f1053, var_7bfeb);
        highp vec3 var_92517 = var_b4fbd;
        highp vec4 var_3d9d9;
        highp vec3 var_b3e4d;
        highp vec3 var_ef9ba;
        bool var_64e2a;
        func_b7bbd(var_bbdbf, var_b65dc, var_64e2a, var_ef9ba, var_b3e4d, var_3d9d9, var_92517, var_1f150, var_b4fbd, var_f1c2e, var_f1053, var_7bfeb, var_e1b04);
