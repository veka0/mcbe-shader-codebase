...
void main() {
    ...
    if (var_e8ba3)
    {
        ...
        highp mat4 var_5ac81 = u_invProj;
        highp mat4 var_e16a5 = u_invProj;
        highp mat4 var_ac48b = u_invProj;
        highp mat4 var_56cae = u_invProj;
        highp mat4 var_6e1d6 = u_invProj;
        ...
        highp vec4 var_e0c52 = vec4(var_0bf64 * var_5ac81[0].x, var_a9f3a * var_e16a5[1].y, var_3792e * var_ac48b[3].z, (var_8e4d8 * var_56cae[2].w) + (var_54205 * var_6e1d6[3].w));
        var_1a05a = var_e0c52;
        ...
        highp mat4 var_31aac = u_invProj;
        highp mat4 var_e14ff = u_invProj;
        highp mat4 var_dd940 = u_invProj;
        highp mat4 var_b5561 = u_invProj;
        highp mat4 var_89f23 = u_invProj;
        ...
        highp vec4 var_ad683 = vec4(var_f4f38 * var_31aac[0].x, var_61554 * var_e14ff[1].y, var_e057a * var_dd940[3].z, (var_99cf2 * var_b5561[2].w) + (var_daf72 * var_89f23[3].w));
        var_8e332 = var_ad683;
        ...
        highp mat4 var_6e551 = u_invProj;
        highp mat4 var_f74ce = u_invProj;
        highp mat4 var_423f7 = u_invProj;
        highp mat4 var_13175 = u_invProj;
        highp mat4 var_60fa5 = u_invProj;
        ...
        highp vec4 var_27587 = vec4(var_55870 * var_6e551[0].x, var_a94cd * var_f74ce[1].y, var_37c9c * var_423f7[3].z, (var_30eeb * var_13175[2].w) + (var_acdec * var_60fa5[3].w));
        var_45215 = var_27587;
        ...
        highp mat4 var_41e53 = u_invProj;
        highp mat4 var_209d1 = u_invProj;
        highp mat4 var_187e6 = u_invProj;
        highp mat4 var_2f7fd = u_invProj;
        highp mat4 var_b0dea = u_invProj;
        ...
        highp vec4 var_0bbb1 = vec4(var_3c555 * var_41e53[0].x, var_b1506 * var_209d1[1].y, var_0b766 * var_187e6[3].z, (var_05900 * var_2f7fd[2].w) + (var_836c8 * var_b0dea[3].w));
        var_e2763 = var_0bbb1;
        ...
        highp mat4 var_ac190 = u_invProj;
        highp mat4 var_3b65d = u_invProj;
        highp mat4 var_3fd8a = u_invProj;
        highp mat4 var_6f492 = u_invProj;
        highp mat4 var_26362 = u_invProj;
        ...
        highp vec4 var_0e05f = vec4(var_bbb61 * var_ac190[0].x, var_28969 * var_3b65d[1].y, var_0fe2b * var_3fd8a[3].z, (var_89548 * var_6f492[2].w) + (var_8cb2a * var_26362[3].w));
        var_3c4e7 = var_0e05f;
        ...
        highp mat4 var_00d40 = u_invProj;
        highp mat4 var_8d4b6 = u_invProj;
        highp mat4 var_b24c4 = u_invProj;
        highp mat4 var_62e19 = u_invProj;
        highp mat4 var_c5895 = u_invProj;
        ...
        highp vec4 var_45a0d = vec4(var_86b09 * var_00d40[0].x, var_6a0c3 * var_8d4b6[1].y, var_55fa3 * var_b24c4[3].z, (var_bf2a0 * var_62e19[2].w) + (var_eeb2c * var_c5895[3].w));
        var_5c4d0 = var_45a0d;
        ...
        highp mat4 var_5ab01 = u_invProj;
        highp mat4 var_0c34e = u_invProj;
        highp mat4 var_7afca = u_invProj;
        highp mat4 var_c05d7 = u_invProj;
        highp mat4 var_46b8a = u_invProj;
        ...
        highp vec4 var_daad9 = vec4(var_4a61c * var_5ab01[0].x, var_3b426 * var_0c34e[1].y, var_32bef * var_7afca[3].z, (var_265b7 * var_c05d7[2].w) + (var_e5afb * var_46b8a[3].w));
        var_91df8 = var_daad9;
