...
void func_677d7(inout highp vec4 arg_6739f, inout highp vec3 arg_87514, inout highp vec3 arg_c03dc, inout highp vec3 arg_58fab, inout highp vec3 arg_adf73, inout highp vec3 arg_c100b, inout highp vec3 arg_09686, inout highp float arg_485b3, inout highp vec3 arg_c7286, inout highp vec3 arg_08b90, inout highp float arg_2d822, inout highp float arg_67b92) {
    ...
    if (int(DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.x) == 1)
    {
        ...
        highp vec4 loc_af92b = CascadesShadowProj[0] * vec4(loc_62fb4, 1.0);
        ...
        {
            loc_90fd1 = clamp(int(CascadesParameters[0].w + 0.5), 1, 9);
        }
        int loc_97b6a = loc_90fd1 / 2;
        highp vec2 loc_c3a0f = ((vec2(loc_af92b.x, loc_af92b.y) * 0.5) + vec2(0.5)) * CascadesParameters[0].x;
        highp float loc_43ca9 = (loc_af92b.z * 0.5) + 0.5;
        loc_c3a0f.y += (1.0 - CascadesParameters[0].x);
        ...
        for (int loc_94d00 = 0; loc_94d00 < loc_90fd1; loc_430f1 = loc_8d3ff, loc_df8d4 = loc_b9035, loc_94d00++)
        {
            loc_8d3ff = loc_430f1;
            loc_b9035 = loc_df8d4;
            highp float loc_f8168;
            highp float loc_e1a52;
            for (int loc_5db26 = 0; loc_5db26 < loc_90fd1; loc_8d3ff = loc_e1a52, loc_b9035 = loc_f8168, loc_5db26++)
            {
                highp vec2 loc_1944c = loc_c3a0f + ((vec2(float(loc_5db26 - loc_97b6a) + 0.5, float(loc_94d00 - loc_97b6a) + 0.5) * ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.x) * CascadesParameters[0].x);
        ...
        if (int(FirstPersonPlayerShadowsEnabledAndResolutionAndFilterWidthAndTextureDimensions.x) > 0)
        {
            ...
            func_59bf3(loc_62fb4, loc_d4110, loc_a39dc, loc_80bb3);
            loc_b9fae = loc_80bb3;
        }
        else
        {
        ...
        loc_fa38e = min(1.0, loc_df8d4 / float(loc_90fd1 * loc_90fd1));
        loc_def52 = mix(min(loc_430f1 / float(loc_90fd1 * loc_90fd1), min(loc_b9fae, loc_c352b)), 1.0, smoothstep(max(0.0, ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.y - 8.0), ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.y, -arg_09686.z));
    }
    else
    {
        loc_fa38e = 1.0;
...
void main() {
    highp vec2 var_05681 = (floor(v_texcoord0 * SceneResolutionAndRecipResolution.xy) + vec2(0.5)) * SceneResolutionAndRecipResolution.zw;
    highp vec4 var_42da2 = texture(s_Normal, var_05681);
    highp float var_4d00d = (texture(s_SceneDepth, var_05681).x * 2.0) - 1.0;
    highp vec4 var_df846 = vec4(v_projPosition.xy, var_4d00d, 1.0);
    ...
    var_df846 = var_20845;
    highp vec4 var_1c342 = vec4(v_projPosition.xy + vec2(SubPixelOffset.x, -SubPixelOffset.y), var_4d00d, 1.0);
    ...
    highp vec4 var_0ac6d = texture(s_ColorMetalnessSubsurface, var_05681);
    ...
    highp vec4 var_6afb1 = texture(s_EmissiveAmbientLinearRoughness, var_05681);
    ...
    func_677d7(var_6afb1, var_74ca9, var_58b41, var_7abf1, var_f7261, var_73c53, var_761c1, var_e67e6, var_1253e, var_34cb3, var_403ab, var_69455);
