...
void main() {
    ...
    float var_fbad7 = var_ee788.x;
    vec4 var_3fc81 = a_texcoord1;
    var_3fc81.w = var_fbad7;
    float var_e8871 = floor(var_fbad7 * 255.0);
    bool var_54fcf = (var_e8871 + 6.1999999161344021558761596679688e-05) < 2.0;
    bool var_9e4ce;
    if (!var_54fcf)
    {
        var_9e4ce = (var_e8871 + 6.1999999161344021558761596679688e-05) > 8.0;
    }
    else
    {
        var_9e4ce = var_54fcf;
