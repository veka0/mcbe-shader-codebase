...
void main() {
    ...
    if (var_e91d1 && (!((var_33ebe & 1u) != 0u)))
    {
        ...
        for (;;)
        {
            if (var_d6224 < 8)
            {
                uint var_a70f2 = uint(var_9dd30.GpuEntryBuffer[var_75570].hash) & 65535u;
                bool var_734de = var_a70f2 == var_c4ba2;
                bool var_e4213;
                if (var_734de)
                {
                    var_e4213 = var_9dd30.GpuEntryBuffer[var_75570].packed_xy == var_ab334;
                }
                else
                {
                    var_e4213 = var_734de;
                ...
                if (var_e4213)
                {
                    var_ec5a7 = var_9dd30.GpuEntryBuffer[var_75570].packed_zw == var_76717;
                }
                else
                {
                    var_ec5a7 = var_e4213;
                ...
                else
                {
                    ...
                    if (var_ec5a7)
                    {
                        var_5ebd4 = uint(var_9dd30.GpuEntryBuffer[var_75570].user_data);
                    }
                    else
                    {
                        var_5ebd4 = var_8e0b6;
