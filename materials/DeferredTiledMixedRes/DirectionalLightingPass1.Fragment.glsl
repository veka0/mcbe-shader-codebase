...
void func_39c0b(inout highp vec2 arg_1bbc3, inout highp vec3 arg_87514, inout highp vec3 arg_c03dc, inout highp vec3 arg_58fab, inout highp vec3 arg_adf73, inout highp vec3 arg_c100b, inout highp vec3 arg_c4970, inout highp float arg_fb1ed, inout highp vec3 arg_c7286, inout highp vec2 arg_3e2b4, inout highp vec3 arg_08b90, inout highp float arg_2d822, inout highp float arg_67b92) {
    ...
    if (int(DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.x) == 1)
    {
        ...
        highp vec4 loc_dd39f = CascadesShadowProj[1] * vec4(loc_d2c90, 1.0);
        highp vec4 loc_35f47 = loc_dd39f;
        ...
        {
            loc_beb12 = clamp(int(CascadesParameters[1].w + 0.5), 1, 9);
        }
        int loc_ca391 = loc_beb12 / 2;
        highp vec2 loc_ef57d = ((loc_dd39f.xy * 0.5) + vec2(0.5)) * CascadesParameters[1].x;
        highp float loc_43ca9 = (loc_35f47.z * 0.5) + 0.5;
        loc_ef57d.y += (1.0 - CascadesParameters[1].x);
        ...
        for (int loc_b8bbc = 0; loc_b8bbc < loc_beb12; loc_6fea6 = loc_8d3ff, loc_df8d4 = loc_b9035, loc_b8bbc++)
        {
            loc_8d3ff = loc_6fea6;
            loc_b9035 = loc_df8d4;
            highp float loc_f8168;
            highp float loc_e1a52;
            for (int loc_4bc47 = 0; loc_4bc47 < loc_beb12; loc_8d3ff = loc_e1a52, loc_b9035 = loc_f8168, loc_4bc47++)
            {
                highp vec2 loc_6205e = loc_ef57d + ((vec2(float(loc_4bc47 - loc_ca391) + 0.5, float(loc_b8bbc - loc_ca391) + 0.5) * ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.x) * CascadesParameters[1].x);
        ...
        if (int(FirstPersonPlayerShadowsEnabledAndResolutionAndFilterWidthAndTextureDimensions.x) > 0)
        {
            ...
            func_0b88d(loc_d2c90, loc_d0b1d, loc_a39dc, loc_80bb3);
            loc_c78ca = loc_80bb3;
        }
        else
        {
...
void main() {
    ...
    highp vec2 var_d38ae = vec2(float(var_6c332.w & 255u) * 0.0039215688593685626983642578125, float((var_6c332.w & 256u) != 0u));
    ...
    func_39c0b(var_d38ae, var_7ea81, var_5bb13, var_6fdd9, var_71888, var_8b177, var_e8ddd, var_b42d8, var_fca56, var_ca3b6, var_b99f0, var_a9088, var_243e1);
