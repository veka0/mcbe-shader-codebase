...
void main() {
    ...
    highp vec2 var_5737b = (((var_3972c * var_f7d5f) + (mod(var_3972c, vec2(2.0)) * max(var_f7d5f - vec2(1.0), vec2(0.0)))) + vec2(0.5)) * SceneResolutionAndRecipResolution.zw;
    highp vec2 var_1fa6b = var_5737b.xy;
    ...
    highp vec4 var_af032 = texture(s_Normal, var_5737b.xy);
    highp vec2 var_0d4a8 = var_5737b.xy;
    highp vec4 var_4435a = texture(s_SceneDepth, var_5737b.xy);
    ...
    if (var_94c07)
    {
        var_6deda = pow((texture(s_CausticsTexture, vec3((var_9b682 - WorldOrigin.xyz).xz * CausticsParameters.y, CausticsTextureParameters.y)).x * 2.0) * clamp(var_f0927.y, 0.0, 1.0), CausticsParameters.z) * (CausticsParameters.z + 1.0);
    }
    else
    {
        var_6deda = 1.0;
    ...
    if (var_a1241.z != 1.0)
    {
        ...
        highp vec3 var_fe63b;
        if (int(QuantizationParameters.y) > 0)
        {
            var_fe63b = (var_44540 + (var_53026 - (var_cceb0 * dot(var_53026, var_cceb0)))) + WorldOrigin.xyz;
        }
        else
        {
            var_fe63b = var_9b682;
        ...
        func_5eada(var_7ca3e, var_e520d, var_a53cf, var_b9e03, var_fe63b, var_f0927, var_92517, var_6deda, var_98c8c, var_d57ea, var_92928, var_9c3c2, var_121d0);
        var_9b8c2 = var_e520d;
        var_272ff = var_a53cf;
    }
    else
