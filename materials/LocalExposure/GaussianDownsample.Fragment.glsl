...
void main() {
    ...
    var_92006 = 0.0;
    var_1c31c = 0.0;
    highp float var_3444b;
    highp float var_75a6e;
    for (int var_4101a = var_ede4a; var_4101a <= var_f75fa; var_92006 = var_75a6e, var_1c31c = var_3444b, var_4101a++)
    {
        int var_129b1 = -var_f75fa;
        var_75a6e = var_92006;
        var_3444b = var_1c31c;
        highp float var_c22fb;
        highp float var_718be;
        for (int var_502e7 = var_129b1; var_502e7 <= var_f75fa; var_75a6e = var_718be, var_3444b = var_c22fb, var_502e7++)
        {
            highp vec2 var_734e7 = vec2(float(var_4101a), float(var_502e7)) * float(var_bf101);
            highp vec2 var_2c069 = var_734e7;
            highp float var_8d99c = exp((-((var_2c069.x * var_2c069.x) + (var_2c069.y * var_2c069.y))) / var_46797);
            var_c22fb = var_3444b + (var_8d99c * log2(dot(texture(s_SceneColor, v_texcoord0 + (var_734e7 * RecipSceneResolution.xy)).xyz, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))));
            var_718be = var_75a6e + var_8d99c;
        }
    }
