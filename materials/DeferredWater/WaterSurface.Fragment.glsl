...
int var_e7b23;
layout(binding = 15, std430) buffer s_zLights { Light zLights[]; } var_a8b33;
...
void func_996d6(inout highp float arg_4edfb, inout highp vec3 arg_b6d8c, inout highp vec3 arg_488fe, inout highp vec3 arg_adf73, inout highp vec3 arg_c100b, inout highp vec3 arg_ae81a, inout highp vec3 arg_c7286, inout highp vec2 arg_3e2b4) {
...
void func_6eb35(inout int arg_7070b, inout highp float arg_9499a, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c) {
    ...
    highp vec3 loc_8868e = arg_aee55 - var_a8b33.zLights[arg_7070b].position.xyz;
    ...
    highp vec4 loc_ad8ff = var_a8b33.zLights[arg_7070b].shadowFaceUV0;
    highp vec3 loc_a2a55;
    if (loc_f3fad == 1)
    {
        loc_ad8ff = var_a8b33.zLights[arg_7070b].shadowFaceUV1;
    ...
    else
    {
        ...
        if (loc_f3fad == 2)
        {
            loc_ad8ff = var_a8b33.zLights[arg_7070b].shadowFaceUV2;
        ...
        else
        {
            ...
            if (loc_f3fad == 3)
            {
                loc_ad8ff = var_a8b33.zLights[arg_7070b].shadowFaceUV3;
            ...
            else
            {
                ...
                if (loc_f3fad == 4)
                {
                    loc_ad8ff = var_a8b33.zLights[arg_7070b].shadowFaceUV4;
                ...
                else
                {
                    ...
                    if (loc_f3fad == 5)
                    {
                        loc_ad8ff = var_a8b33.zLights[arg_7070b].shadowFaceUV5;
...
void func_d321c(inout int arg_2f306, inout highp float arg_43b7a, inout highp vec3 arg_0a2b9, inout highp vec3 arg_29ac4, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_8dfd7 = var_a8b33.zLights[arg_2f306].position.xyz - arg_29ac4;
    ...
    if (loc_16a27 >= (var_a8b33.zLights[arg_2f306].position.w * var_a8b33.zLights[arg_2f306].position.w))
    {
        arg_43b7a = 1.0;
        arg_0a2b9 = vec3(0.0);
        return;
    ...
    if (DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.w != 0.0)
    {
        ...
        func_6eb35(arg_2f306, loc_1b78e, arg_ab1f6, arg_81f82);
        loc_a011d = loc_1b78e;
    }
    else
    {
    ...
    highp float loc_4c5a5 = loc_16a27 / ((var_a8b33.zLights[arg_2f306].position.w * var_a8b33.zLights[arg_2f306].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    arg_43b7a = loc_a011d;
    arg_0a2b9 = (var_a8b33.zLights[arg_2f306].color.xyz * var_a8b33.zLights[arg_2f306].color.w) * loc_ae18a;
}
void func_1cb59(inout highp vec3 arg_33c3b, inout highp vec3 arg_534d1, inout highp vec3 arg_c2c08, inout highp vec3 arg_81f79, inout highp vec2 arg_92c2f, inout highp vec3 arg_f6a53, inout highp vec3 arg_4f9dc, inout highp vec3 arg_8bccf) {
    ...
    for (int loc_97a60 = loc_79315; loc_97a60 < loc_822f5; loc_95dc0 = loc_e2a66, loc_97a60++)
    {
        ...
        highp vec3 loc_82c7f = normalize((u_view * vec4(var_a8b33.zLights[loc_f153e].position.xyz, 1.0)).xyz - arg_33c3b);
...
void main() {
    ...
    func_996d6(var_e4742, var_bdcf7, var_d9513, var_cfdac, var_0e7a8, var_cbd15, var_614bf, var_1fc8b);
#ifdef POINT_LIGHT_SHADING__ON
