...
void main() {
    ...
    int var_263e3 = int((var_4581e.z << uint(4)) | ((var_4581e.y & 240u) >> uint(4)));
    int var_95a4f = int(var_4581e.w);
    highp vec4 var_e5700 = Data_PS[var_263e3];
    highp vec4 var_1dc25 = Data_PS[var_263e3 + 1];
    highp vec4 var_f6261 = Data_PS[var_263e3];
    ...
    else
    {
        ...
        if (3.0 == float(var_95a4f))
        {
            ...
            if (var_30475)
            {
                var_a37ad.x = clamp(var_20069.x, var_49a69.x, var_49a69.x + var_49a69.z);
                var_a37ad.y = clamp(var_20069.y, var_49a69.y, var_49a69.y + var_49a69.w);
            }
            var_f6261 = texture(s_txBuffer, vec2(var_a37ad.x, 1.0 - var_a37ad.y));
            var_f6261.w = mix(1.0 - var_f6261.w, var_f6261.w, var_e5700.x);
            highp vec3 var_0beb9 = var_f6261.xyz;
            var_f6261.w = mix(((0.2125999927520751953125 * var_0beb9.x) + (0.715200006961822509765625 * var_0beb9.y)) + (0.072200000286102294921875 * var_0beb9.z), var_f6261.w, var_e5700.z);
        ...
        else
        {
            ...
            {
                highp vec4 var_3c0d8 = texture(s_txBuffer1, v_Additional.xy);
                highp vec3 var_662e7 = Data_PS[var_263e3].xyz;
                ...
                var_f6261 = Data_PS[var_263e3] * pow(abs(var_3c0d8.x), 1.4500000476837158203125 - var_8dbe5);
                var_b5f11 = 1.0;
            }
            else
            {
                ...
                {
                    highp vec4 var_360f9 = texture(s_txBuffer2, v_Additional.xy);
                    highp vec3 var_62605 = Data_PS[var_263e3].xyz;
                    ...
                    var_f6261 = Data_PS[var_263e3] * pow(abs(smoothstep((-0.501960813999176025390625) / var_20069.z, 0.501960813999176025390625 / var_20069.z, (var_360f9.x * 7.96875) - 3.984375)), 1.4500000476837158203125 - var_21124);
                    var_78c7e = 1.0;
                }
                else
                {
                    ...
                    {
                        highp vec4 var_c8a1b = texture(s_txBuffer2, v_Additional.xy);
                        highp vec3 var_58206 = Data_PS[var_263e3].xyz;
                        ...
                        var_f6261 = Data_PS[var_263e3] * pow(abs(smoothstep(0.5 - var_20069.z, 0.5 + var_20069.z, var_c8a1b.x)), 1.4500000476837158203125 - var_60cee);
                        var_aef2c = 1.0;
                    }
                    else
                    {
                        highp float var_7849b;
                        if (30.0 == float(var_95a4f))
                        {
                            var_7849b = texture(s_txBuffer, v_Additional.xy).x;
                        }
                        else
                        {
                            ...
                            {
                                var_f6261 = texture(s_txBuffer, (Data_PS[var_263e3].zw * vec2(fract(v_Additional.xy).x, 1.0 - fract(v_Additional.xy).y)) + Data_PS[var_263e3].xy);
                                highp float var_a6166;
                                if ((int(var_1dc25.x) & 1) != 0)
                                {
                                    var_a6166 = 1.0 - var_f6261.w;
                                }
                                else
                                {
                                    var_a6166 = var_f6261.w;
                                }
                                var_f6261.w = var_a6166;
                                highp float var_d5391;
                                if ((int(var_1dc25.x) & 4) != 0)
                                {
                                    highp vec3 var_48885 = var_f6261.xyz;
                                ...
                                {
                                    var_d5391 = var_f6261.w;
                                }
                                var_f6261.w = var_d5391;
                                ...
                                {
                                    var_a8c62 = var_f6261.w;
                                }
                                var_f6261.w = var_a8c62;
    ...
    bgfx_FragColor = var_f6261 * var_1710e;
}
