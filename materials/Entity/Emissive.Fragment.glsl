...
void main() {
#ifdef SOURCE_INPUT_TYPE0__SAMPLED
    highp vec4 var_cbf9d = texture(s_MatTexture0, v_texcoord0);
#endif
...
#endif
#ifdef SOURCE_INPUT_TYPE0__SAMPLED
    highp vec3 var_99c58 = mix(var_cbf9d.xyz, OverlayColor.xyz, vec3(var_5b8d6.w));
    highp vec4 var_edeb5 = vec4(var_99c58.x, var_99c58.y, var_99c58.z, var_cbf9d.w);
#endif
...
#endif
#ifdef SOURCE_INPUT_TYPE0__SAMPLED
    var_edeb5 = vec4(var_d04fd.x, var_d04fd.y, var_d04fd.z, var_cbf9d.w);
#endif
...
#endif
#ifdef SOURCE_INPUT_TYPE0__SAMPLED
    bgfx_FragColor = vec4(var_a3ef8.x, var_a3ef8.y, var_a3ef8.z, var_cbf9d.w);
#endif
}
