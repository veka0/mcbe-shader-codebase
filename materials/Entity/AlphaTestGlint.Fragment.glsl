...
void main() {
    ...
    highp vec4 var_da12a = vec4(var_49f0e.xyz * var_49f0e.xyz, abs(var_40943.w)) + vec4(mix((mix(var_280a9.xyz, OverlayColor.xyz, vec3(var_67487.w)).xyz * v_light.xyz).xyz, v_fog.xyz, vec3(var_27484.w)), 0.0);
    var_a53aa = var_da12a;
