...
layout(binding = 3, std430) buffer s_Lights { Light Lights[]; } var_0de88;
...
void func_aed09(inout int arg_3cd09, inout highp float arg_28e67, inout highp vec3 arg_214f6) {
    if (var_0de88.Lights[arg_3cd09].shadowProbeIndex < 0)
    {
        arg_28e67 = 1.0;
        return;
    }
    highp vec3 loc_3566a = v_worldPos - var_0de88.Lights[arg_3cd09].position.xyz;
    ...
    for (int loc_1139b = 0; loc_1139b < 4; loc_b74da = loc_f6f3d, loc_1139b++)
    {
        ...
        for (int loc_79fcd = 0; loc_79fcd < 4; loc_f6f3d = loc_bbf51, loc_79fcd++)
        {
            ...
            loc_0a47c.z = float(var_0de88.Lights[arg_3cd09].shadowProbeIndex * 6) + loc_0a47c.z;
...
void func_e7535(inout highp vec4 arg_83841, inout int arg_a1b0b, inout highp vec3 arg_62394, inout highp vec3 arg_154f5) {
    ...
    highp vec3 loc_569de = var_0de88.Lights[arg_a1b0b].position.xyz - v_worldPos;
    ...
    if (loc_95cea >= (var_0de88.Lights[arg_a1b0b].position.w * var_0de88.Lights[arg_a1b0b].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_fd676 = loc_95cea / ((var_0de88.Lights[arg_a1b0b].position.w * var_0de88.Lights[arg_a1b0b].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    highp vec3 loc_13960 = var_0de88.Lights[arg_a1b0b].color.xyz * loc_3d192;
    arg_83841 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_83841.w);
    arg_83841.w = 1.0 - (loc_95cea / ((var_0de88.Lights[arg_a1b0b].position.w * var_0de88.Lights[arg_a1b0b].position.w) + 9.9999997473787516355514526367188e-05));
    arg_62394 = (((var_0de88.Lights[arg_a1b0b].color.xyz * var_0de88.Lights[arg_a1b0b].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_2955f(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_6ff9e, inout highp vec3 arg_901f6, inout highp vec4 arg_336ff, inout highp vec3 arg_20396, inout highp vec3 arg_ef8ef, inout highp float arg_fe933, inout highp vec3 arg_81f82) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_a3520 = normalize((u_view * vec4(var_0de88.Lights[loc_ee051].position.xyz, 1.0)).xyz - arg_89c41);
...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_418d3(var_eddfe, var_d35f7, var_76f6c, var_01682, var_ab011, var_d2f69, var_3b20b, var_4746f, var_98063, var_dff00);
        highp vec3 var_6844f = var_2f58c;
        highp vec4 var_20f7d;
        highp vec3 var_bb3e9;
        highp vec3 var_5aa7a;
        bool var_f26f2;
        func_2955f(var_97950, var_9f936, var_f26f2, var_5aa7a, var_bb3e9, var_20f7d, var_6844f, var_88136, var_2f58c, var_76f6c, var_d2f69, var_3b20b, var_4746f, var_98063, var_dff00, var_660ac);
