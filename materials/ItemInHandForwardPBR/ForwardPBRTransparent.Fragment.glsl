...
layout(binding = 3, std430) buffer s_Lights { Light Lights[]; } var_0f769;
...
void func_51637(inout int arg_3cd09, inout highp float arg_c05a6, inout highp vec3 arg_214f6) {
    if (var_0f769.Lights[arg_3cd09].shadowProbeIndex < 0)
    {
        arg_c05a6 = 1.0;
        return;
    }
    highp vec3 loc_3566a = v_worldPos - var_0f769.Lights[arg_3cd09].position.xyz;
    ...
    for (int loc_1139b = 0; loc_1139b < 4; loc_54d10 = loc_f6f3d, loc_1139b++)
    {
        ...
        for (int loc_79fcd = 0; loc_79fcd < 4; loc_f6f3d = loc_bbf51, loc_79fcd++)
        {
            ...
            loc_7004c.z = float(var_0f769.Lights[arg_3cd09].shadowProbeIndex * 6) + loc_7004c.z;
...
void func_79cb8(inout highp vec4 arg_22524, inout int arg_c8e98, inout highp vec3 arg_62394, inout highp vec3 arg_154f5) {
    ...
    highp vec3 loc_569de = var_0f769.Lights[arg_c8e98].position.xyz - v_worldPos;
    ...
    if (loc_3bcb9 >= (var_0f769.Lights[arg_c8e98].position.w * var_0f769.Lights[arg_c8e98].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_8a6f3 = loc_3bcb9 / (var_0f769.Lights[arg_c8e98].position.w * var_0f769.Lights[arg_c8e98].position.w);
    ...
    highp vec3 loc_13960 = var_0f769.Lights[arg_c8e98].color.xyz * loc_3d192;
    arg_22524 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_22524.w);
    arg_22524.w = 1.0 - (loc_3bcb9 / (var_0f769.Lights[arg_c8e98].position.w * var_0f769.Lights[arg_c8e98].position.w));
    arg_62394 = (((var_0f769.Lights[arg_c8e98].color.xyz * var_0f769.Lights[arg_c8e98].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_2955f(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_6ff9e, inout highp vec3 arg_901f6, inout highp vec4 arg_336ff, inout highp vec3 arg_20396, inout highp vec3 arg_ef8ef, inout highp float arg_fe933, inout highp vec3 arg_81f82) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_a3520 = normalize((u_view * vec4(var_0f769.Lights[loc_ee051].position.xyz, 1.0)).xyz - arg_89c41);
...
void main() {
    ...
    highp vec3 var_98063 = pow(max(var_a9492.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
#endif
#ifdef MULTI_COLOR_TINT__ON
    highp vec3 var_98063 = pow(max(var_e73ee.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
#endif
    ...
    highp vec3 var_4746f = vec3(0.039999999105930328369140625 * (1.0 - var_3b20b.x)) + (var_98063 * var_3b20b.x);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_418d3(var_eddfe, var_d35f7, var_76f6c, var_01682, var_ab011, var_e1519, var_3b20b, var_4746f, var_98063, var_dff00);
        highp vec3 var_6844f = var_dde88;
        highp vec4 var_20f7d;
        highp vec3 var_bb3e9;
        highp vec3 var_5aa7a;
        bool var_f26f2;
        func_2955f(var_97950, var_9f936, var_f26f2, var_5aa7a, var_bb3e9, var_20f7d, var_6844f, var_88136, var_dde88, var_76f6c, var_e1519, var_3b20b, var_4746f, var_98063, var_dff00, var_660ac);
    ...
    highp vec3 var_7610b;
    if (PreExposureEnabled.x > 0.0)
    {
        var_7610b = var_be237 * (0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x);
    }
    else
    {
        var_7610b = var_be237;
    ...
    bgfx_FragData[0] = vec4(var_7610b.x, var_7610b.y, var_7610b.z, vec4(var_aaae6, var_aaae6, var_aaae6, var_71131.w).w);
