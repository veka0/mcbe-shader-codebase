...
void main() {
    ivec2 var_910e6 = ivec2(v_texcoord0 * InputAndOutputResolution.zw);
    bgfx_FragColor = vec4(vec3(0.9570000171661376953125, 0.2750000059604644775390625, 0.0670000016689300537109375) * step(mod(float(var_910e6.x - var_910e6.y), 16.0) * 0.066666670143604278564453125, 0.0625), 1.0);
}
