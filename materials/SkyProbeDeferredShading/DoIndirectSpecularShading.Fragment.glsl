...
void main() {
    ...
    highp vec4 var_483d3 = texture(s_EmissiveAmbientLinearRoughness, v_texcoord0);
    ...
    highp float var_eca07 = clamp(((var_483d3.z * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0);
    ...
    if (SSRParameters.x != 0.0)
    {
        ...
        {
            highp float var_0e6b6 = 1.0 - var_483d3.w;
            var_0f441 = (1.0 - (var_0e6b6 * var_0e6b6)) * (IBLParameters.y - 1.0);
        }
        else
        {
            highp float var_8084c = 1.0 - var_483d3.w;
        ...
        highp vec3 var_67eb4 = mix(textureLod(s_SpecularIBLRecords, vec4(var_a5d2d, float((var_ae27f + 2) % 3)), var_0f441).xyz, textureLod(s_SpecularIBLRecords, vec4(var_a5d2d, float(var_ae27f)), var_0f441).xyz, vec3(IBLParameters.w));
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_be4af(var_483d3, var_d88d2, var_8c1ad, var_26642);
        ...
        highp vec2 var_caa24 = vec2(clamp(dot(var_9897b, -(var_a6f80 / vec3(var_a8b25))), 0.0, 1.0), var_483d3.w);
    ...
    else
    {
        ...
        if (IBLParameters.x != 0.0)
        {
            ...
            if (int(ConvolutionType.x) == 1)
            {
                highp float var_37c9f = 1.0 - var_483d3.w;
                var_622ee = (1.0 - (var_37c9f * var_37c9f)) * (IBLParameters.y - 1.0);
            }
            else
            {
                highp float var_0f4a8 = 1.0 - var_483d3.w;
            ...
            highp vec3 var_63ae8 = mix(textureLod(s_SpecularIBLRecords, vec4(var_bc3e5, float((var_0a0b1 + 2) % 3)), var_622ee).xyz, textureLod(s_SpecularIBLRecords, vec4(var_bc3e5, float(var_0a0b1)), var_622ee).xyz, vec3(IBLParameters.w));
            ...
            if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
            {
                ...
                func_be4af(var_483d3, var_d88d2, var_265a6, var_bf376);
            ...
            highp vec2 var_cf091 = vec2(clamp(dot(var_9897b, -(var_a6f80 / vec3(var_a8b25))), 0.0, 1.0), var_483d3.w);
        ...
        else
        {
            ...
            if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
            {
                ...
                func_2e632(var_483d3, var_d88d2, var_5b282);
                highp vec2 var_b6dcd = vec2(clamp(dot(var_9897b, -(var_a6f80 / vec3(var_a8b25))), 0.0, 1.0), var_483d3.w);
