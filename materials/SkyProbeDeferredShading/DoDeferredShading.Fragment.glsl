    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_a0f15 > 0.0)
        {
            ...
            else
            {
                ...
                highp vec3 var_bacde = var_50289;
                highp float var_9281d = 1.0 - smoothstep(FogSkyBlend.x - FogSkyBlend.w, FogSkyBlend.z - FogSkyBlend.w, var_bacde.y);
                highp float var_99d92 = dot(var_50289, SunDir.xyz);
                highp float var_b6eed = dot(var_50289, MoonDir.xyz);
                highp vec3 var_5d345 = var_50289;
