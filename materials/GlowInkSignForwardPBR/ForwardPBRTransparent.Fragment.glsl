...
void main() {
    ...
    highp vec3 var_b4e88;
    func_9b87e(var_b4e88, var_48376);
    ...
    highp vec3 var_d42f9 = var_e14aa.xyz;
    highp vec3 var_72f13 = (u_view * var_e14aa).xyz;
    highp vec3 var_c1cbb = vec3(0.039999999105930328369140625 * (1.0 - MERSUniforms.x)) + (var_b4e88 * MERSUniforms.x);
    ...
    highp vec4 var_3e390 = vec4(var_bc571, 0.0);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_5a44e(var_c16c9, var_8f93a, var_72f13, var_fbd89, var_d42f9, var_d5595, var_f2bdf, var_c6972, var_c1cbb, var_b4e88, var_13784);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_54904;
        highp vec3 var_a53cf;
        highp vec3 var_12f6e;
        func_60043(var_12f6e, var_c16c9, var_a53cf, var_8f93a, var_54904, var_1cc0e, var_80075, var_72f13, var_c6972, var_c1cbb, var_b4e88, var_d42f9, var_13784);
#endif
        highp vec4 var_829bb = var_3e390;
        uint var_08c07 = uint(floor(var_829bb.w * 255.0));
        highp vec3 var_d5e11;
        if ((DirectionalLightToggleAndMaxDistanceAndMaxCascadesPerLightAndGPUBlockLightingEnabled.w != 0.0) && (!((var_08c07 & 1u) != 0u)))
        {
            highp vec3 var_81aaa = ((v_worldPos - WorldOrigin.xyz) - vec3(0.5)) + (var_d42f9 * 0.20000000298023223876953125);
            ...
            if (var_4680b)
            {
                ...
                if (var_cdbb7)
                {
                    var_32d93 = any(greaterThanEqual(abs(var_d42f9), vec3(1.0)));
                }
                else
                {
                    var_32d93 = var_cdbb7;
                ...
                if (var_32d93)
                {
                    highp vec3 var_523e6 = var_d42f9;
                    highp vec3 var_34a44 = abs(var_d42f9);
        ...
        {
            var_d5e11 = var_3e390.xyz;
        }
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_9c24a = var_54904;
#endif
        highp vec4 var_b07d6 = SkyAmbientLightColorIntensity;
        highp float var_af3de = TileLightIntensity.y * TileLightIntensity.y;
#ifdef POINT_LIGHT_SHADING__ON
        var_f7210 = var_12f6e;
#endif
...
#ifdef POINT_LIGHT_SHADING__OFF
        var_e51b8 = var_8f93a;
        var_48988 = ((var_b4e88 * (1.0 - MERSUniforms.x)) * max((var_d5e11 * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_af3de * var_af3de) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_b07d6.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w;
#endif
#ifdef POINT_LIGHT_SHADING__ON
        var_48988 = ((var_b4e88 * (1.0 - MERSUniforms.x)) * max(((var_d5e11 + (var_54904.xyz * var_9c24a.w)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_af3de * var_af3de) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_b07d6.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w;
#endif
        var_0cece = ((mix(var_b4e88, vec3(dot(var_b4e88, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(GlowStrength.x)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x;
    }
    else
    {
        var_f7210 = vec3(0.0);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp vec3 var_a56d9 = reflect(normalize(var_a8715 - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_d42f9);
    ...
    highp vec3 var_1243d = vec4(var_bde45.xyz + (mix(((var_48988 + var_f7210) + var_e51b8) + var_0cece, var_164a6.xyz, vec3(var_45187.w)) * var_063c9.w), 1.0).xyz + var_083e8;
