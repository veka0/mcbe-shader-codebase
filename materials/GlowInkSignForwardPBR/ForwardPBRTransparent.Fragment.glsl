...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_c65e4(var_8bbcb, var_b02e1, var_72f13, var_fbd89, var_1d2cf, var_d5595, var_f2bdf, var_c6972, var_c1cbb, var_f4b2a, var_13784);
        highp vec4 var_36252;
        highp vec3 var_a53cf;
        highp vec3 var_12f6e;
        func_4e1d6(var_12f6e, var_8bbcb, var_a53cf, var_b02e1, var_36252, var_1cc0e, var_80075, var_72f13, var_c6972, var_c1cbb, var_f4b2a, var_1d2cf, var_13784);
        var_7049d = var_12f6e;
        var_a1285 = var_a53cf;
        var_ecc6e = var_36252;
    }
    ...
    highp vec3 var_d35b6 = var_1160c.xyz + (mix((((((var_f4b2a * (1.0 - MERSUniforms.x)) * max(((var_451c2 + (var_ecc6e.xyz * var_bf94a.w)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_a7b47 * var_a7b47) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_fba63.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_7049d) + var_a1285) + (((mix(var_f4b2a, vec3(dot(var_f4b2a, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(GlowStrength.x)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_33f03.xyz, vec3(var_3086a.w)) * var_74565.w);
