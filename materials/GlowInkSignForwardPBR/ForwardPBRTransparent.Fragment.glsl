...
void main() {
    ...
    highp vec3 var_6aa0c;
    func_9b87e(var_6aa0c, var_48376);
    ...
    highp vec3 var_255a3 = (var_219ab + (var_fddd0 - (var_322a5 * dot(var_fddd0, var_322a5)))) + WorldOrigin.xyz;
    highp vec3 var_38266 = var_e14aa.xyz;
    highp vec3 var_a2d96 = (u_view * var_e14aa).xyz;
    highp vec3 var_ce4e1 = vec3(0.039999999105930328369140625 * (1.0 - MERSUniforms.x)) + (var_6aa0c * MERSUniforms.x);
    ...
    highp vec4 var_3e390 = vec4(var_5b4a8, 0.0);
    ...
    highp vec3 var_0cece;
    highp vec3 var_79d9b;
    highp vec3 var_e51b8;
    highp vec3 var_f7210;
    if (var_5bd0a.z != 1.0)
    {
        highp vec3 var_2c548 = -(var_29d3b / vec3(length(var_29d3b) + 9.9999997473787516355514526367188e-05));
        highp float var_7f970 = MERSUniforms.w * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        highp vec3 var_d5595 = var_29d3b;
        ...
        highp vec3 var_bc201;
        highp vec3 var_83eb1;
        func_5a44e(var_83eb1, var_bc201, var_a2d96, var_fbd89, var_38266, var_d5595, var_f2bdf, var_2c548, var_ce4e1, var_6aa0c, var_7f970);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec3 var_815dd;
        highp vec3 var_8ee3d;
        func_9830f(var_8ee3d, var_83eb1, var_815dd, var_bc201, var_255a3, var_29d3b, var_a2d96, var_2c548, var_ce4e1, var_6aa0c, var_38266, var_7f970);
#endif
        highp vec4 var_829bb = var_3e390;
...
#endif
        {
            highp vec3 var_36ee9 = ((v_worldPos - WorldOrigin.xyz) - vec3(0.5)) + (var_38266 * 0.20000000298023223876953125);
            ...
            if (var_4680b)
            {
                ...
                if (var_cdbb7)
                {
                    var_32d93 = any(greaterThanEqual(abs(var_38266), vec3(1.0)));
                }
                else
                {
                    var_32d93 = var_cdbb7;
                ...
                if (var_32d93)
                {
                    highp vec3 var_523e6 = var_38266;
                    highp vec3 var_34a44 = abs(var_38266);
        ...
        {
            var_da927 = var_3e390.xyz;
        }
        highp vec4 var_55223 = SkyAmbientLightColorIntensity;
        highp float var_9afe7 = TileLightIntensity.y * TileLightIntensity.y;
#ifdef POINT_LIGHT_SHADING__ON
        var_f7210 = var_8ee3d;
#endif
#ifdef POINT_LIGHT_SHADING__OFF
        ...
        var_e51b8 = var_bc201;
#endif
        var_79d9b = ((var_6aa0c * (1.0 - MERSUniforms.x)) * max((var_da927 * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_9afe7 * var_9afe7) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_55223.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w;
        var_0cece = ((mix(var_6aa0c, vec3(dot(var_6aa0c, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(GlowStrength.x)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x;
    }
    else
    {
        var_f7210 = vec3(0.0);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        {
            var_d11db = (u_view * vec4(var_255a3, 1.0)).xyz;
            var_a8715 = var_255a3;
        }
        else
        {
        ...
        highp vec3 var_a56d9 = reflect(normalize(var_a8715 - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_38266);
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_045b4(var_3e390, var_84ff0, var_617d6);
        ...
        highp vec2 var_bfbb7 = vec2(clamp(dot(var_a2d96, -normalize(var_d11db)), 0.0, 1.0), MERSUniforms.z);
        var_bfbb7.y = 1.0 - var_bfbb7.y;
        highp vec2 var_7d2be = texture(s_BrdfLUT, var_bfbb7).xy;
        highp vec3 var_fe0f6 = var_da3af * ((var_ce4e1 * var_7d2be.x) + vec3(var_7d2be.y));
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            if (QuantizationParameters.w > 0.0)
            {
                var_481f7 = (u_view * vec4(var_255a3, 1.0)).xyz;
            }
            else
            {
                var_481f7 = var_29d3b;
            ...
            func_8822c(var_3e390, var_6eb02);
            highp vec2 var_c1068 = vec2(clamp(dot(var_a2d96, -normalize(var_481f7)), 0.0, 1.0), MERSUniforms.z);
            var_c1068.y = 1.0 - var_c1068.y;
            highp vec2 var_864a0 = texture(s_BrdfLUT, var_c1068).xy;
            var_e2657 = var_6eb02.xyz * ((var_ce4e1 * var_864a0.x) + vec3(var_864a0.y));
        }
        else
        {
            var_e2657 = vec3(0.0);
    ...
    highp vec3 var_1243d = vec4(var_bde45.xyz + (mix(((var_79d9b + var_f7210) + var_e51b8) + var_0cece, var_164a6.xyz, vec3(var_45187.w)) * var_063c9.w), 1.0).xyz + var_083e8;
    highp vec4 var_ba5d1 = texture(s_PreviousFrameAverageLuminance, vec2(0.5));
    highp float var_44167 = var_ba5d1.x;
    highp vec3 var_2771c = var_1243d + (var_1243d * (vec3(LightingEnabledAndAdaptiveEmissive.y, LightingEnabledAndAdaptiveEmissive.y, LightingEnabledAndAdaptiveEmissive.y) / vec3((0.180000007152557373046875 / var_44167) + 9.9999997473787516355514526367188e-05)));
