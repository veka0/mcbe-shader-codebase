...
void StarsSurface(in StandardSurfaceInput surfaceInput, inout StandardSurfaceOutput surfaceOutput) {
    vec3 starColor = surfaceInput.Color;
    starColor *= StarsColor.rgb * surfaceInput.Alpha;
    surfaceOutput.Albedo = starColor;
...
void StandardTemplate_Opaque_Frag(FragmentInput fragInput, inout FragmentOutput fragOutput) {
    ...
    StarsSurface(surfaceInput, surfaceOutput);
