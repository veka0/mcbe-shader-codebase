...
void main() {
    ...
    highp vec3 var_9f2c1 = var_9f386.xyz;
    ...
    highp vec3 var_c35eb = var_9f2c1;
    highp vec3 var_5bd0a = var_adfcf;
    highp vec3 var_811e1 = var_9f2c1;
    ...
    highp vec3 var_19589 = -(var_9f2c1 / vec3(length(var_9f2c1) + 9.9999997473787516355514526367188e-05));
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_17da7(var_8efb6, var_2a503, var_489d8, var_c35eb, var_c062c, var_19589, var_d2a1f, var_50417, var_badc0, var_15166, var_f9967);
        highp vec3 var_6bb48 = var_9f2c1;
        highp vec4 var_1b4da;
        highp vec3 var_c1a13;
        highp vec3 var_da80f;
        bool var_716f8;
        func_32bd4(var_37230, var_8ba1b, var_716f8, var_da80f, var_c1a13, var_1b4da, var_6bb48, var_adfcf, var_9f2c1, var_489d8, var_19589, var_d2a1f, var_50417, var_badc0, var_15166, var_f9967, var_9058a);
    ...
    highp float var_7d5ab = length(var_9f2c1);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp vec2 var_c040f = texture(s_BrdfLUT, vec2(clamp(dot(var_489d8, -(var_9f2c1 / vec3(length(var_9f2c1)))), 0.0, 1.0), var_d2a1f)).xy;
        highp vec3 var_94472 = ((var_b1eea * (pow(clamp(((TileLightIntensity.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0), 3.0) * IBLParameters.x)) * IBLParameters.z) * ((var_50417 * var_c040f.x) + vec3(var_c040f.y));
        highp float var_96068 = length(var_9f2c1);
