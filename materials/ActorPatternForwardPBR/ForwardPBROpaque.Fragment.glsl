...
void func_17da7(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_02c40, inout highp vec3 arg_abe00, inout highp vec2 arg_c288e, inout highp vec3 arg_99739, inout highp float arg_2bc6f, inout highp vec3 arg_85276, inout highp vec3 arg_cff01, inout highp float arg_5416d, inout highp float arg_24e02) {
...
void main() {
    ...
    highp vec4 var_6a69a = MatColor * texture(s_MatTexture, v_texcoord0);
#endif
#ifdef MASKED_MULTITEXTURE__ON
    highp vec4 var_ade26 = texture(s_MatTexture1, v_texcoord0);
    highp vec4 var_76534 = var_ade26;
    highp vec4 var_6a69a = mix(var_ade26, MatColor * texture(s_MatTexture, v_texcoord0), vec4(float((((var_76534.x + var_76534.y) + var_76534.z) * (1.0 - var_76534.w)) > 0.0)));
#endif
#ifdef EMISSIVE__EMISSIVE
    if (dot(vec4(var_6a69a.xyz, mix(var_6a69a.w, var_6a69a.w * OverlayColor.w, TintedAlphaTestEnabled.x)), vec4(1.0)) < ActorFPEpsilon.x)
#endif
#ifdef EMISSIVE__EMISSIVE_ONLY
    highp float var_a8620 = mix(var_6a69a.w, var_6a69a.w * OverlayColor.w, TintedAlphaTestEnabled.x);
    bool var_e7bf9 = var_a8620 < ActorFPEpsilon.x;
    bool var_330ac;
    if (!var_e7bf9)
#endif
#if defined(EMISSIVE__OFF) && !defined(CHANGE_COLOR__OFF)
    if (mix(var_6a69a.w, var_6a69a.w * OverlayColor.w, TintedAlphaTestEnabled.x) < ActorFPEpsilon.x)
#endif
#if defined(CHANGE_COLOR__OFF) && defined(EMISSIVE__OFF)
    if (mix(var_6a69a.w, var_6a69a.w * OverlayColor.w, TintedAlphaTestEnabled.x) < 0.5)
#endif
    {
#ifdef EMISSIVE__EMISSIVE_ONLY
...
#ifdef CHANGE_COLOR__MULTI
    highp vec2 var_459de = var_6a69a.xy;
    highp vec3 var_1099e = mix((var_6a69a.xxx * ChangeColor.xyz).xyz, var_6a69a.yyy * MultiplicativeTintColor.xyz, vec3(ceil(var_459de.y)));
    highp vec4 var_8c1c4 = vec4(var_1099e.x, var_1099e.y, var_1099e.z, var_6a69a.w);
#endif
#ifndef CHANGE_COLOR__MULTI
    highp vec4 var_8c1c4 = var_6a69a;
#endif
#ifdef CHANGE_COLOR__ON
    highp vec4 var_8a135 = ChangeColor;
    highp vec3 var_fba6e = mix(var_6a69a.xyz, var_6a69a.xyz * ChangeColor.xyz, vec3(var_8c1c4.w));
    var_8c1c4 = vec4(var_fba6e.x, var_fba6e.y, var_fba6e.z, var_6a69a.w);
    var_8c1c4.w *= var_8a135.w;
#endif
    var_8c1c4.w = max(UseAlphaRewrite.x, var_8c1c4.w);
    var_6a69a = var_8c1c4;
    highp vec3 var_491ab = mix((var_8c1c4.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w));
    highp vec4 var_f039a = vec4(var_491ab.x, var_491ab.y, var_491ab.z, var_8c1c4.w);
    highp vec3 var_badc0 = var_491ab.xyz;
    int var_f71fc = int(PBRTextureFlags.x);
    highp float var_15166;
    highp float var_014e9;
    highp float var_d2a1f;
    ...
    if ((var_f71fc & 1) == 1)
    {
        ...
        var_76cb9 = var_ae1fa;
        var_d2a1f = var_4035b.z;
        var_014e9 = var_4035b.y;
        var_15166 = var_4035b.x;
    }
    else
    {
        var_76cb9 = SubsurfaceUniform.x;
        var_d2a1f = RoughnessUniform.x;
        var_014e9 = EmissiveUniform.x;
        var_15166 = MetalnessUniform.x;
    }
    ...
    highp vec3 var_adfcf = var_e87e0.xyz / vec3(var_b8928.w);
    highp vec4 var_7c164 = vec4(normalize(var_d39c8), 1.0);
    highp vec3 var_e0815 = var_9f386.xyz;
    highp vec3 var_9058a = var_7c164.xyz;
    highp vec3 var_489d8 = (u_view * var_7c164).xyz;
    highp vec3 var_50417 = vec3(0.039999999105930328369140625 * (1.0 - var_15166)) + (var_badc0 * var_15166);
    ...
    highp vec3 var_c35eb = var_e0815;
    highp vec3 var_5bd0a = var_adfcf;
    highp vec3 var_811e1 = var_e0815;
    ...
    highp vec3 var_34c46 = -(var_e0815 / vec3(length(var_e0815)));
    highp float var_f9967 = var_76cb9 * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
    bool var_5a6e4;
    highp vec4 var_9a0a9;
    highp vec3 var_44335;
    highp vec3 var_94c8b;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_c062c = vec2(var_49182, var_280ef);
        highp vec3 var_2a503;
        highp vec3 var_8efb6;
        func_17da7(var_8efb6, var_2a503, var_489d8, var_c35eb, var_c062c, var_34c46, var_d2a1f, var_50417, var_badc0, var_15166, var_f9967);
        highp vec3 var_6bb48 = var_e0815;
        highp vec4 var_1b4da;
        highp vec3 var_c1a13;
        highp vec3 var_da80f;
        bool var_716f8;
        func_32bd4(var_37230, var_8ba1b, var_716f8, var_da80f, var_c1a13, var_1b4da, var_6bb48, var_adfcf, var_e0815, var_489d8, var_34c46, var_d2a1f, var_50417, var_badc0, var_15166, var_f9967, var_9058a);
        var_94c8b = var_8efb6 + (var_da80f * (1.0 - var_f3062));
        var_44335 = var_2a503 + (var_c1a13 * (1.0 - var_5d160));
        var_9a0a9 = var_1b4da;
        var_5a6e4 = var_716f8;
    }
    else
    ...
    highp float var_7c2a4;
    if (var_5a6e4)
    {
        var_7c2a4 = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_7c2a4 = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_69b2b = var_9a0a9;
    highp vec4 var_0f873 = SkyAmbientLightColorIntensity;
    highp float var_908b5 = TileLightIntensity.x * TileLightIntensity.x;
    highp vec3 var_e2ae2 = (((((var_badc0 * (1.0 - var_15166)) * max(((clamp(vec3(var_908b5 + (var_69b2b.x * var_69b2b.w), (var_908b5 * ((((var_908b5 * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_69b2b.y * var_69b2b.w), (var_908b5 * (((var_908b5 * var_908b5) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_69b2b.z * var_69b2b.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_7c2a4) + ((SkyAmbientLightColorIntensity.xyz * pow(TileLightIntensity.y, mix(5.0, 3.0, CameraLightIntensity.y))) * var_0f873.w), vec3(0.02999999932944774627685546875))) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_94c8b) + var_44335) + (((mix(var_badc0, vec3(dot(var_badc0, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_014e9)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x);
    highp float var_7d5ab = length(var_e0815);
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_e2ae2, var_a6488, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_e2ae2;
    ...
    {
        var_7e3dc = mix(var_e2ae2, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
    highp vec3 var_28cb8;
    if (VolumeScatteringEnabledAndPointLightVolumetricsEnabled.x != 0.0)
    {
        highp vec2 var_65315 = VolumeNearFar.xy;
        highp vec2 var_7d045 = (var_adfcf.xy + vec2(1.0)) * 0.5;
        highp vec4 var_92c8f = u_invProj * vec4(var_adfcf, 1.0);
    ...
    {
        highp vec3 var_7914f = reflect(normalize(v_worldPos - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_9058a);
        ...
        highp float var_12c15 = 1.0 - var_d2a1f;
        ...
        highp vec2 var_c040f = texture(s_BrdfLUT, vec2(clamp(dot(var_489d8, -(var_e0815 / vec3(length(var_e0815)))), 0.0, 1.0), var_d2a1f)).xy;
        highp vec3 var_94472 = ((var_9aad8 * (pow(clamp(((TileLightIntensity.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0), 3.0) * IBLParameters.x)) * IBLParameters.z) * ((var_50417 * var_c040f.x) + vec3(var_c040f.y));
        highp float var_96068 = length(var_e0815);
        ...
        if (VolumeScatteringEnabledAndPointLightVolumetricsEnabled.x != 0.0)
        {
            ...
            highp vec2 var_9ec98 = (var_adfcf.xy + vec2(1.0)) * 0.5;
            highp vec4 var_197cc = u_invProj * vec4(var_adfcf, 1.0);
    ...
    bgfx_FragData[0] = vec4(var_7610b.x, var_7610b.y, var_7610b.z, vec4(var_aaae6, var_aaae6, var_aaae6, var_f039a.w).w);
}
