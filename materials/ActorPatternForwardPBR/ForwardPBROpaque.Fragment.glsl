...
layout(binding = 12, std430) buffer s_GpuEntryBuffer { GpuVolumeEntry GpuEntryBuffer[]; } var_4dd4b;
#ifdef POINT_LIGHT_SHADING__ON
...
void main() {
    ...
    func_9b87e(var_b8af5, var_9e11a);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_634be(var_f6f76, var_357df, var_cde66, var_b5d88, var_3c004, var_6cfc2, var_b82c9, var_9823f, var_d0296, var_c1070, var_b8af5, var_55f80, var_11a4a);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_95aa8(var_e318f, var_f6f76, var_aae12, var_357df, var_05431, var_6aed3, var_0daae, var_cde66, var_9823f, var_d0296, var_c1070, var_b8af5, var_55f80, var_3c004, var_11a4a);
        var_98bf2 = var_e318f;
#endif
    ...
    if ((DirectionalLightToggleAndMaxDistanceAndMaxCascadesPerLightAndGPUBlockLightingEnabled.w != 0.0) && (!((var_9c6ab & 1u) != 0u)))
    {
        ...
        for (;;)
        {
            if (var_d6224 < 8)
            {
                uint var_a70f2 = uint(var_4dd4b.GpuEntryBuffer[var_3af73].hash) & 65535u;
                bool var_734de = var_a70f2 == var_19109;
                bool var_e4213;
                if (var_734de)
                {
                    var_e4213 = var_4dd4b.GpuEntryBuffer[var_3af73].packed_xy == var_ab334;
                }
                else
                {
                    var_e4213 = var_734de;
                ...
                if (var_e4213)
                {
                    var_ec5a7 = var_4dd4b.GpuEntryBuffer[var_3af73].packed_zw == var_76717;
                }
                else
                {
                    var_ec5a7 = var_e4213;
                ...
                else
                {
                    ...
                    if (var_ec5a7)
                    {
                        var_5ebd4 = uint(var_4dd4b.GpuEntryBuffer[var_3af73].user_data);
                    }
                    else
                    {
                        var_5ebd4 = var_8e0b6;
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_d903a(var_5b71e, var_55f80, var_713f8, var_26642);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_769bb(var_5b71e, var_55f80, var_da70a);
