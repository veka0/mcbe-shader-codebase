...
#endif
float var_33fae;
layout(binding = 13, std430) buffer s_VoxelBuffer { VoxelNode VoxelBuffer[]; } var_4f342;
layout(binding = 12, std430) buffer s_GpuEntryBuffer { GpuVolumeEntry GpuEntryBuffer[]; } var_bd250;
#ifdef POINT_LIGHT_SHADING__ON
layout(binding = 15, std430) buffer s_zLights { Light zLights[]; } var_9ce73;
layout(binding = 14, std430) buffer s_zLightLookupArray { LightData zLightLookupArray[]; } var_257bb;
#endif
...
void func_daa30(inout int arg_7070b, inout highp float arg_43b7a, inout highp float arg_9499a, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c, inout highp float arg_77c90) {
    ...
    highp vec3 loc_8868e = arg_aee55 - var_9ce73.zLights[arg_7070b].position.xyz;
    ...
    highp vec4 loc_87a38 = var_9ce73.zLights[arg_7070b].shadowFaceUV0;
    highp vec3 loc_baa89;
    if (loc_f3fad == 1)
    {
        loc_87a38 = var_9ce73.zLights[arg_7070b].shadowFaceUV1;
    ...
    else
    {
        ...
        if (loc_f3fad == 2)
        {
            loc_87a38 = var_9ce73.zLights[arg_7070b].shadowFaceUV2;
        ...
        else
        {
            ...
            if (loc_f3fad == 3)
            {
                loc_87a38 = var_9ce73.zLights[arg_7070b].shadowFaceUV3;
            ...
            else
            {
                ...
                if (loc_f3fad == 4)
                {
                    loc_87a38 = var_9ce73.zLights[arg_7070b].shadowFaceUV4;
                ...
                else
                {
                    ...
                    if (loc_f3fad == 5)
                    {
                        loc_87a38 = var_9ce73.zLights[arg_7070b].shadowFaceUV5;
...
void func_8e599(inout int arg_2f7cd, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_0a2b9, inout highp vec3 arg_f6a53, inout highp vec3 arg_4f9dc, inout highp float arg_8bccf) {
    ...
    highp vec3 loc_a4b3e = var_9ce73.zLights[arg_2f7cd].position.xyz - v_worldPos;
    ...
    if (loc_16a27 >= (var_9ce73.zLights[arg_2f7cd].position.w * var_9ce73.zLights[arg_2f7cd].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_0a2b9 = vec3(0.0);
    ...
    highp float loc_4c5a5 = loc_16a27 / ((var_9ce73.zLights[arg_2f7cd].position.w * var_9ce73.zLights[arg_2f7cd].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    arg_43b7a = loc_22c1c;
    arg_7f337 = loc_a011d;
    arg_0a2b9 = (var_9ce73.zLights[arg_2f7cd].color.xyz * var_9ce73.zLights[arg_2f7cd].color.w) * loc_ae18a;
}
void func_4fd11(inout highp vec3 arg_33c3b, inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_efe4b, inout highp vec3 arg_81f79, inout highp float arg_d565c, inout highp vec3 arg_58ffc, inout highp vec3 arg_cff01, inout highp float arg_5416d, inout highp vec3 arg_3ec33, inout highp vec3 arg_8f7d6, inout highp float arg_a6fcb) {
    ...
    {
        int loc_95ec7 = int(var_257bb.zLightLookupArray[loc_6165e].lookup);
        if (loc_95ec7 < 0)
        {
            break;
        }
        highp vec3 loc_ed90f = normalize((u_view * vec4(var_9ce73.zLights[loc_95ec7].position.xyz, 1.0)).xyz - arg_33c3b);
...
void func_33953(inout uint arg_a601e, inout highp vec3 arg_aa7d7) {
    if (var_4f342.VoxelBuffer[arg_a601e].data == 0u)
    {
        arg_aa7d7 = vec3(0.0);
        return;
    }
    highp vec4 loc_11fc1 = vec4(uvec4(var_4f342.VoxelBuffer[arg_a601e].data, var_4f342.VoxelBuffer[arg_a601e].data >> 8u, var_4f342.VoxelBuffer[arg_a601e].data >> 16u, var_4f342.VoxelBuffer[arg_a601e].data >> 24u) & uvec4(255u)) * vec4(0.0039215688593685626983642578125);
...
void func_593c8(inout highp vec3 arg_ca7c6, inout highp vec3 arg_951a8, inout uint arg_2632b, inout highp vec3 arg_e5233) {
    ...
    {
        if (!((var_4f342.VoxelBuffer[arg_2632b + 4096u].data & (1u << uint(var_7138c[loc_fa0d5]))) != 0u))
        {
            arg_e5233 = vec3(0.0);
            return;
        }
        uvec3 loc_441ec = uvec3(arg_ca7c6 - (floor(arg_ca7c6 * 0.0625) * 16.0)) & uvec3(15u);
        loc_58bb3 = (var_4f342.VoxelBuffer[(arg_2632b + 4097u) + uint(var_7138c[loc_fa0d5])].data >> 2u) + ((loc_441ec.y + (loc_441ec.z * 16u)) + (loc_441ec.x * 256u));
    }
...
void main() {
...
#ifdef EMISSIVE__EMISSIVE
    if (var_e194d || (dot(vec4(var_d9ac1.xyz, mix(var_8afd1.w, var_8afd1.w * OverlayColor.w, TintedAlphaTestEnabled.x)), vec4(1.0)) < ActorFPEpsilon.x))
#endif
#ifdef EMISSIVE__EMISSIVE_ONLY
    if (var_e194d || var_bd07c)
#endif
#if defined(EMISSIVE__OFF) && !defined(CHANGE_COLOR__OFF)
    if (var_e194d || (mix(var_8afd1.w, var_8afd1.w * OverlayColor.w, TintedAlphaTestEnabled.x) < ActorFPEpsilon.x))
#endif
#if defined(CHANGE_COLOR__OFF) && defined(EMISSIVE__OFF)
    if (var_e194d || (mix(var_8afd1.w, var_8afd1.w * OverlayColor.w, TintedAlphaTestEnabled.x) < 0.5))
#endif
    {
        discard;
    }
    ...
    highp vec4 var_6eb7c = vec4(var_491ab.x, var_491ab.y, var_491ab.z, var_8afd1.w);
    highp vec3 var_9e11a = var_491ab.xyz;
    highp float var_fae64;
    highp float var_fb018;
    highp float var_b259b;
    ...
    if ((var_cd3a0 & 1) == 1)
    {
        ...
        var_6757b = var_ae1fa;
        var_b259b = var_4035b.z;
        var_fb018 = var_4035b.y;
        var_fae64 = var_4035b.x;
    }
    else
    {
        var_6757b = SubsurfaceUniform.x;
        var_b259b = RoughnessUniform.x;
        var_fb018 = EmissiveUniform.x;
        var_fae64 = MetalnessUniform.x;
    }
    ...
    func_9b87e(var_3e08d, var_9e11a);
    ...
    highp vec3 var_2266d = vec3(0.039999999105930328369140625 * (1.0 - var_fae64)) + (var_3e08d * var_fae64);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        highp float var_de864 = var_6757b * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        ...
        func_634be(var_57594, var_59d8b, var_3ad69, var_b5d88, var_f783d, var_6cfc2, var_b82c9, var_dfcb4, var_b259b, var_2266d, var_3e08d, var_fae64, var_de864);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec3 var_0edfc;
        highp vec3 var_3cf91;
        func_2dd06(var_3cf91, var_57594, var_0edfc, var_59d8b, var_d5e8a, var_86c43, var_3ad69, var_dfcb4, var_b259b, var_2266d, var_3e08d, var_fae64, var_f783d, var_de864);
#endif
...
#endif
        {
            ...
            for (;;)
            {
                if (var_4bfc3 < 8)
                {
                    uint var_b3275 = uint(var_bd250.GpuEntryBuffer[var_1bd82].hash) & 65535u;
                    bool var_079e7 = var_b3275 == var_0b021;
                    bool var_88b02;
                    if (var_079e7)
                    {
                        var_88b02 = var_bd250.GpuEntryBuffer[var_1bd82].packed_xy == var_8282d;
                    }
                    else
                    {
                        var_88b02 = var_079e7;
                    ...
                    if (var_88b02)
                    {
                        var_4f663 = var_bd250.GpuEntryBuffer[var_1bd82].packed_zw == var_db019;
                    }
                    else
                    {
                        var_4f663 = var_88b02;
                    ...
                    else
                    {
                        ...
                        if (var_4f663)
                        {
                            var_fbc90 = uint(var_bd250.GpuEntryBuffer[var_1bd82].user_data);
                        }
                        else
                        {
                            var_fbc90 = var_e4d40;
        ...
        var_e51b8 = var_59d8b;
#endif
        var_1163d = ((var_3e08d * (1.0 - var_fae64)) * max((var_b9249 * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_fc65f * var_fc65f) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_3df32.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w;
        var_48867 = ((mix(var_3e08d, vec3(dot(var_3e08d, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_fb018)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x;
    }
    else
    {
        var_f7210 = vec3(0.0);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        {
            highp float var_9a0e5 = 1.0 - var_b259b;
            var_0f441 = (1.0 - (var_9a0e5 * var_9a0e5)) * (IBLParameters.y - 1.0);
        }
        else
        {
            highp float var_c17b7 = 1.0 - var_b259b;
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_d903a(var_a8c9c, var_fae64, var_713f8, var_26642);
        ...
        highp vec2 var_dea35 = vec2(clamp(dot(var_3ad69, -normalize(var_dd3fd)), 0.0, 1.0), var_b259b);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_769bb(var_a8c9c, var_fae64, var_da70a);
            highp vec2 var_c297e = vec2(clamp(dot(var_3ad69, -normalize(var_21df9)), 0.0, 1.0), var_b259b);
