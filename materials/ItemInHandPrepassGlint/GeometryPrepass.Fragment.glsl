...
void main() {
    ...
    uvec2 var_5f070 = uvec2(uint(clamp(var_2ef20.z, 0.0, 1.0) * 255.0) & 255u, uint(clamp(var_2ef20.y, 0.0, 1.0) * 255.0) & 255u);
    bgfx_FragData0 = uvec4((var_5f070.x << 8u) | var_5f070.y, var_ef8ed.x, var_ef8ed.y, var_d3959);
