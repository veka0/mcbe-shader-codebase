...
void main() {
...
#endif
    var_b8bc1.w = 1.0;
    highp vec4 var_38da5 = var_b8bc1;
    ...
    if (var_ab7ce || (var_38da5.w < 0.5))
    {
        discard;
    }
    highp vec4 var_8544b = v_fog;
    bgfx_FragColor = vec4(mix(vec4(var_b8bc1.xyz, var_38da5.w).xyz, v_fog.xyz, vec3(var_8544b.w)), var_38da5.w);
}
