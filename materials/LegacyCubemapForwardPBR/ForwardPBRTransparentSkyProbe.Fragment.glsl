...
void main() {
    ...
    highp vec3 var_db69b = var_f79a5 * ((clamp(var_ae031.y, SkyProbeUVFadeParameters.y, SkyProbeUVFadeParameters.x) - SkyProbeUVFadeParameters.y) / ((SkyProbeUVFadeParameters.x - SkyProbeUVFadeParameters.y) + 9.9999997473787516355514526367188e-06));
    highp vec3 var_b67ef;
    if (PreExposureEnabled.x > 0.0)
    {
        var_b67ef = var_db69b * 0.180000007152557373046875;
    }
    else
    {
        var_b67ef = var_db69b;
    }
    bgfx_FragColor = vec4(var_b67ef, max(var_2ee7a.w, SkyProbeUVFadeParameters.z));
}
