...
void func_2c4cf(inout highp vec4 arg_3156b, inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_218ea, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_a9fca, inout highp vec2 arg_f36e7, inout highp vec3 arg_81f79, inout highp vec3 arg_58ffc, inout highp float arg_d96ac, inout highp float arg_cdb42) {
    ...
    for (int loc_0c559 = 0; loc_0c559 < loc_29e34; loc_6ee08 = loc_f20d9, loc_7d7d3 = loc_fde0c, loc_0c559++, loc_a7108 = loc_f3340)
    {
        ...
        loc_fde0c = loc_7d7d3 + (((((((vec3(1.0) - loc_d5257) * mix(loc_1e1bf, max((dot(arg_218ea, loc_921fd) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_2d61b * loc_2d61b), 0.0), arg_cdb42)) * (loc_ec1c7 * vec3(0.3183098733425140380859375))) * loc_c6386) + (((loc_ec1c7 * vec3(0.3183098733425140380859375)) * (arg_cdb42 * max((dot(-arg_218ea, loc_921fd) + SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.y) / (loc_c20a0 * loc_c20a0), 0.0))) * loc_a416a)) * loc_49071) * DiffuseSpecularEmissiveAmbientTermToggles.x);
...
void main() {
    ...
    if (var_45a07.z != 1.0)
    {
        ...
        highp vec2 var_61b41 = vec2(var_30c68, var_ba9ef);
        highp vec3 var_815dd;
        highp vec3 var_e6e93;
        func_2c4cf(var_81cf4, var_e6e93, var_815dd, var_75e73, var_3f1f0, var_0d7d8, var_6eea8, var_61b41, var_e6f45, var_cbf43, var_9894f, var_f5dab);
        var_e6b66 = var_e6e93;
        var_d9967 = var_815dd;
    }
    else
