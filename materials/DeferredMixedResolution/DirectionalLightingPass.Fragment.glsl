...
void func_1d616(inout highp vec4 arg_765b5, inout highp vec3 arg_87514, inout highp vec3 arg_c03dc, inout highp vec3 arg_58fab, inout highp vec3 arg_adf73, inout highp vec3 arg_c100b, inout highp vec3 arg_ae81a, inout highp vec4 arg_71964, inout highp vec3 arg_c7286, inout highp vec2 arg_3e2b4, inout highp vec3 arg_08b90, inout highp float arg_2d822, inout highp float arg_67b92) {
...
void main() {
    ...
    if (var_45a07.z != 1.0)
    {
        ...
        func_1d616(var_66577, var_e520d, var_a53cf, var_b9e03, var_8d2f5, var_effba, var_92517, var_d61cf, var_98c8c, var_75bca, var_92928, var_9c3c2, var_121d0);
        var_9b8c2 = var_e520d;
        var_272ff = var_a53cf;
    }
    else
