...
void main() {
    ...
    func_a72a6(var_f92f2, var_23e14, var_3d822, var_5e5e9, var_fbbd0);
    ...
    highp vec3 var_2b8e0 = var_e14aa.xyz;
    highp vec3 var_54582 = (u_view * var_e14aa).xyz;
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        highp vec3 var_53f62 = -(var_714a0 / vec3(length(var_714a0) + 9.9999997473787516355514526367188e-05));
        highp float var_83276 = var_5e5e9 * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        highp vec3 var_6cfc2 = var_714a0;
        highp vec2 var_29002 = vec2(var_30c68, var_ba9ef);
        highp vec3 var_c2621;
        highp vec3 var_7a98e;
        func_f7676(var_7a98e, var_c2621, var_54582, var_1414b, var_2b8e0, var_6cfc2, var_29002, var_53f62, var_23e14, var_dfaa1, var_09560, var_f92f2, var_83276);
        ...
        func_f8e98(var_bf718, var_5423d, var_bb1ac, var_da80f, var_e4833, var_cdcc9, var_a6bd2, var_714a0, var_54582, var_53f62, var_23e14, var_dfaa1, var_09560, var_f92f2, var_83276, var_1414b, var_2b8e0);
