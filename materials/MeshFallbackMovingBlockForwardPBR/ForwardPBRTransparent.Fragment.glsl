...
void main() {
    ...
    highp float var_23e14;
    highp float var_f92f2;
    func_a72a6(var_f92f2, var_23e14, var_3d822, var_5e5e9, var_9c01b);
    ...
    highp vec3 var_2626c = var_930c5.xyz;
    highp vec3 var_239fe = v_worldPos - WorldOrigin.xyz;
    highp vec3 var_eebcb = dFdx(var_2626c);
    highp vec3 var_211c8 = dFdy(var_2626c);
    ...
    highp vec3 var_2fffa = (var_239fe - (var_7d782 - (var_5acf5 * dot(var_7d782, var_5acf5)))) + WorldOrigin.xyz;
    highp vec3 var_2b8e0 = var_618bf.xyz;
    highp vec3 var_54582 = (u_view * var_618bf).xyz;
    ...
    highp float var_106e2 = length(var_2626c);
    ...
    if (var_5bd0a.z != 1.0)
    {
        highp vec3 var_53f62 = -(var_2626c / vec3(length(var_2626c) + 9.9999997473787516355514526367188e-05));
        highp float var_83276 = var_5e5e9 * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        highp vec3 var_6cfc2 = var_2626c;
        ...
        func_41b91(var_7a98e, var_c2621, var_54582, var_b5d88, var_2b8e0, var_6cfc2, var_b1591, var_53f62, var_23e14, var_dfaa1, var_09560, var_f92f2, var_83276);
        highp vec3 var_850d6 = var_2626c;
        ...
        highp vec3 var_cdcc9 = var_2626c;
        highp vec4 var_e4833;
        highp vec3 var_da80f;
        highp vec3 var_bb1ac;
        func_7df5c(var_bf718, var_5423d, var_bb1ac, var_da80f, var_e4833, var_cdcc9, var_a6bd2, var_2626c, var_54582, var_53f62, var_23e14, var_dfaa1, var_09560, var_f92f2, var_83276, var_2c7f3, var_2b8e0);
    ...
    {
        highp float var_79b3e = clamp((((length(var_2626c) / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) * FogAndDistanceControl.y, 0.0, 1.0);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        {
            var_dd3fd = (u_view * vec4(var_2fffa, 1.0)).xyz;
            var_a8715 = var_2fffa;
        }
        else
        {
        ...
        {
            highp float var_9a0e5 = 1.0 - var_23e14;
            var_0f441 = (1.0 - (var_9a0e5 * var_9a0e5)) * (IBLParameters.y - 1.0);
        }
        else
        {
            highp float var_c17b7 = 1.0 - var_23e14;
        ...
        highp vec2 var_dea35 = vec2(clamp(dot(var_54582, -normalize(var_dd3fd)), 0.0, 1.0), var_23e14);
