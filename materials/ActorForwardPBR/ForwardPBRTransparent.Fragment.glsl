...
void main() {
    ...
    highp vec3 var_af760 = mix((var_393c6.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w));
    highp vec4 var_f039a = vec4(var_af760.x, var_af760.y, var_af760.z, var_393c6.w);
