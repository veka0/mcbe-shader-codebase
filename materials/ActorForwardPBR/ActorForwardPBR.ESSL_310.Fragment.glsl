...
struct VertexInput {
    ...
    int boneId;
    #endif
    #if defined(INSTANCING__ON)&&(defined(FORWARD_PBR_ALPHA_TEST_PASS)|| defined(FORWARD_PBR_TRANSPARENT_PASS))
    vec4 tangent;
    #endif
    ...
    vec4 instanceData2;
    #endif
    #if defined(INSTANCING__OFF)&&(defined(FORWARD_PBR_ALPHA_TEST_PASS)|| defined(FORWARD_PBR_TRANSPARENT_PASS))
    vec4 tangent;
    #endif
};
