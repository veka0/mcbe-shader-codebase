...
void main() {
    ...
    var_32d02 = var_6ee95;
    highp vec3 var_af760 = mix((var_32d02.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w));
    highp vec4 var_f039a = vec4(var_af760.x, var_af760.y, var_af760.z, var_32d02.w);
