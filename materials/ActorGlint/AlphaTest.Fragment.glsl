...
void main() {
    ...
    highp vec4 var_e5ebd = vec4(var_1099e.x, var_1099e.y, var_1099e.z, var_f7872.w);
#endif
#ifndef CHANGE_COLOR__MULTI
    highp vec4 var_e5ebd = var_f7872;
#endif
#ifdef CHANGE_COLOR__ON
    highp vec4 var_8a135 = ChangeColor;
    highp vec3 var_fba6e = mix(var_f7872.xyz, var_f7872.xyz * ChangeColor.xyz, vec3(var_e5ebd.w));
    var_e5ebd = vec4(var_fba6e.x, var_fba6e.y, var_fba6e.z, var_f7872.w);
    ...
    highp vec4 var_85c79 = vec4(var_61669.xyz * var_61669.xyz, abs(var_61669.w)) + vec4(mix((var_e5ebd.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w)).xyz * v_light.xyz, 0.0);
    var_85c79.w = var_e5ebd.w;
