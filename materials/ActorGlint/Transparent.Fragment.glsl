...
void main() {
    ...
    highp vec4 var_a3804 = MatColor * texture(s_MatTexture, v_texcoord0);
#endif
    ...
    highp vec4 var_a3804 = var_98b25;
#endif
    ...
    highp vec4 var_a3804 = mix(var_7fef3, MatColor * texture(s_MatTexture, v_texcoord0), vec4(float((((var_0b7d3.x + var_0b7d3.y) + var_0b7d3.z) * (1.0 - var_0b7d3.w)) > 0.0)));
#endif
#ifdef CHANGE_COLOR__MULTI
    ...
    highp vec4 var_a3804 = vec4(var_1099e.x, var_1099e.y, var_1099e.z, var_98b25.w);
#endif
    ...
    highp vec3 var_fba6e = mix(var_98b25.xyz, var_98b25.xyz * ChangeColor.xyz, vec3(var_a3804.w));
    var_a3804 = vec4(var_fba6e.x, var_fba6e.y, var_fba6e.z, var_98b25.w);
    var_a3804.w *= var_8a135.w;
#endif
    ...
    highp vec4 var_e07b8 = vec4(var_61669.xyz * var_61669.xyz, abs(var_61669.w)) + vec4(mix((var_a3804.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w)).xyz * v_light.xyz, 0.0);
    var_e07b8.w = var_a3804.w;
    highp vec4 var_f83be = var_e07b8;
    highp vec4 var_ae171 = vec4(var_e07b8.xyz, var_f83be.w * HudOpacity.x);
    highp vec4 var_6ca24 = v_fog;
    highp vec3 var_14685 = mix(var_ae171.xyz, v_fog.xyz, vec3(var_6ca24.w));
    bgfx_FragColor = vec4(var_14685.x, var_14685.y, var_14685.z, var_ae171.w);
}
