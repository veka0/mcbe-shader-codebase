...
#ifdef POINT_LIGHT_SHADING__ON
layout(binding = 14, std430) buffer s_zLights { Light zLights[]; } var_5af29;
...
void func_6eb35(inout int arg_7070b, inout highp float arg_9499a, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c) {
    ...
    highp vec3 loc_8868e = arg_aee55 - var_5af29.zLights[arg_7070b].position.xyz;
    ...
    highp vec4 loc_ad8ff = var_5af29.zLights[arg_7070b].shadowFaceUV0;
    highp vec3 loc_a2a55;
    if (loc_f3fad == 1)
    {
        loc_ad8ff = var_5af29.zLights[arg_7070b].shadowFaceUV1;
    ...
    else
    {
        ...
        if (loc_f3fad == 2)
        {
            loc_ad8ff = var_5af29.zLights[arg_7070b].shadowFaceUV2;
        ...
        else
        {
            ...
            if (loc_f3fad == 3)
            {
                loc_ad8ff = var_5af29.zLights[arg_7070b].shadowFaceUV3;
            ...
            else
            {
                ...
                if (loc_f3fad == 4)
                {
                    loc_ad8ff = var_5af29.zLights[arg_7070b].shadowFaceUV4;
                ...
                else
                {
                    ...
                    if (loc_f3fad == 5)
                    {
                        loc_ad8ff = var_5af29.zLights[arg_7070b].shadowFaceUV5;
...
void func_65427(inout highp vec4 arg_e84ec, inout int arg_6ba42, inout highp float arg_43b7a, inout highp vec3 arg_0a2b9, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_a4b3e = var_5af29.zLights[arg_6ba42].position.xyz - v_worldPos;
    ...
    if (loc_9eb1a >= (var_5af29.zLights[arg_6ba42].position.w * var_5af29.zLights[arg_6ba42].position.w))
    {
        arg_43b7a = 1.0;
        arg_0a2b9 = vec3(0.0);
        return;
    ...
    highp float loc_4c5a5 = loc_9eb1a / ((var_5af29.zLights[arg_6ba42].position.w * var_5af29.zLights[arg_6ba42].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_5af29.zLights[arg_6ba42].color.xyz * loc_219c5;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_9eb1a / ((var_5af29.zLights[arg_6ba42].position.w * var_5af29.zLights[arg_6ba42].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_cddfe;
    arg_0a2b9 = (var_5af29.zLights[arg_6ba42].color.xyz * var_5af29.zLights[arg_6ba42].color.w) * loc_219c5;
}
void func_290c9(inout highp vec3 arg_33c3b, inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec4 arg_fadf1, inout highp vec3 arg_c2c08, inout highp vec3 arg_81f79, inout highp vec3 arg_4f9dc, inout highp vec3 arg_8bccf, inout highp vec3 arg_78faf) {
    ...
    for (int loc_86630 = loc_490eb; loc_86630 < loc_c476d; loc_15415 = loc_33796, loc_7640f = loc_1b28d, loc_a55d6 = loc_96e3a, loc_86630++)
    {
        ...
        highp vec3 loc_82c7f = normalize((u_view * vec4(var_5af29.zLights[loc_d6ee8].position.xyz, 1.0)).xyz - arg_33c3b);
