...
void main() {
    ...
    func_9b87e(var_da5e6, var_9e11a);
    ...
    if (PreExposureEnabled.x > 0.0)
    {
        var_d523d = var_beb07 * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_d523d = var_beb07;
