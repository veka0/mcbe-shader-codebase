...
layout(binding = 13, std430) buffer s_zLights { Light zLights[]; } var_c827d;
layout(binding = 12, std430) buffer s_zLightLookupArray { LightData zLightLookupArray[]; } var_40094;
...
void func_8fc55(inout int arg_0ec26, inout highp float arg_9eee0, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c) {
    if (var_c827d.zLights[arg_0ec26].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        return;
    }
    highp vec3 loc_44ea9 = arg_aee55 - var_c827d.zLights[arg_0ec26].position.xyz;
    ...
    if (((textureLod(s_PointLightShadowTextureArray, vec4(loc_13db4, float(var_c827d.zLights[arg_0ec26].shadowProbeIndex)), 0.0).x * 2.0) - 1.0) >= loc_02fd5.z)
    {
        loc_591c8 = 1.0;
    }
    else
...
void func_65427(inout highp vec4 arg_e84ec, inout int arg_6ba42, inout highp float arg_43b7a, inout highp vec3 arg_0a2b9, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_a4b3e = var_c827d.zLights[arg_6ba42].position.xyz - v_worldPos;
    ...
    if (loc_9eb1a >= (var_c827d.zLights[arg_6ba42].position.w * var_c827d.zLights[arg_6ba42].position.w))
    {
        arg_43b7a = 1.0;
        arg_0a2b9 = vec3(0.0);
        return;
    ...
    highp float loc_4c5a5 = loc_9eb1a / ((var_c827d.zLights[arg_6ba42].position.w * var_c827d.zLights[arg_6ba42].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_c827d.zLights[arg_6ba42].color.xyz * loc_219c5;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_9eb1a / ((var_c827d.zLights[arg_6ba42].position.w * var_c827d.zLights[arg_6ba42].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_cddfe;
    arg_0a2b9 = (var_c827d.zLights[arg_6ba42].color.xyz * var_c827d.zLights[arg_6ba42].color.w) * loc_219c5;
}
void func_3b9a0(inout highp vec3 arg_33c3b, inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec4 arg_fadf1, inout highp vec3 arg_c2c08, inout highp vec3 arg_81f79, inout highp vec3 arg_4f9dc, inout highp vec3 arg_8bccf, inout highp vec3 arg_78faf) {
    ...
    {
        int loc_d6ee8 = int(var_40094.zLightLookupArray[loc_86630].lookup);
        if (loc_d6ee8 < 0)
        {
            break;
        }
        highp vec3 loc_82c7f = normalize((u_view * vec4(var_c827d.zLights[loc_d6ee8].position.xyz, 1.0)).xyz - arg_33c3b);
