...
float var_33fae;
#ifdef POINT_LIGHT_SHADING__ON
layout(binding = 12, std430) buffer s_zLights { Light zLights[]; } var_24e5c;
...
void func_6eb35(inout int arg_7070b, inout highp float arg_9499a, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c) {
    if (arg_7070b < 0)
    {
        arg_9499a = 0.0;
        return;
    }
    highp vec3 loc_8868e = arg_aee55 - var_24e5c.zLights[arg_7070b].position.xyz;
    ...
    highp vec4 loc_ad8ff = var_24e5c.zLights[arg_7070b].shadowFaceUV0;
    highp vec3 loc_a2a55;
    if (loc_f3fad == 1)
    {
        loc_ad8ff = var_24e5c.zLights[arg_7070b].shadowFaceUV1;
    ...
    else
    {
        ...
        if (loc_f3fad == 2)
        {
            loc_ad8ff = var_24e5c.zLights[arg_7070b].shadowFaceUV2;
        ...
        else
        {
            ...
            if (loc_f3fad == 3)
            {
                loc_ad8ff = var_24e5c.zLights[arg_7070b].shadowFaceUV3;
            ...
            else
            {
                ...
                if (loc_f3fad == 4)
                {
                    loc_ad8ff = var_24e5c.zLights[arg_7070b].shadowFaceUV4;
                ...
                else
                {
                    ...
                    if (loc_f3fad == 5)
                    {
                        loc_ad8ff = var_24e5c.zLights[arg_7070b].shadowFaceUV5;
    ...
    bool loc_da9b7 = loc_ad8ff.z == 0.0;
    bool loc_20dc6;
    if (loc_da9b7)
    {
        loc_20dc6 = loc_ad8ff.w == 0.0;
    }
    else
    {
        loc_20dc6 = loc_da9b7;
    ...
    highp vec4 loc_94374 = PointLightProj * vec4(loc_a2a55, 1.0);
    highp float loc_2f407 = clamp(dot(normalize(-loc_8868e), normalize(arg_1111c)), PointLightNdLFloor.x, 1.0);
    loc_94374.z -= (PointLightShadowParams1.x + (PointLightShadowParams1.y * (sqrt(1.0 - (loc_2f407 * loc_2f407)) / loc_2f407)));
    highp float loc_d799e = loc_94374.w;
    highp vec4 loc_9858b = loc_94374;
    highp vec4 loc_ee1fb = loc_9858b / vec4(loc_d799e);
    loc_94374 = loc_ee1fb;
    highp vec2 loc_f42a7 = vec2(0.5) / PointLightShadowAtlasResolution.xy;
    highp float loc_591c8;
    if (((textureLod(s_PointLightShadowTextureAtlas, clamp(loc_ad8ff.xy + (((loc_ee1fb.xy * 0.5) + vec2(0.5)) * (loc_ad8ff.zw - loc_ad8ff.xy)), loc_ad8ff.xy + loc_f42a7, loc_ad8ff.zw - loc_f42a7), 0.0).x * 2.0) - 1.0) >= loc_94374.z)
    {
        loc_591c8 = 1.0;
    }
    else
...
void func_65427(inout highp vec4 arg_e84ec, inout int arg_6ba42, inout highp float arg_43b7a, inout highp vec3 arg_0a2b9, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_a4b3e = var_24e5c.zLights[arg_6ba42].position.xyz - v_worldPos;
    ...
    if (loc_9eb1a >= (var_24e5c.zLights[arg_6ba42].position.w * var_24e5c.zLights[arg_6ba42].position.w))
    {
        arg_43b7a = 1.0;
        arg_0a2b9 = vec3(0.0);
        return;
    ...
    if (DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.w != 0.0)
    {
        ...
        func_6eb35(arg_6ba42, loc_1b78e, arg_ab1f6, arg_81f82);
        loc_cddfe = loc_1b78e;
    }
    else
    {
    ...
    highp float loc_4c5a5 = loc_9eb1a / ((var_24e5c.zLights[arg_6ba42].position.w * var_24e5c.zLights[arg_6ba42].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_24e5c.zLights[arg_6ba42].color.xyz * loc_219c5;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_9eb1a / ((var_24e5c.zLights[arg_6ba42].position.w * var_24e5c.zLights[arg_6ba42].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_cddfe;
    arg_0a2b9 = (var_24e5c.zLights[arg_6ba42].color.xyz * var_24e5c.zLights[arg_6ba42].color.w) * loc_219c5;
}
void func_290c9(inout highp vec3 arg_33c3b, inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec4 arg_fadf1, inout highp vec3 arg_c2c08, inout highp vec3 arg_81f79, inout highp vec3 arg_4f9dc, inout highp vec3 arg_8bccf, inout highp vec3 arg_78faf) {
    ...
    for (int loc_86630 = loc_490eb; loc_86630 < loc_c476d; loc_15415 = loc_33796, loc_7640f = loc_1b28d, loc_a55d6 = loc_96e3a, loc_86630++)
    {
        ...
        highp vec3 loc_82c7f = normalize((u_view * vec4(var_24e5c.zLights[loc_d6ee8].position.xyz, 1.0)).xyz - arg_33c3b);
        ...
        func_65427(loc_bc541, loc_d6ee8, loc_1191b, loc_01c61, arg_4f9dc, arg_8bccf);
        loc_55c3a = loc_bc541;
...
void main() {
    ...
    if ((((var_f88c4.x + var_f88c4.y) + var_f88c4.z) < 9.9999997473787516355514526367188e-05) && (TileLightIntensity.x > 9.9999997473787516355514526367188e-05))
    {
        ...
        var_f4a3a = clamp(vec3(var_88ce0 + (var_0bc6f.x * var_0bc6f.w), (var_88ce0 * ((((var_88ce0 * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_0bc6f.y * var_0bc6f.w), (var_88ce0 * (((var_88ce0 * var_88ce0) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_0bc6f.z * var_0bc6f.w)), vec3(0.0), vec3(1.0));
    }
    else
    {
        var_f4a3a = BlockLightColor.xyz;
    }
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_481dd(var_8a0bc, var_e2694, var_a43ed, var_0ae9b, var_7e3af, var_163cf, var_0d88f, var_242e3, var_da5e6);
#ifdef POINT_LIGHT_SHADING__ON
        highp vec4 var_b0736;
        highp vec3 var_0702c;
        highp vec3 var_965c6;
        func_cdb47(var_965c6, var_8a0bc, var_0702c, var_e2694, var_b0736, var_279e5, var_25e46, var_a43ed, var_242e3, var_7e3af, var_da5e6);
        var_0e739 = var_965c6;
#endif
...
#ifdef POINT_LIGHT_SHADING__OFF
    highp vec3 var_beb07 = vec4(var_2b7c8.xyz + (mix(((((var_da5e6 * 1.0) * max((var_f4a3a * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_54e32 * var_54e32) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_4e62c.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_0e739) + var_1f34a, var_c74b6.xyz, vec3(var_664e8.w)) * var_8cad1.w), 1.0).xyz + var_db299;
#endif
#ifdef POINT_LIGHT_SHADING__ON
    highp vec3 var_beb07 = vec4(var_2b7c8.xyz + (mix(((((var_da5e6 * 1.0) * max(((var_f4a3a + (var_b07c8.xyz * var_eff67.w)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_54e32 * var_54e32) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_4e62c.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_0e739) + var_1f34a, var_c74b6.xyz, vec3(var_664e8.w)) * var_8cad1.w), 1.0).xyz + var_db299;
#endif
