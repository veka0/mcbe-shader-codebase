...
layout(binding = 14, std430) buffer s_zLights { Light zLights[]; } var_eb8b0;
...
void func_5b6a6(inout int arg_826b5, inout highp float arg_9eee0, inout highp float arg_6b488, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c) {
    if (var_eb8b0.zLights[arg_826b5].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        arg_6b488 = 1.0;
        return;
    }
    highp vec3 loc_44ea9 = arg_aee55 - var_eb8b0.zLights[arg_826b5].position.xyz;
    ...
    highp float loc_e670f = (textureLod(s_PointLightShadowTextureArray, vec4(loc_f715f, float(var_eb8b0.zLights[arg_826b5].shadowProbeIndex)), 0.0).x * 2.0) - 1.0;
...
void func_735c6(inout highp vec4 arg_e84ec, inout int arg_34699, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_ec226, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    highp vec3 loc_a4b3e = var_eb8b0.zLights[arg_34699].position.xyz - v_worldPos;
    ...
    if (loc_3a449 >= (var_eb8b0.zLights[arg_34699].position.w * var_eb8b0.zLights[arg_34699].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_ec226 = vec3(0.0);
    ...
    highp float loc_4c5a5 = loc_3a449 / ((var_eb8b0.zLights[arg_34699].position.w * var_eb8b0.zLights[arg_34699].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_eb8b0.zLights[arg_34699].color.xyz * loc_4217d;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_3a449 / ((var_eb8b0.zLights[arg_34699].position.w * var_eb8b0.zLights[arg_34699].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_a011d;
    arg_7f337 = loc_cddfe;
    arg_ec226 = ((var_eb8b0.zLights[arg_34699].color.xyz * var_eb8b0.zLights[arg_34699].color.w) * loc_4217d) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_2c1ed(inout bool arg_9a2b4, inout bool arg_b6724, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_33e52, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_fea00, inout highp vec3 arg_01a6b, inout highp vec3 arg_061f9, inout highp vec3 arg_c8c10, inout highp vec3 arg_8f7d6, inout highp vec3 arg_115ae) {
    ...
    for (int loc_86630 = loc_2aee5; loc_86630 < loc_9d2b5; loc_983e3 = loc_7c75a, loc_33c65 = loc_ed2f2, loc_23246 = loc_62c27, loc_86630++)
    {
        ...
        highp vec3 loc_dfb9f = normalize((u_view * vec4(var_eb8b0.zLights[loc_959ae].position.xyz, 1.0)).xyz - arg_fea00);
...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_fca58(var_c65bf, var_9aeed, var_f993c, var_0ae9b, var_f9f35, var_163cf, var_76520, var_17a13, var_7fab2);
        ...
        func_2c1ed(var_da382, var_d1b0b, var_e1a8f, var_ef9ba, var_36252, var_6cfc2, var_729bd, var_e7e52, var_f993c, var_17a13, var_7fab2, var_fe3d5, var_f9f35);
