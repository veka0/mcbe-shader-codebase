...
void main() {
    highp vec4 var_6301a = texture(s_RasterColor, vec3(v_texcoord0, TextureArrayIndex.x));
    highp vec4 var_f3c01 = var_6301a;
    bool var_a4901;
    ...
    switch (uint(DebugMode.x))
    {
        case 1u:
        {
            var_6e3c6 = var_6301a.www;
            var_a4901 = false;
            break;
        }
        case 2u:
        {
            highp vec2 var_7bee0 = (var_6301a.xy * 2.0) - vec2(1.0);
        ...
        case 3u:
        {
            highp vec2 var_3b7a3 = var_6301a.xy;
            highp vec3 var_4ad52 = vec3(var_6301a.xy, (1.0 - abs(var_3b7a3.x)) - abs(var_3b7a3.y));
        ...
        case 4u:
        {
            var_6e3c6 = vec3(((clamp(var_6301a.xy, vec2(-1.0), vec2(1.0)) * 10.0) * 0.5) + vec2(0.5), 0.0);
            var_a4901 = false;
            break;
        }
        case 5u:
        {
            var_6e3c6 = vec3(((clamp(var_6301a.zw, vec2(-1.0), vec2(1.0)) * 10.0) * 0.5) + vec2(0.5), 0.0);
            var_a4901 = false;
            break;
        }
        case 6u:
        {
            var_6e3c6 = vec3(var_6301a.xy, 0.0);
            var_a4901 = false;
            break;
        }
        case 7u:
        {
            var_6e3c6 = (var_6301a.xyz * 0.0500000007450580596923828125) + vec3(0.5);
            var_a4901 = false;
            break;
        }
        case 8u:
        {
            var_6e3c6 = var_6301a.xyz;
            var_a4901 = false;
            break;
        }
        case 9u:
        {
            var_6e3c6 = var_6301a.xxx;
            var_a4901 = false;
            break;
        }
        case 10u:
        {
            var_6e3c6 = var_6301a.yyy;
            var_a4901 = false;
            break;
        }
        case 11u:
        {
            var_6e3c6 = var_6301a.zzz;
            var_a4901 = false;
            break;
        }
        case 12u:
        ...
        case 13u:
        {
            highp float var_eda2e = clamp((log2(dot(var_6301a.xyz, vec3(0.2125000059604644775390625, 0.7153999805450439453125, 0.07209999859333038330078125)) * 8.0) + 4.0) * 0.5, 0.0, 8.0);
        ...
        case 18u:
        {
            highp vec2 var_a11ee = var_6301a.yz;
