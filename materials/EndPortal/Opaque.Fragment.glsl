...
void main() {
    ...
    highp vec4 var_ac95b;
    if ((v_encodedPlane * 32.0) > 31.0)
    {
        var_ac95b = vec4(v_fog.xyz * var_1d0b7.w, 1.0);
    }
    else
    {
        var_ac95b = vec4((var_73e16.xyz * (var_bebe3.xyz * (1.0 - v_encodedPlane))).xyz * (1.0 - var_1d0b7.w), 0.0);
    }
    bgfx_FragData0 = var_ac95b;
}
