...
out vec3 v_worldPos;
void main() {
    vec4 var_db7bf = u_model[0] * vec4(a_position, 1.0);
    vec4 var_df665 = u_viewProj * var_db7bf;
    vec4 var_5b30b = var_df665;
