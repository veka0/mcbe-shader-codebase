...
void main() {
    ...
    highp vec3 var_d17fe;
    switch (uint(DebugMode.x))
    {
        case 14u:
        {
            var_d17fe = vec3(0.0, float(var_dd031.w) * 0.0039215688593685626983642578125, 0.0);
            break;
        }
        case 18u:
        {
            ...
            var_d17fe = ((var_79506.xyz * var_ea8ab.w) * 6.0) * vec3(0.16666667163372039794921875);
            break;
        }
        case 19u:
        {
            ...
            var_d17fe = (vec2(float(var_16036.x), var_9718b) * vec2(0.0039215688593685626983642578125)).xxx;
            break;
        }
        case 20u:
        {
            ...
            var_d17fe = (vec2(var_9718b, float(var_75ad2.y)) * vec2(0.0039215688593685626983642578125)).yyy;
            break;
        }
        default:
        {
    ...
    bgfx_FragColor = vec4(var_d17fe, 1.0);
}
