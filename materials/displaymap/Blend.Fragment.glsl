...
void main() {
    ...
    highp vec4 var_89ae1 = var_1b510;
    ...
    highp vec3 var_829a7 = pow((vec3(0.8359375) + (pow(abs(var_4524e), vec3(0.1593017578125)) * 18.8515625)) / (vec3(1.0) + (pow(abs(var_4524e), vec3(0.1593017578125)) * 18.6875)), vec3(78.84375));
    bgfx_FragColor = vec4(var_829a7.x, var_829a7.y, var_829a7.z, var_89ae1.w);
}
