...
void func_ae324(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_1418f, inout highp vec3 arg_89c41, inout highp vec3 arg_e4e64, inout highp vec3 arg_061f9, inout highp vec4 arg_33915, inout highp vec3 arg_04538, inout highp vec3 arg_dd9d3, inout highp float arg_f859b, inout highp float arg_c50ac, inout highp vec3 arg_f6a53, inout highp vec3 arg_4f9dc, inout highp vec3 arg_8bccf) {
...
void main() {
    ...
    highp float var_83102 = clamp(2.007874011993408203125 * (var_4ac0e.w - 0.501960813999176025390625), 0.0, 1.0);
    highp vec4 var_b0fd8 = texture(s_EmissiveAmbientLinearRoughness, v_texcoord0);
    ...
    highp vec3 var_2f122 = pow(max(var_124e5.xyz, vec3(0.0)), vec3(2.2000000476837158203125));
    highp vec3 var_9808d = vec3(0.039999999105930328369140625 * (1.0 - var_83102)) + (var_2f122 * var_83102);
    ...
    highp vec3 var_0f0a1;
    highp vec3 var_7a1dd;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_779e0 = vec2(var_49182, var_280ef);
        highp vec3 var_b2e8e;
        highp vec3 var_7395f;
        func_b56ea(var_b0fd8, var_7395f, var_b2e8e, var_8b9ec, var_c7af6, var_d2cee, var_a1ebf, var_6d386, var_6cdf3, var_779e0, var_47f66, var_9808d, var_2f122, var_83102, var_31ae1);
        highp vec3 var_23d9a = var_5c7b3;
        highp vec4 var_8fd40;
        highp vec3 var_fa062;
        highp vec3 var_38603;
        bool var_902e5;
        func_ae324(var_512b6, var_c0bfd, var_902e5, var_38603, var_fa062, var_8fd40, var_23d9a, var_5c7b3, var_8b9ec, var_47f66, var_b0fd8, var_9808d, var_2f122, var_83102, var_31ae1, var_6cdf3, var_c7af6, var_d2cee);
        var_7a1dd = var_7395f + (var_38603 * (1.0 - var_f3062));
        var_0f0a1 = var_b2e8e + (var_fa062 * (1.0 - var_5d160));
        var_9a0a9 = var_8fd40;
        var_5a6e4 = var_902e5;
    }
    else
    ...
    highp float var_96811;
    if (var_5a6e4)
    {
        var_96811 = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_96811 = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_19c73 = var_9a0a9;
    highp float var_fd6cb = var_b0fd8.y * var_b0fd8.y;
    highp vec4 var_d3f33 = SkyAmbientLightColorIntensity;
    highp float var_353bc = var_b0fd8.z * var_b0fd8.z;
    highp vec3 var_38eee = (((((var_2f122 * (1.0 - var_83102)) * max(((clamp(vec3(var_fd6cb + (var_19c73.x * var_19c73.w), (var_fd6cb * ((((var_fd6cb * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_19c73.y * var_19c73.w), (var_fd6cb * (((var_fd6cb * var_fd6cb) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_19c73.z * var_19c73.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_96811) + ((SkyAmbientLightColorIntensity.xyz * mix((var_353bc * var_353bc) * var_b0fd8.z, (var_b0fd8.z * var_b0fd8.z) * var_b0fd8.z, CameraLightIntensity.y)) * var_d3f33.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_7a1dd) + var_0f0a1) + (((mix(var_2f122, vec3(dot(var_2f122, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_b0fd8.x)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x);
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_38eee, var_9d9e1, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_38eee;
    ...
    {
        var_7e3dc = mix(var_38eee, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
