...
void main() {
    ...
    var_2c432 = var_1d57a;
    highp vec3 var_f710c = mix((var_1d57a.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w));
    highp vec4 var_89833 = vec4(var_f710c.x, var_f710c.y, var_f710c.z, var_1d57a.w);
