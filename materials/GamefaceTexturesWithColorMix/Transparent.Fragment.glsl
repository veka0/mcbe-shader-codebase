    ...
    switch (int(var_3e166.x))
    {
        ...
        case 12:
        {
            ...
            if (var_55c4b.x <= var_55c4b.y)
            {
                ...
                {
                    highp vec3 var_7cf72 = var_55c4b;
                    ...
                    var_55c4b = vec3(0.0, var_7cf72.y, var_7cf72.z);
                }
                else
                {
                    if (var_55c4b.x <= var_55c4b.z)
                    {
                        highp vec3 var_6afc0 = var_55c4b.xzy;
                    ...
                    {
                        highp vec3 var_45b2c = var_55c4b.zxy;
            ...
            else
            {
                if (var_55c4b.x <= var_55c4b.z)
                {
                    highp vec3 var_6209d = var_55c4b.yxz;
                ...
                else
                {
                    if (var_55c4b.y <= var_55c4b.z)
                    {
                        highp vec3 var_f347b = var_55c4b.yzx;
                    ...
                    {
                        highp vec3 var_bf949 = var_55c4b.zyx;
            ...
            highp vec3 var_066ba = var_9e21f;
            highp vec3 var_3f137 = var_9e21f;
            highp float var_d7cfd = ((0.2125999927520751953125 * var_3f137.x) + (0.715200006961822509765625 * var_3f137.y)) + (0.072200000286102294921875 * var_3f137.z);
        ...
        case 13:
        {
            ...
            if (var_51615.x <= var_51615.y)
            {
                ...
                {
                    highp vec3 var_19909 = var_51615;
                    ...
                    var_51615 = vec3(0.0, var_19909.y, var_19909.z);
                }
                else
                {
                    if (var_51615.x <= var_51615.z)
                    {
                        highp vec3 var_b645d = var_51615.xzy;
                    ...
                    {
                        highp vec3 var_57f84 = var_51615.zxy;
            ...
            else
            {
                if (var_51615.x <= var_51615.z)
                {
                    highp vec3 var_5eacc = var_51615.yxz;
                ...
                else
                {
                    if (var_51615.y <= var_51615.z)
                    {
                        highp vec3 var_33a78 = var_51615.yzx;
                    ...
                    {
                        highp vec3 var_89d81 = var_51615.zyx;
            ...
            highp vec3 var_f1dca = var_13e54;
            highp vec3 var_6a75b = var_13e54;
            highp float var_edfe8 = ((0.2125999927520751953125 * var_6a75b.x) + (0.715200006961822509765625 * var_6a75b.y)) + (0.072200000286102294921875 * var_6a75b.z);
        ...
        case 14:
        {
            ...
            highp vec3 var_742ab = var_79139;
            highp vec3 var_da0a3 = var_79139;
            highp float var_bf5b9 = ((0.2125999927520751953125 * var_da0a3.x) + (0.715200006961822509765625 * var_da0a3.y)) + (0.072200000286102294921875 * var_da0a3.z);
        ...
        case 15:
        {
            ...
            highp vec3 var_259ab = var_9f80d;
            highp vec3 var_ac9fb = var_9f80d;
            highp float var_762b6 = ((0.2125999927520751953125 * var_ac9fb.x) + (0.715200006961822509765625 * var_ac9fb.y)) + (0.072200000286102294921875 * var_ac9fb.z);
