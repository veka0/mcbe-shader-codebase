...
void main() {
    ...
    vec3 var_d06aa = a_position + PrevPositionBaseOffset.xyz;
    vec3 var_e66b5 = vec3(30.0);
    v_color0 = a_color0;
    ...
    v_prevWorldPos = (vec3(var_d06aa.x - (var_e66b5.x * float(int(var_d06aa.x / var_e66b5.x))), var_d06aa.y - (var_e66b5.y * float(int(var_d06aa.y / var_e66b5.y))), var_d06aa.z - (var_e66b5.z * float(int(var_d06aa.z / var_e66b5.z)))) - vec3(15.0)) + PrevPositionForwardOffset.xyz;
#ifdef NO_VARIETY__OFF
