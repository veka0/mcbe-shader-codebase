...
void main() {
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_6873b, var_9d9e1, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_6873b;
