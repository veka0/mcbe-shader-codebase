...
void main() {
    highp vec4 var_d1022 = texture(s_RasterColor, v_texcoord0);
    highp vec4 var_84c0b = var_d1022;
    bool var_4379b;
    ...
    switch (uint(DebugMode.x))
    {
        case 1u:
        {
            var_8e7a3 = var_d1022.www;
            var_4379b = false;
            break;
        }
        case 2u:
        {
            highp vec2 var_7bee0 = (var_d1022.xy * 2.0) - vec2(1.0);
        ...
        case 3u:
        {
            highp vec2 var_3b7a3 = var_d1022.xy;
            highp vec3 var_4ad52 = vec3(var_d1022.xy, (1.0 - abs(var_3b7a3.x)) - abs(var_3b7a3.y));
        ...
        case 4u:
        {
            var_8e7a3 = vec3(((clamp(var_d1022.xy, vec2(-1.0), vec2(1.0)) * 10.0) * 0.5) + vec2(0.5), 0.0);
            var_4379b = false;
            break;
        }
        case 5u:
        {
            var_8e7a3 = vec3(((clamp(var_d1022.zw, vec2(-1.0), vec2(1.0)) * 10.0) * 0.5) + vec2(0.5), 0.0);
            var_4379b = false;
            break;
        }
        case 6u:
        {
            var_8e7a3 = vec3(var_d1022.xy, 0.0);
            var_4379b = false;
            break;
        }
        case 7u:
        {
            var_8e7a3 = (var_d1022.xyz * 0.0500000007450580596923828125) + vec3(0.5);
            var_4379b = false;
            break;
        }
        case 8u:
        {
            var_8e7a3 = var_d1022.xyz;
            var_4379b = false;
            break;
        }
        case 9u:
        {
            var_8e7a3 = var_d1022.xxx;
            var_4379b = false;
            break;
        }
        case 10u:
        {
            var_8e7a3 = var_d1022.yyy;
            var_4379b = false;
            break;
        }
        case 11u:
        {
            var_8e7a3 = var_d1022.zzz;
            var_4379b = false;
            break;
        }
        case 12u:
        ...
        case 13u:
        {
            highp float var_eda2e = clamp((log2(dot(var_d1022.xyz, vec3(0.2125000059604644775390625, 0.7153999805450439453125, 0.07209999859333038330078125)) * 8.0) + 4.0) * 0.5, 0.0, 8.0);
        ...
        case 14u:
        {
            var_8e7a3 = vec3(var_d1022.yz, 0.0);
            var_4379b = false;
            break;
        }
        case 15u:
