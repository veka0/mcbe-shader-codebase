...
void main() {
    ...
    highp vec3 var_e2584 = mix((var_295e5.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w)).xyz * v_light.xyz;
    highp vec4 var_67533 = vec4(var_e2584.x, var_e2584.y, var_e2584.z, var_295e5.w);
    highp vec4 var_1413e = vec4(var_e2584, var_67533.w * HudOpacity.x);
    highp vec4 var_6ca24 = v_fog;
    highp vec3 var_14685 = mix(var_1413e.xyz, v_fog.xyz, vec3(var_6ca24.w));
    bgfx_FragColor = vec4(var_14685.x, var_14685.y, var_14685.z, var_1413e.w);
}
