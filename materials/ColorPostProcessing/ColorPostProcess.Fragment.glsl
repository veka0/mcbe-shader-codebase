...
void main() {
    ...
    highp vec3 var_e3e21;
    if (TonemapParams0.z > 0.0)
    {
        var_e3e21 = var_f0fbb / vec3((0.180000007152557373046875 / texture(s_PreExposureLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_e3e21 = var_f0fbb;
    }
    highp float var_aef79;
    if (ExposureCompensation.z > 0.5)
    {
        var_aef79 = clamp(texture(s_AverageLuminance, vec2(0.5)).x, LuminanceMinMaxAndWhitePointAndMinWhitePoint.x, LuminanceMinMaxAndWhitePointAndMinWhitePoint.y);
    }
    else
    {
        var_aef79 = 0.180000007152557373046875;
    }
    int var_bb4e7 = int(ExposureCompensation.x);
    highp float var_482cd;
    if ((var_bb4e7 > 0) && (var_bb4e7 < 2))
    {
        var_482cd = 1.0299999713897705078125 - (2.0 / ((0.4342944920063018798828125 * log(var_aef79 + 1.0)) + 2.0));
    }
    else
    {
        ...
        if (var_bb4e7 > 1)
        {
            ...
            {
                var_1cefa = ((log2(var_aef79) + 3.0) - (log2(LuminanceMinMaxAndWhitePointAndMinWhitePoint.x) + 3.0)) / ((log2(LuminanceMinMaxAndWhitePointAndMinWhitePoint.y) + 3.0) - (log2(LuminanceMinMaxAndWhitePointAndMinWhitePoint.x) + 3.0));
            }
    ...
    highp float var_830e7 = dot(var_e3e21, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875));
    bool var_710bf = ColorGrading_Contrast_Highlights.w != 0.0;
    bool var_3ddc3 = ColorGrading_Contrast_Shadows.w != 0.0;
    bool var_c60f8;
    if (var_710bf)
    {
        var_c60f8 = var_830e7 >= (var_aef79 * ColorGrading_Misc.y);
    }
    else
    {
        var_c60f8 = var_710bf;
    ...
    else
    {
        ...
        if (var_3ddc3)
        {
            var_4356f = var_830e7 <= (var_aef79 * ColorGrading_Misc.z);
        }
        else
        {
            var_4356f = var_3ddc3;
        ...
        else
        {
            ...
            if (ColorGrading_Contrast_Midtones.w != 0.0)
            {
                ...
                if ((var_830e7 < var_aef79) && var_3ddc3)
                {
                    var_704f5 = mix(ColorGrading_Contrast_Shadows.xyz, ColorGrading_Contrast_Midtones.xyz, vec3((var_830e7 - (var_aef79 * ColorGrading_Misc.z)) / (var_aef79 - (var_aef79 * ColorGrading_Misc.z))));
                }
                else
                {
                    highp vec3 var_48621;
                    if ((var_830e7 > var_aef79) && var_710bf)
                    {
                        var_48621 = mix(ColorGrading_Contrast_Midtones.xyz, ColorGrading_Contrast_Highlights.xyz, vec3((var_830e7 - var_aef79) / ((var_aef79 * ColorGrading_Misc.y) - var_aef79)));
                    }
                    else
                    {
    ...
    highp vec3 var_dca8e = vec3(ColorGrading_Misc.x * var_aef79);
    highp vec3 var_adbb5 = max(var_dca8e * pow(max(var_e3e21, vec3(0.0)) / var_dca8e, var_1cf7f), vec3(0.0));
    bool var_399ef = ColorGrading_Saturation_Highlights.w != 0.0;
    bool var_25f33 = ColorGrading_Saturation_Shadows.w != 0.0;
    bool var_01349;
    if (var_399ef)
    {
        var_01349 = var_830e7 >= (var_aef79 * ColorGrading_Misc.y);
    }
    else
    {
        var_01349 = var_399ef;
    }
    highp vec3 var_86ac7;
    if (var_01349)
    {
        var_86ac7 = ColorGrading_Saturation_Highlights.xyz;
    }
    else
    {
        bool var_f8b69;
        if (var_25f33)
        {
            var_f8b69 = var_830e7 <= (var_aef79 * ColorGrading_Misc.z);
        }
        else
        {
            var_f8b69 = var_25f33;
        ...
        else
        {
            ...
            if (ColorGrading_Saturation_Midtones.w != 0.0)
            {
                ...
                if ((var_830e7 < var_aef79) && var_25f33)
                {
                    var_1abde = mix(ColorGrading_Saturation_Shadows.xyz, ColorGrading_Saturation_Midtones.xyz, vec3((var_830e7 - (var_aef79 * ColorGrading_Misc.z)) / (var_aef79 - (var_aef79 * ColorGrading_Misc.z))));
                }
                else
                {
                    highp vec3 var_99fe9;
                    if ((var_830e7 > var_aef79) && var_399ef)
                    {
                        var_99fe9 = mix(ColorGrading_Saturation_Midtones.xyz, ColorGrading_Saturation_Highlights.xyz, vec3((var_830e7 - var_aef79) / ((var_aef79 * ColorGrading_Misc.y) - var_aef79)));
                    }
                    else
                    {
    ...
    if (var_79dd7)
    {
        var_12e11 = var_830e7 >= (var_aef79 * ColorGrading_Misc.y);
    }
    else
    {
        var_12e11 = var_79dd7;
    }
    highp vec3 var_5031f;
    if (var_12e11)
    {
        var_5031f = ColorGrading_Gain_Highlights.xyz;
    }
    else
    {
        bool var_430d4;
        if (var_a07bd)
        {
            var_430d4 = var_830e7 <= (var_aef79 * ColorGrading_Misc.z);
        }
        else
        {
            var_430d4 = var_a07bd;
        ...
        else
        {
            ...
            if (ColorGrading_Gain_Midtones.w != 0.0)
            {
                ...
                if ((var_830e7 < var_aef79) && var_a07bd)
                {
                    var_162e8 = mix(ColorGrading_Gain_Shadows.xyz, ColorGrading_Gain_Midtones.xyz, vec3((var_830e7 - (var_aef79 * ColorGrading_Misc.z)) / (var_aef79 - (var_aef79 * ColorGrading_Misc.z))));
                }
                else
                {
                    highp vec3 var_15cd3;
                    if ((var_830e7 > var_aef79) && var_79dd7)
                    {
                        var_15cd3 = mix(ColorGrading_Gain_Midtones.xyz, ColorGrading_Gain_Highlights.xyz, vec3((var_830e7 - var_aef79) / ((var_aef79 * ColorGrading_Misc.y) - var_aef79)));
                    }
                    else
                    {
    ...
    if (var_77cce)
    {
        var_1e2a1 = var_830e7 >= (var_aef79 * ColorGrading_Misc.y);
    }
    else
    {
        var_1e2a1 = var_77cce;
    }
    highp vec3 var_cd4f5;
    if (var_1e2a1)
    {
        var_cd4f5 = ColorGrading_Offset_Highlights.xyz;
    }
    else
    {
        bool var_f7a29;
        if (var_6c659)
        {
            var_f7a29 = var_830e7 <= (var_aef79 * ColorGrading_Misc.z);
        }
        else
        {
            var_f7a29 = var_6c659;
        ...
        else
        {
            ...
            if (ColorGrading_Offset_Midtones.w != 0.0)
            {
                ...
                if ((var_830e7 < var_aef79) && var_6c659)
                {
                    var_0e80d = mix(ColorGrading_Offset_Shadows.xyz, ColorGrading_Offset_Midtones.xyz, vec3((var_830e7 - (var_aef79 * ColorGrading_Misc.z)) / (var_aef79 - (var_aef79 * ColorGrading_Misc.z))));
                }
                else
                {
                    highp vec3 var_c972b;
                    if ((var_830e7 > var_aef79) && var_77cce)
                    {
                        var_c972b = mix(ColorGrading_Offset_Midtones.xyz, ColorGrading_Offset_Highlights.xyz, vec3((var_830e7 - var_aef79) / ((var_aef79 * ColorGrading_Misc.y) - var_aef79)));
                    }
                    else
                    {
    ...
    highp float var_53592 = (0.180000007152557373046875 / var_aef79) * var_482cd;
    highp vec3 var_6b722 = max(max(max(mix(vec3(dot(var_adbb5, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), var_adbb5, var_86ac7), vec3(0.0)) * var_5031f, vec3(0.0)) + (vec3(var_aef79) * var_cd4f5), vec3(0.0)) * var_53592;
    highp vec3 var_fe479;
    if (TonemapParams0.y >= 0.5)
    {
        highp float var_a6dfd = var_53592 * var_4a042;
        int var_fde43 = int(TonemapParams0.x);
        highp float var_8a41a = var_a6dfd * var_a6dfd;
        highp vec3 var_f1975;
        if (var_fde43 == 1)
        {
            var_f1975 = (var_6b722 * (vec3(1.0) + (var_6b722 / vec3(var_8a41a)))) / (vec3(1.0) + var_6b722);
        }
        else
        {
            ...
            if (var_fde43 == 2)
            {
                highp float var_78bd9 = dot(var_6b722, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875));
                var_3a319 = var_6b722 * (((var_78bd9 * (1.0 + (var_78bd9 / var_8a41a))) / (1.0 + var_78bd9)) / var_78bd9);
            }
            else
            {
                ...
                if (var_fde43 == 3)
                {
                    highp vec3 var_8c311 = var_6b722 * 2.0;
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        if (var_fde43 == 5)
                        {
                            highp vec3 var_29097 = var_6b722;
                            ...
                            var_ee8a2 = mix(var_6b722 / vec3(var_829b3), vec3(1.0), vec3(pow(var_b9ec4, GenericTonemapperContrastAndScaleAndOffsetAndCrosstalk.w))) * var_b9ec4;
                        }
                        else
                        {
                            var_ee8a2 = var_6b722 / (vec3(1.0) + var_6b722);
                        }
                        var_ab2cf = var_ee8a2;
                    }
                    var_b9221 = var_ab2cf;
        ...
        var_fe479 = pow(max(var_f1975, vec3(0.0)), vec3(1.0) / (var_6cd50 * ColorGrading_Gamma_PlayerUI.x));
    }
    else
    {
        var_fe479 = pow(max(var_6b722, vec3(0.0)), vec3(0.4545454680919647216796875));
    }
    highp vec3 var_b53eb = clamp(var_fe479, vec3(0.0), vec3(1.0));
