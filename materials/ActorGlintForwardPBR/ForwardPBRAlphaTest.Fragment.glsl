...
void func_75cb2(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_69e1b, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_a9fca, inout highp vec2 arg_f36e7, inout highp vec3 arg_81f79, inout highp vec4 arg_c54c3) {
    ...
    for (int loc_50392 = 0; loc_50392 < loc_a58f1; loc_81561 = loc_4f500, loc_d97c5 = loc_476bb, loc_50392++)
    {
        highp float loc_86107;
        if (int(DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.x) == 1)
        {
            highp float loc_29bbf = max(dot(arg_69e1b, normalize((u_view * DirectionalLightSourceShadowDirection[loc_50392]).xyz)), 0.0);
        ...
        highp vec3 loc_af162 = normalize((u_view * DirectionalLightSourceWorldSpaceDirection[loc_50392]).xyz);
        highp vec4 loc_fe4ce = DirectionalLightSourceDiffuseColorAndIlluminance[loc_50392];
        highp vec3 loc_7d025 = ((DirectionalLightSourceDiffuseColorAndIlluminance[loc_50392].xyz * loc_fe4ce.w) * arg_f36e7[loc_50392]) * DirectionalLightToggleAndCountAndMaxDistanceAndMaxCascadesPerLight.x;
...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_75cb2(var_c65bf, var_9aeed, var_f993c, var_0ae9b, var_f9f35, var_163cf, var_c6b5c, var_17a13, var_74779);
