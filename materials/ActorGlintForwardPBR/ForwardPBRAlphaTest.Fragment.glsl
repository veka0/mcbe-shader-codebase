...
layout(binding = 3, std430) buffer s_Lights { Light Lights[]; } var_a4908;
...
void func_5cff0(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_69e1b, inout highp vec3 arg_58517, inout highp vec3 arg_abe00, inout highp vec2 arg_c288e, inout highp vec3 arg_a3604, inout highp vec4 arg_c54c3) {
    ...
    for (int loc_fd135 = 0; loc_fd135 < loc_a58f1; loc_81561 = loc_4f500, loc_d97c5 = loc_476bb, loc_fd135++)
    {
        ...
        if (int(DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.x) == 1)
        {
            ...
            func_cb3cb(loc_fd135, arg_58517, loc_b57a6, loc_66a53);
            ...
            if (loc_66a53 != (-1))
            {
                ...
                if (int(FirstPersonPlayerShadowsEnabledAndResolutionAndFilterWidthAndTextureDimensions.x) > 0)
                {
                    ...
                    func_7a524(arg_58517, loc_955a9, loc_93efa);
                ...
                if (loc_643a4)
                {
                    highp vec4 loc_1a6df = CloudShadowProj * vec4(arg_58517, 1.0);
...
void func_73db9(inout int arg_aec91, inout highp float arg_28e67, inout highp vec3 arg_0623c, inout highp vec3 arg_214f6) {
    if (var_a4908.Lights[arg_aec91].shadowProbeIndex < 0)
    {
        arg_28e67 = 1.0;
        return;
    }
    highp vec3 loc_7f355 = arg_0623c - var_a4908.Lights[arg_aec91].position.xyz;
    ...
    for (int loc_1139b = 0; loc_1139b < 4; loc_b74da = loc_ab1a2, loc_1139b++)
    {
        ...
        for (int loc_79fcd = 0; loc_79fcd < 4; loc_ab1a2 = loc_ad4ff, loc_79fcd++)
        {
            ...
            loc_3d9e2.z = float(var_a4908.Lights[arg_aec91].shadowProbeIndex * 6) + loc_3d9e2.z;
...
void func_deced(inout highp vec4 arg_83841, inout int arg_50e58, inout highp vec3 arg_62394, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_569de = var_a4908.Lights[arg_50e58].position.xyz - v_worldPos;
    ...
    if (loc_95cea >= (var_a4908.Lights[arg_50e58].position.w * var_a4908.Lights[arg_50e58].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_fd676 = loc_95cea / ((var_a4908.Lights[arg_50e58].position.w * var_a4908.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    highp vec3 loc_13960 = var_a4908.Lights[arg_50e58].color.xyz * loc_3d192;
    arg_83841 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_83841.w);
    arg_83841.w = 1.0 - (loc_95cea / ((var_a4908.Lights[arg_50e58].position.w * var_a4908.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05));
    arg_62394 = (((var_a4908.Lights[arg_50e58].color.xyz * var_a4908.Lights[arg_50e58].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_76426(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_5e5a1, inout highp vec3 arg_21ff0, inout highp vec4 arg_eac61, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_138a8 = normalize((u_view * vec4(var_a4908.Lights[loc_2cc07].position.xyz, 1.0)).xyz - arg_89c41);
...
void main() {
    ...
    highp vec4 var_acfd1 = vec4(var_2b5c5.xyz * var_2b5c5.xyz, abs(var_2b5c5.w)) + vec4(mix((var_93e9a.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w)), 0.0);
    var_acfd1.w = var_93e9a.w;
    highp vec4 var_d4180 = var_acfd1;
    ...
    highp vec3 var_68c1c = var_9f386.xyz;
    highp vec3 var_4d6b6 = var_89669.xyz;
    highp vec3 var_4a39c = (u_view * var_89669).xyz;
    ...
    highp float var_da2ab = length(var_68c1c);
    highp vec3 var_a7d68 = var_68c1c;
    highp vec3 var_5bd0a = var_bed13;
    highp vec3 var_811e1 = var_68c1c;
    ...
    highp vec3 var_e0782 = -(var_68c1c / vec3(length(var_68c1c) + 9.9999997473787516355514526367188e-05));
    highp vec3 var_f49d3;
    if (ShadowQuantizationParameters.y > 0.0)
    {
        ...
        var_f49d3 = (var_8ae03 - (var_24b50 - (var_ce28e * dot(var_24b50, var_ce28e)))) + WorldOrigin.xyz;
    }
    else
    {
        var_f49d3 = v_worldPos;
    }
    bool var_5a6e4;
    highp vec4 var_9a0a9;
    highp vec3 var_8adad;
    highp vec3 var_77fdc;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_b7ced = vec2(var_49182, var_280ef);
        highp vec3 var_c7b8f;
        highp vec3 var_211cd;
        func_5cff0(var_211cd, var_c7b8f, var_4a39c, var_f49d3, var_a7d68, var_b7ced, var_e0782, var_acfd1);
        highp vec3 var_8bbda = var_68c1c;
        highp vec4 var_9536d;
        highp vec3 var_62261;
        highp vec3 var_7aa4c;
        bool var_c0cc5;
        func_76426(var_25152, var_f4e52, var_c0cc5, var_7aa4c, var_62261, var_9536d, var_8bbda, var_bed13, var_68c1c, var_4a39c, var_e0782, var_acfd1, var_f49d3, var_4d6b6);
        var_77fdc = var_211cd + (var_7aa4c * (1.0 - var_f3062));
        var_8adad = var_c7b8f + (var_62261 * (1.0 - var_5d160));
        var_9a0a9 = var_9536d;
        var_5a6e4 = var_c0cc5;
    }
    else
    ...
    highp float var_4dfb1;
    if (var_5a6e4)
    {
        var_4dfb1 = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_4dfb1 = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_c174e = var_9a0a9;
    highp vec4 var_746de = SkyAmbientLightColorIntensity;
    highp float var_3b1fe = TileLightIntensity.x * TileLightIntensity.x;
    highp vec3 var_9f32b = ((((var_acfd1.xyz * 1.0) * max(((clamp(vec3(var_3b1fe + (var_c174e.x * var_c174e.w), (var_3b1fe * ((((var_3b1fe * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_c174e.y * var_c174e.w), (var_3b1fe * (((var_3b1fe * var_3b1fe) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_c174e.z * var_c174e.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_4dfb1) + ((SkyAmbientLightColorIntensity.xyz * pow(TileLightIntensity.y, mix(5.0, 3.0, CameraLightIntensity.y))) * var_746de.w), vec3(0.02999999932944774627685546875))) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_77fdc) + var_8adad;
    highp float var_7d5ab = length(var_68c1c);
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_9f32b, var_08c70, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_9f32b;
    ...
    {
        var_7e3dc = mix(var_9f32b, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
    ...
    {
        highp vec3 var_7914f = reflect(normalize(v_worldPos - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_4d6b6);
        ...
        highp vec3 var_ac463 = (var_6f3bc * (pow(clamp(((TileLightIntensity.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0), 3.0) * IBLParameters.x)) * IBLParameters.z;
        highp vec4 var_3154f;
        func_1e7c4(var_ac463, var_3154f);
        highp vec4 var_beeb8 = var_3154f;
        highp vec3 var_681ec;
        if (var_beeb8.w == 1.0)
        {
            var_681ec = var_3154f.xyz;
        }
        else
        {
            var_681ec = var_ac463;
        }
        highp vec2 var_22bad = texture(s_BrdfLUT, vec2(clamp(dot(var_4a39c, -(var_68c1c / vec3(var_da2ab))), 0.0, 1.0), 0.5)).xy;
        highp vec3 var_daf78 = var_681ec * ((vec3(0.039999999105930328369140625) * var_22bad.x) + vec3(var_22bad.y));
        highp vec3 var_67472;
        if (AtmosphericScatteringToggles.x != 0.0)
        {
            var_67472 = var_daf78 * (1.0 - clamp((((var_da2ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) * FogAndDistanceControl.y, 0.0, 1.0));
        }
        else
        {
            var_67472 = var_daf78 * (1.0 - clamp((((var_da2ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0));
        }
