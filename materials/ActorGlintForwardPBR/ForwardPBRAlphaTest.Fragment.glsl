...
layout(binding = 3, std430) buffer s_Lights { Light Lights[]; } var_b0190;
...
void func_aed09(inout int arg_3cd09, inout highp float arg_28e67, inout highp vec3 arg_214f6) {
    if (var_b0190.Lights[arg_3cd09].shadowProbeIndex < 0)
    {
        arg_28e67 = 1.0;
        return;
    }
    highp vec3 loc_3566a = v_worldPos - var_b0190.Lights[arg_3cd09].position.xyz;
    ...
    for (int loc_1139b = 0; loc_1139b < 4; loc_b74da = loc_f6f3d, loc_1139b++)
    {
        ...
        for (int loc_79fcd = 0; loc_79fcd < 4; loc_f6f3d = loc_bbf51, loc_79fcd++)
        {
            ...
            loc_0a47c.z = float(var_b0190.Lights[arg_3cd09].shadowProbeIndex * 6) + loc_0a47c.z;
...
void func_e7535(inout highp vec4 arg_83841, inout int arg_a1b0b, inout highp vec3 arg_62394, inout highp vec3 arg_154f5) {
    ...
    highp vec3 loc_569de = var_b0190.Lights[arg_a1b0b].position.xyz - v_worldPos;
    ...
    if (loc_95cea >= (var_b0190.Lights[arg_a1b0b].position.w * var_b0190.Lights[arg_a1b0b].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_fd676 = loc_95cea / ((var_b0190.Lights[arg_a1b0b].position.w * var_b0190.Lights[arg_a1b0b].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    highp vec3 loc_13960 = var_b0190.Lights[arg_a1b0b].color.xyz * loc_3d192;
    arg_83841 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_83841.w);
    arg_83841.w = 1.0 - (loc_95cea / ((var_b0190.Lights[arg_a1b0b].position.w * var_b0190.Lights[arg_a1b0b].position.w) + 9.9999997473787516355514526367188e-05));
    arg_62394 = (((var_b0190.Lights[arg_a1b0b].color.xyz * var_b0190.Lights[arg_a1b0b].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_7d4c7(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_5e5a1, inout highp vec3 arg_21ff0, inout highp vec4 arg_eac61, inout highp vec3 arg_81f82) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_138a8 = normalize((u_view * vec4(var_b0190.Lights[loc_ee051].position.xyz, 1.0)).xyz - arg_89c41);
...
void main() {
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_4cdf3(var_c282b, var_de9aa, var_f1c2e, var_edfc0, var_c8039, var_f1053, var_4e671);
        highp vec3 var_92517 = var_b4fbd;
        highp vec4 var_3d9d9;
        highp vec3 var_b3e4d;
        highp vec3 var_ef9ba;
        bool var_64e2a;
        func_7d4c7(var_bbdbf, var_b65dc, var_64e2a, var_ef9ba, var_b3e4d, var_3d9d9, var_92517, var_1f150, var_b4fbd, var_f1c2e, var_f1053, var_4e671, var_e1b04);
