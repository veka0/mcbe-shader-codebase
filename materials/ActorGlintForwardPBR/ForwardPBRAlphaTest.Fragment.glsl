...
layout(binding = 14, std430) buffer s_zLights { Light zLights[]; } var_c912d;
...
uniform highp mat4 DirectionalLightSourceCausticsViewProj;
...
void func_5b299(inout highp vec3 arg_e16e6, inout highp vec3 arg_1bae0, inout highp vec3 arg_488fe, inout highp vec3 arg_adf73, inout highp vec3 arg_c100b, inout highp vec3 arg_d7698, inout highp float arg_485b3, inout highp vec3 arg_c7286, inout highp vec4 arg_3efab) {
    ...
    if (int(DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.x) == 1)
    {
        ...
        highp vec3 loc_edca9 = arg_adf73 + ((arg_c100b * ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.w) * clamp(1.0 - loc_93b5c, 0.0, 1.0));
        highp float loc_93095;
        loc_93095 = 1.0;
        int loc_eb72c;
        highp float loc_b1c51;
        for (int loc_d87da = 0, loc_335db = 0; loc_d87da < 4; loc_335db = loc_eb72c, loc_93095 = loc_b1c51, loc_d87da++)
        {
            int loc_724f1 = int(CascadesPerSet[loc_d87da]);
            for (int loc_c0375 = 0; loc_c0375 < loc_724f1; loc_c0375++)
            {
                int loc_19392 = loc_335db + loc_c0375;
                if (loc_19392 >= 8)
                {
                    loc_b1c51 = loc_93095;
                    break;
                }
                highp vec4 loc_f4ee8;
                bool loc_8f5d1;
                func_f0809(loc_f4ee8, loc_19392, loc_edca9, loc_8f5d1);
                highp vec4 loc_e2716 = loc_f4ee8;
                if (!loc_8f5d1)
                {
                    continue;
                }
                highp float loc_e3626 = clamp(loc_93b5c, loc_c54e0[loc_19392], 1.0);
                highp float loc_0ebc3 = CascadesParameters[loc_19392].y + (CascadesParameters[loc_19392].z * (sqrt(1.0 - (loc_e3626 * loc_e3626)) / loc_e3626));
                int loc_73fe4;
                if (QuantizationParameters.x != 0.0)
                {
                    loc_73fe4 = 1;
                ...
                {
                    loc_73fe4 = clamp(int(CascadesParameters[loc_19392].w + 0.5), 1, 9);
                }
                int loc_2b064 = loc_73fe4 / 2;
                highp vec2 loc_c324a = ((vec2(loc_e2716.x, loc_e2716.y) * 0.5) + vec2(0.5)) * CascadesParameters[loc_19392].x;
                highp float loc_3198a = (loc_e2716.z * 0.5) + 0.5;
                loc_c324a.y += (1.0 - CascadesParameters[loc_19392].x);
                ...
                for (int loc_6984d = 0; loc_6984d < loc_73fe4; loc_5ff83 = loc_793bd, loc_6984d++)
                {
                    ...
                    {
                        highp vec2 loc_49c29 = loc_c324a + ((vec2(float(loc_2f95f - loc_2b064) + 0.5, float(loc_6984d - loc_2b064) + 0.5) * ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.x) * CascadesParameters[loc_19392].x);
                        highp vec4 loc_f4b0f = textureGather(s_ShadowCascades, vec3(loc_49c29, float(loc_19392)));
                ...
                loc_b1c51 = min(loc_93095, loc_5ff83 / float(loc_73fe4 * loc_73fe4));
                break;
            }
            loc_eb72c = loc_335db + loc_724f1;
        }
        ...
        if (int(FirstPersonPlayerShadowsEnabledAndResolutionAndFilterWidthAndTextureDimensions.x) > 0)
        {
            ...
            func_59bf3(loc_edca9, loc_93b5c, loc_a39dc, loc_cd479);
            loc_fc44d = min(loc_93095, loc_cd479);
        }
        else
        {
            loc_fc44d = loc_93095;
        ...
        if (loc_b7d63)
        {
            ...
            highp vec4 loc_8ad63 = CloudShadowProj * vec4(loc_edca9, 1.0);
        ...
        loc_19fd0 = mix(loc_4c338, 1.0, smoothstep(max(0.0, ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.y - 8.0), ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.y, -arg_d7698.z));
    }
    else
    {
        loc_19fd0 = 1.0;
    ...
    highp vec3 loc_43463 = ((DirectionalLightSourceDiffuseColorAndIlluminance.xyz * loc_85a44.w) * arg_485b3) * DirectionalLightToggleAndMaxDistanceAndMaxCascadesPerLight.x;
    highp float loc_a4d6c = max(dot(arg_488fe, loc_d841a), 0.0);
    ...
    highp vec3 loc_f6f78 = vec3(0.959999978542327880859375) * ((loc_8948b * loc_8948b) * loc_fd36a);
    arg_e16e6 = (((((vec3(0.959999978542327880859375) - loc_f6f78) * loc_a4d6c) * ((arg_3efab.xyz * 1.0) * vec3(0.3183098733425140380859375))) * loc_19fd0) * loc_43463) * DiffuseSpecularEmissiveAmbientTermToggles.x;
    arg_1bae0 = (((((((vec3(0.039999999105930328369140625) + loc_f6f78) * (0.01989436708390712738037109375 / (loc_ced6f * loc_ced6f))) * ((loc_0b311 / ((loc_0b311 * 0.875) + 0.12510000169277191162109375)) * (loc_a4d6c / ((loc_a4d6c * 0.875) + 0.12510000169277191162109375)))) / vec3(((4.0 * loc_a4d6c) * loc_0b311) + 9.9999997473787516355514526367188e-05)) * loc_a4d6c) * loc_19fd0) * loc_43463) * DiffuseSpecularEmissiveAmbientTermToggles.y;
}
...
void func_5b6a6(inout int arg_826b5, inout highp float arg_9eee0, inout highp float arg_6b488, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c) {
    if (var_c912d.zLights[arg_826b5].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        arg_6b488 = 1.0;
        return;
    }
    highp vec3 loc_44ea9 = arg_aee55 - var_c912d.zLights[arg_826b5].position.xyz;
    ...
    highp float loc_e670f = (textureLod(s_PointLightShadowTextureArray, vec4(loc_f715f, float(var_c912d.zLights[arg_826b5].shadowProbeIndex)), 0.0).x * 2.0) - 1.0;
...
void func_735c6(inout highp vec4 arg_e84ec, inout int arg_34699, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_ec226, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    arg_e84ec = vec4(0.0);
    if (arg_34699 < 0)
    {
        arg_43b7a = 1.0;
    ...
    highp vec3 loc_a4b3e = var_c912d.zLights[arg_34699].position.xyz - v_worldPos;
    ...
    if (loc_3a449 >= (var_c912d.zLights[arg_34699].position.w * var_c912d.zLights[arg_34699].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_ec226 = vec3(0.0);
    ...
    if (DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.w != 0.0)
    {
        ...
        func_5b6a6(arg_34699, loc_5ee54, loc_879d8, arg_5e370, arg_78ca7);
        loc_a011d = loc_5ee54;
        loc_cddfe = loc_879d8;
    }
    else
    ...
    highp float loc_4c5a5 = loc_3a449 / ((var_c912d.zLights[arg_34699].position.w * var_c912d.zLights[arg_34699].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_c912d.zLights[arg_34699].color.xyz * loc_4217d;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_3a449 / ((var_c912d.zLights[arg_34699].position.w * var_c912d.zLights[arg_34699].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_a011d;
    arg_7f337 = loc_cddfe;
    arg_ec226 = ((var_c912d.zLights[arg_34699].color.xyz * var_c912d.zLights[arg_34699].color.w) * loc_4217d) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_0fcb2(inout bool arg_9a2b4, inout bool arg_b6724, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_33e52, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_fea00, inout highp vec3 arg_5e5a1, inout highp vec3 arg_061f9, inout highp vec4 arg_eac61, inout highp vec3 arg_8f7d6, inout highp vec3 arg_115ae) {
    ...
    for (int loc_86630 = loc_2aee5; loc_86630 < loc_9d2b5; loc_983e3 = loc_7c75a, loc_33c65 = loc_ed2f2, loc_23246 = loc_62c27, loc_86630++)
    {
        ...
        highp vec3 loc_74d8b = normalize((u_view * vec4(var_c912d.zLights[loc_959ae].position.xyz, 1.0)).xyz - arg_fea00);
        ...
        if (arg_b6724)
        {
            ...
            if (arg_9a2b4)
            {
                highp float loc_542fb = max(dot(arg_5e5a1, loc_74d8b), 0.0);
                highp float loc_33e5f = max(dot(arg_5e5a1, arg_061f9), 0.0);
                highp vec3 loc_608b6 = normalize(loc_74d8b + arg_061f9);
            ...
            {
                loc_8d121 = vec3(0.0);
                loc_770dc = ((arg_eac61.xyz * 1.0) * vec3(0.3183098733425140380859375)) * max(dot(arg_5e5a1, loc_74d8b), 0.0);
            }
            loc_20211 = loc_8d121;
            loc_1507e = vec3(0.0);
            loc_6691c = loc_770dc;
        ...
        else
        {
            ...
            if (arg_9a2b4)
            {
                highp float loc_41de3 = max(dot(arg_5e5a1, loc_74d8b), 0.0);
                highp float loc_7d8be = max(dot(arg_5e5a1, arg_061f9), 0.0);
                highp vec3 loc_74f40 = normalize(loc_74d8b + arg_061f9);
        ...
        func_735c6(loc_95268, loc_959ae, loc_839cd, loc_8b13a, loc_e4695, arg_8f7d6, arg_115ae);
        loc_fa2ec += loc_95268;
...
void main() {
    ...
    highp float var_76520;
    if (var_94c07)
    {
        highp vec4 var_2c6cf = DirectionalLightSourceCausticsViewProj * vec4(v_worldPos - WorldOrigin.xyz, 1.0);
        highp vec4 var_3ab6f = var_2c6cf;
        highp vec3 var_08d24 = var_2c6cf.xyz / vec3(var_3ab6f.w);
        var_08d24.y *= (-1.0);
        ...
        var_76520 = pow(var_057f4, float(int(CausticsParameters.z))) * float(int(CausticsParameters.z) + 1);
    }
    else
    {
        var_76520 = 1.0;
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_5b299(var_c65bf, var_9aeed, var_f993c, var_0ae9b, var_f9f35, var_163cf, var_76520, var_17a13, var_74779);
        ...
        func_0fcb2(var_da382, var_d1b0b, var_e1a8f, var_ef9ba, var_36252, var_6cfc2, var_729bd, var_e7e52, var_f993c, var_17a13, var_74779, var_fe3d5, var_f9f35);
