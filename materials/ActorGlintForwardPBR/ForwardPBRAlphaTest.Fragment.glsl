...
layout(binding = 3, std430) buffer s_Lights { Light Lights[]; } var_cdb0d;
...
void func_4cdf3(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_69e1b, inout highp vec3 arg_abe00, inout highp vec2 arg_c288e, inout highp vec3 arg_a3604, inout highp vec4 arg_c54c3) {
...
void func_51637(inout int arg_3cd09, inout highp float arg_c05a6, inout highp vec3 arg_214f6) {
    if (var_cdb0d.Lights[arg_3cd09].shadowProbeIndex < 0)
    {
        arg_c05a6 = 1.0;
        return;
    }
    highp vec3 loc_3566a = v_worldPos - var_cdb0d.Lights[arg_3cd09].position.xyz;
    ...
    for (int loc_1139b = 0; loc_1139b < 4; loc_54d10 = loc_f6f3d, loc_1139b++)
    {
        ...
        for (int loc_79fcd = 0; loc_79fcd < 4; loc_f6f3d = loc_bbf51, loc_79fcd++)
        {
            ...
            loc_7004c.z = float(var_cdb0d.Lights[arg_3cd09].shadowProbeIndex * 6) + loc_7004c.z;
...
void func_79cb8(inout highp vec4 arg_22524, inout int arg_c8e98, inout highp vec3 arg_62394, inout highp vec3 arg_154f5) {
    ...
    highp vec3 loc_569de = var_cdb0d.Lights[arg_c8e98].position.xyz - v_worldPos;
    ...
    if (loc_3bcb9 >= (var_cdb0d.Lights[arg_c8e98].position.w * var_cdb0d.Lights[arg_c8e98].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_8a6f3 = loc_3bcb9 / (var_cdb0d.Lights[arg_c8e98].position.w * var_cdb0d.Lights[arg_c8e98].position.w);
    ...
    highp vec3 loc_13960 = var_cdb0d.Lights[arg_c8e98].color.xyz * loc_3d192;
    arg_22524 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_22524.w);
    arg_22524.w = 1.0 - (loc_3bcb9 / (var_cdb0d.Lights[arg_c8e98].position.w * var_cdb0d.Lights[arg_c8e98].position.w));
    arg_62394 = (((var_cdb0d.Lights[arg_c8e98].color.xyz * var_cdb0d.Lights[arg_c8e98].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_7d4c7(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_5e5a1, inout highp vec3 arg_21ff0, inout highp vec4 arg_eac61, inout highp vec3 arg_81f82) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_138a8 = normalize((u_view * vec4(var_cdb0d.Lights[loc_ee051].position.xyz, 1.0)).xyz - arg_89c41);
...
void main() {
    ...
    highp vec4 var_4e671 = vec4(var_2b5c5.xyz * var_2b5c5.xyz, abs(var_2b5c5.w)) + vec4(mix((var_93e9a.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w)), 0.0);
    var_4e671.w = var_93e9a.w;
    highp vec4 var_d4180 = var_4e671;
    ...
    highp vec3 var_9fdd6 = var_9f386.xyz;
    ...
    highp vec3 var_edfc0 = var_9fdd6;
    highp vec3 var_5bd0a = var_1f150;
    highp vec3 var_811e1 = var_9fdd6;
    ...
    highp vec3 var_45daf = -(var_9fdd6 / vec3(length(var_9fdd6)));
    bool var_5a6e4;
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_4cdf3(var_c282b, var_de9aa, var_f1c2e, var_edfc0, var_c8039, var_45daf, var_4e671);
        highp vec3 var_92517 = var_9fdd6;
        highp vec4 var_3d9d9;
        highp vec3 var_b3e4d;
        highp vec3 var_ef9ba;
        bool var_64e2a;
        func_7d4c7(var_bbdbf, var_b65dc, var_64e2a, var_ef9ba, var_b3e4d, var_3d9d9, var_92517, var_1f150, var_9fdd6, var_f1c2e, var_45daf, var_4e671, var_e1b04);
        var_77fdc = var_c282b + (var_ef9ba * (1.0 - var_f3062));
        var_8adad = var_de9aa + (var_b3e4d * (1.0 - var_5d160));
        var_9a0a9 = var_3d9d9;
        var_5a6e4 = var_64e2a;
    }
    else
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_9f32b, var_a6488, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_9f32b;
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp vec3 var_77c01 = mix(textureLod(s_SpecularIBLRecords, vec4(var_7914f, float((var_ae27f + 2) % 3)), var_cd8a3).xyz, textureLod(s_SpecularIBLRecords, vec4(var_7914f, float(var_ae27f)), var_cd8a3).xyz, vec3(IBLParameters.w));
        highp vec3 var_2f540;
        if (PreExposureEnabled.x > 0.0)
        {
            var_2f540 = var_77c01 * vec3(5.5555553436279296875);
        }
        else
        {
            var_2f540 = var_77c01;
        }
        highp vec2 var_51e86 = texture(s_BrdfLUT, vec2(clamp(dot(var_f1c2e, -(var_9fdd6 / vec3(length(var_9fdd6)))), 0.0, 1.0), 0.5)).xy;
        highp vec3 var_77178 = ((var_2f540 * (pow(clamp(((TileLightIntensity.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0), 3.0) * IBLParameters.x)) * IBLParameters.z) * ((vec3(0.039999999105930328369140625) * var_51e86.x) + vec3(var_51e86.y));
        highp float var_96068 = length(var_9fdd6);
