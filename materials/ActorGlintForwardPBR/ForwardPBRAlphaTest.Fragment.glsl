...
layout(binding = 14, std430) buffer s_zLights { Light zLights[]; } var_d8699;
...
void func_5b6a6(inout int arg_826b5, inout highp float arg_9eee0, inout highp float arg_6b488, inout highp vec3 arg_aee55, inout highp vec3 arg_1111c) {
    if (var_d8699.zLights[arg_826b5].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        arg_6b488 = 1.0;
        return;
    }
    highp vec3 loc_44ea9 = arg_aee55 - var_d8699.zLights[arg_826b5].position.xyz;
    ...
    highp float loc_e670f = (textureLod(s_PointLightShadowTextureArray, vec4(loc_f715f, float(var_d8699.zLights[arg_826b5].shadowProbeIndex)), 0.0).x * 2.0) - 1.0;
...
void func_06ed4(inout highp vec4 arg_e84ec, inout int arg_fb63f, inout highp float arg_43b7a, inout highp float arg_7f337, inout highp vec3 arg_0a2b9, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    highp vec3 loc_a4b3e = var_d8699.zLights[arg_fb63f].position.xyz - v_worldPos;
    ...
    if (loc_3a449 >= (var_d8699.zLights[arg_fb63f].position.w * var_d8699.zLights[arg_fb63f].position.w))
    {
        arg_43b7a = 1.0;
        arg_7f337 = 1.0;
        arg_0a2b9 = vec3(0.0);
    ...
    highp float loc_4c5a5 = loc_3a449 / ((var_d8699.zLights[arg_fb63f].position.w * var_d8699.zLights[arg_fb63f].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    if (loc_cddfe > 0.0)
    {
        highp vec3 loc_8226d = var_d8699.zLights[arg_fb63f].color.xyz * loc_219c5;
        arg_e84ec = vec4(loc_8226d.x, loc_8226d.y, loc_8226d.z, arg_e84ec.w);
        arg_e84ec.w = 1.0 - (loc_3a449 / ((var_d8699.zLights[arg_fb63f].position.w * var_d8699.zLights[arg_fb63f].position.w) + 9.9999997473787516355514526367188e-05));
    }
    arg_43b7a = loc_a011d;
    arg_7f337 = loc_cddfe;
    arg_0a2b9 = (var_d8699.zLights[arg_fb63f].color.xyz * var_d8699.zLights[arg_fb63f].color.w) * loc_219c5;
}
void func_0fcb2(inout bool arg_9a2b4, inout bool arg_b6724, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_33e52, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_fea00, inout highp vec3 arg_5e5a1, inout highp vec3 arg_061f9, inout highp vec4 arg_eac61, inout highp vec3 arg_8f7d6, inout highp vec3 arg_115ae) {
    ...
    for (int loc_86630 = loc_2aee5; loc_86630 < loc_9d2b5; loc_983e3 = loc_7c75a, loc_33c65 = loc_ed2f2, loc_23246 = loc_62c27, loc_86630++)
    {
        ...
        highp vec3 loc_74d8b = normalize((u_view * vec4(var_d8699.zLights[loc_959ae].position.xyz, 1.0)).xyz - arg_fea00);
...
void func_5ffa5(inout highp vec3 arg_4f139, inout highp vec3 arg_d5e4d, inout highp vec3 arg_5b214, inout highp vec3 arg_2f16d, inout highp vec4 arg_d4ca2, inout highp vec3 arg_c7375, inout highp vec3 arg_b40e7, inout highp vec3 arg_a995c, inout highp vec3 arg_4e72a, inout highp vec3 arg_e9876, inout highp vec4 arg_763eb, inout highp vec3 arg_15153) {
    ...
    func_0fcb2(loc_d7f6a, loc_9f74f, loc_29151, loc_61fb4, loc_2e10a, loc_6c2e9, arg_a995c, arg_c7375, arg_4e72a, arg_e9876, arg_763eb, loc_6b162, arg_15153);
...
void main() {
    ...
    highp vec4 var_d98fe = vec4(var_2b5c5.xyz * var_2b5c5.xyz, abs(var_2b5c5.w)) + vec4(mix((var_93e9a.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w)), 0.0);
    var_d98fe.w = var_93e9a.w;
    highp vec4 var_d4180 = var_d98fe;
    ...
    highp vec3 var_69e5d;
    highp vec3 var_a0019;
    if (var_5bd0a.z != 1.0)
    {
        ...
        func_5b299(var_363da, var_81903, var_0a070, var_0ae9b, var_0981e, var_163cf, var_41b9e, var_eaed9, var_d98fe);
        highp vec4 var_2d7ba;
        highp vec3 var_815dd;
        highp vec3 var_8ee3d;
        func_5ffa5(var_8ee3d, var_363da, var_815dd, var_81903, var_2d7ba, var_29d3b, var_7446c, var_190a8, var_0a070, var_eaed9, var_d98fe, var_0981e);
        var_a0019 = var_8ee3d;
        var_69e5d = var_815dd;
        var_9a0a9 = var_2d7ba;
    }
    ...
    highp vec4 var_220d2 = var_9a0a9;
    highp float var_5b18f = TileLightIntensity.x * TileLightIntensity.x;
    highp vec4 var_6e3e4 = SkyAmbientLightColorIntensity;
    highp float var_2a1cf = TileLightIntensity.y * TileLightIntensity.y;
    ...
    highp vec4 var_2deb3 = vec4(var_1bb57, var_bdb1d);
    highp vec4 var_d967c = var_2deb3;
    highp vec4 var_1c81b;
    if (VolumeScatteringEnabledAndPointLightVolumetricsEnabled.x != 0.0)
    {
        ...
        var_1c81b = mix(textureLod(s_ScatteringBuffer, vec3(var_8cf8f, var_115ba.y, float(var_0e80b)), 0.0), textureLod(s_ScatteringBuffer, vec3(var_8cf8f, var_115ba.y, float(var_0e80b + 1)), 0.0), vec4(clamp(var_14f4f - float(var_0e80b), 0.0, 1.0)));
    }
    else
    {
        var_1c81b = vec4(0.0, 0.0, 0.0, 1.0);
    }
    highp vec4 var_bedd3 = var_1c81b;
    highp vec3 var_12584;
    ...
    highp vec3 var_fe3cb = vec4(var_1c81b.xyz + (mix(((((var_d98fe.xyz * 1.0) * max((clamp(vec3(var_5b18f + (var_220d2.x * var_220d2.w), (var_5b18f * ((((var_5b18f * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_220d2.y * var_220d2.w), (var_5b18f * (((var_5b18f * var_5b18f) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_220d2.z * var_220d2.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_2a1cf * var_2a1cf) * TileLightIntensity.y, (TileLightIntensity.y * TileLightIntensity.y) * TileLightIntensity.y, CameraLightIntensity.y)) * var_6e3e4.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_a0019) + var_69e5d, var_2deb3.xyz, vec3(var_d967c.w)) * var_bedd3.w), 1.0).xyz + var_12584;
    highp vec3 var_cb832;
    if (PreExposureEnabled.x > 0.0)
    {
        var_cb832 = var_fe3cb * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_cb832 = var_fe3cb;
