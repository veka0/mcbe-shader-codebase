...
layout(binding = 3, std430) buffer s_Lights { Light Lights[]; } var_a4822;
...
void func_cf9f6(inout highp vec3 arg_534d1, inout highp vec3 arg_90b60, inout highp vec3 arg_69e1b, inout highp vec3 arg_016ce, inout highp vec3 arg_68e47, inout highp vec3 arg_470f5, inout highp vec2 arg_c288e, inout highp vec3 arg_a3604, inout highp vec4 arg_c54c3) {
    ...
    for (int loc_fd135 = 0; loc_fd135 < loc_a58f1; loc_81561 = loc_4f500, loc_d97c5 = loc_476bb, loc_fd135++)
    {
        highp float loc_04b75;
        if (int(DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.x) == 1)
        {
            highp float loc_4e64b = max(dot(arg_69e1b, normalize((u_view * DirectionalLightSourceShadowDirection[loc_fd135]).xyz)), 0.0);
            highp vec3 loc_75562 = arg_016ce + ((arg_68e47 * ShadowFilterOffsetAndRangeFarAndMapSizeAndNormalOffsetStrength.w) * clamp(1.0 - loc_4e64b, 0.0, 1.0));
            int loc_66a53;
            highp vec4 loc_b57a6;
            func_cb3cb(loc_fd135, loc_75562, loc_b57a6, loc_66a53);
            highp vec4 loc_b19db = loc_b57a6;
            highp float loc_2f871;
            if (loc_66a53 != (-1))
            {
                highp float loc_0ed3d = ShadowBias[loc_66a53] + (ShadowSlopeBias[loc_66a53] * clamp(tan(acos(loc_4e64b)), 0.0, 1.0));
                int loc_be19b = int(DirectionalLightSourceShadowCascadeNumber[loc_fd135].x);
                highp float loc_222e2;
                func_b31b9(loc_be19b, loc_222e2, loc_66a53, loc_b19db, loc_0ed3d);
                highp float loc_ad256;
                if (int(FirstPersonPlayerShadowsEnabledAndResolutionAndFilterWidthAndTextureDimensions.x) > 0)
                {
                    highp float loc_93efa;
                    func_a4016(loc_75562, loc_4e64b, loc_93efa);
        ...
        highp vec3 loc_6bdc6 = (((DirectionalLightSourceDiffuseColorAndIlluminance[loc_fd135].xyz * loc_5b55e.w) * loc_791d7) * arg_c288e[loc_fd135]) * DirectionalLightToggleAndCountAndMaxDistanceAndMaxCascadesPerLight.x;
        ...
        highp vec3 loc_bae7e = vec3(0.959999978542327880859375) * pow(clamp(1.0 - max(dot(arg_a3604, loc_8c143), 0.0), 0.0, 1.0), 5.0);
        loc_476bb = loc_d97c5 + ((((((vec3(0.959999978542327880859375) - loc_bae7e) * loc_abc49) * ((arg_c54c3.xyz * 1.0) * vec3(0.3183098733425140380859375))) * loc_04b75) * loc_6bdc6) * DiffuseSpecularEmissiveAmbientTermToggles.x);
        loc_4f500 = loc_81561 + ((((((((vec3(0.039999999105930328369140625) + loc_bae7e) * (0.01989436708390712738037109375 / (loc_fc12f * loc_fc12f))) * ((loc_f17ab / ((loc_f17ab * 0.875) + 0.12510000169277191162109375)) * (loc_abc49 / ((loc_abc49 * 0.875) + 0.12510000169277191162109375)))) / vec3(((4.0 * loc_abc49) * loc_f17ab) + 9.9999997473787516355514526367188e-05)) * loc_abc49) * loc_04b75) * loc_6bdc6) * DiffuseSpecularEmissiveAmbientTermToggles.y);
    }
    arg_534d1 = loc_d97c5;
    arg_90b60 = loc_81561;
}
...
void func_1799c(inout int arg_47a77, inout highp float arg_9eee0, inout highp vec3 arg_0623c, inout highp vec3 arg_1bb2e) {
    if (var_a4822.Lights[arg_47a77].shadowProbeIndex < 0)
    {
        arg_9eee0 = 1.0;
        return;
    }
    highp vec3 loc_2b15e = arg_0623c - var_a4822.Lights[arg_47a77].position.xyz;
    ...
    if (((textureLod(s_PointLightShadowTextureArray, vec4(loc_ad23e, float(var_a4822.Lights[arg_47a77].shadowProbeIndex)), 0.0).x * 2.0) - 1.0) >= loc_f7c8d.z)
    {
        loc_591c8 = 1.0;
    }
    else
...
void func_deced(inout highp vec4 arg_83841, inout int arg_50e58, inout highp vec3 arg_62394, inout highp vec3 arg_ab1f6, inout highp vec3 arg_81f82) {
    ...
    highp vec3 loc_569de = var_a4822.Lights[arg_50e58].position.xyz - v_worldPos;
    ...
    if (loc_95cea >= (var_a4822.Lights[arg_50e58].position.w * var_a4822.Lights[arg_50e58].position.w))
    {
        arg_62394 = vec3(0.0);
        return;
    }
    ...
    highp float loc_fd676 = loc_95cea / ((var_a4822.Lights[arg_50e58].position.w * var_a4822.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05);
    ...
    highp vec3 loc_13960 = var_a4822.Lights[arg_50e58].color.xyz * loc_3d192;
    arg_83841 = vec4(loc_13960.x, loc_13960.y, loc_13960.z, arg_83841.w);
    arg_83841.w = 1.0 - (loc_95cea / ((var_a4822.Lights[arg_50e58].position.w * var_a4822.Lights[arg_50e58].position.w) + 9.9999997473787516355514526367188e-05));
    arg_62394 = (((var_a4822.Lights[arg_50e58].color.xyz * var_a4822.Lights[arg_50e58].color.w) * loc_3d192) * loc_33ea0) * DirectionalShadowModeAndCloudShadowToggleAndPointLightToggleAndShadowToggle.z;
}
void func_76426(inout bool arg_9a2b4, inout bool arg_b6724, inout bool arg_33e52, inout highp vec3 arg_3289d, inout highp vec3 arg_98547, inout highp vec4 arg_82d08, inout highp vec3 arg_dc0ef, inout highp vec3 arg_96daa, inout highp vec3 arg_89c41, inout highp vec3 arg_5e5a1, inout highp vec3 arg_21ff0, inout highp vec4 arg_eac61, inout highp vec3 arg_5e370, inout highp vec3 arg_78ca7) {
    ...
    for (int loc_0ad25 = loc_2aee5; loc_0ad25 < loc_9d2b5; loc_118d9 = loc_7a7eb, loc_68344 = loc_49b5f, loc_23246 = loc_62c27, loc_0ad25++)
    {
        ...
        highp vec3 loc_138a8 = normalize((u_view * vec4(var_a4822.Lights[loc_2cc07].position.xyz, 1.0)).xyz - arg_89c41);
        ...
        if (arg_b6724)
        {
            ...
            if (arg_9a2b4)
            {
                ...
                highp float loc_33e5f = max(dot(arg_5e5a1, arg_21ff0), 0.0);
                highp vec3 loc_2e051 = normalize(loc_138a8 + arg_21ff0);
                highp float loc_3806d = max(dot(arg_5e5a1, loc_2e051), 0.0);
                highp float loc_e5162 = max((((-0.9375) * loc_3806d) * loc_3806d) + 1.0, 9.9999997473787516355514526367188e-05);
                highp vec3 loc_c1dd9 = vec3(0.959999978542327880859375) * pow(clamp(1.0 - max(dot(arg_21ff0, loc_2e051), 0.0), 0.0, 1.0), 5.0);
                loc_8d121 = ((((vec3(0.039999999105930328369140625) + loc_c1dd9) * (0.01989436708390712738037109375 / (loc_e5162 * loc_e5162))) * ((loc_33e5f / ((loc_33e5f * 0.875) + 0.12510000169277191162109375)) * (loc_542fb / ((loc_542fb * 0.875) + 0.12510000169277191162109375)))) / vec3(((4.0 * loc_542fb) * loc_33e5f) + 9.9999997473787516355514526367188e-05)) * loc_542fb;
                loc_770dc = ((vec3(0.959999978542327880859375) - loc_c1dd9) * loc_542fb) * ((arg_eac61.xyz * 1.0) * vec3(0.3183098733425140380859375));
            }
            else
            {
                loc_8d121 = vec3(0.0);
        ...
        else
        {
            ...
            if (arg_9a2b4)
            {
                highp float loc_e5d13 = max(dot(arg_5e5a1, loc_138a8), 0.0);
                highp float loc_76109 = max(dot(arg_5e5a1, arg_21ff0), 0.0);
                highp vec3 loc_94084 = normalize(loc_138a8 + arg_21ff0);
                highp float loc_1a38a = max(dot(arg_5e5a1, loc_94084), 0.0);
...
void main() {
    ...
    highp vec4 var_c26bc = vec4(var_2b5c5.xyz * var_2b5c5.xyz, abs(var_2b5c5.w)) + vec4(mix((var_93e9a.xyz * mix(vec3(1.0), v_color0.xyz, vec3(ColorBased.x))).xyz, OverlayColor.xyz, vec3(OverlayColor.w)), 0.0);
    var_c26bc.w = var_93e9a.w;
    highp vec4 var_d4180 = var_c26bc;
    ...
    highp vec3 var_f8775 = var_9f386.xyz;
    highp vec3 var_6ec0d = var_89669.xyz;
    highp vec3 var_84209 = (u_view * var_89669).xyz;
    ...
    highp float var_3dc39 = length(var_f8775);
    highp vec3 var_d49b9 = var_f8775;
    highp vec3 var_5bd0a = var_bed13;
    highp vec3 var_811e1 = var_f8775;
    ...
    if (!var_49ba4)
    {
        var_25152 = var_464cb && (var_3707d < PointLightSpecularFadeOutParameters.y);
    }
    else
    {
        var_25152 = var_49ba4;
    ...
    if (!var_70859)
    {
        var_f4e52 = var_686c7 && (var_3707d < PointLightDiffuseFadeOutParameters.y);
    }
    else
    {
        var_f4e52 = var_70859;
    }
    highp vec3 var_fc705 = -(var_f8775 / vec3(length(var_f8775) + 9.9999997473787516355514526367188e-05));
    highp vec3 var_cab08;
    if (ShadowQuantizationParameters.y > 0.0)
    {
        highp vec3 var_2a957 = v_worldPos - WorldOrigin.xyz;
        highp vec3 var_371a2 = normalize(round(normalize((u_invView * vec4(normalize(cross(normalize(dFdx(var_f8775)), normalize(dFdy(var_f8775)))), 0.0)).xyz) / vec3(ShadowPrecisionRoundingParameters.x)) * ShadowPrecisionRoundingParameters.x);
        highp vec3 var_73ac8 = mod(var_2a957, vec3(ShadowQuantizationParameters.z));
        var_cab08 = (round((var_2a957 - (var_73ac8 - (var_371a2 * dot(var_73ac8, var_371a2)))) / vec3(ShadowPrecisionRoundingParameters.y)) * ShadowPrecisionRoundingParameters.y) + WorldOrigin.xyz;
    }
    else
    {
        var_cab08 = v_worldPos;
    }
    bool var_5a6e4;
    highp vec4 var_9a0a9;
    highp vec3 var_cb40a;
    highp vec3 var_0a75d;
    if (var_5bd0a.z != 1.0)
    {
        highp vec2 var_c6b5c = vec2(var_49182, var_280ef);
        highp vec3 var_9aeed;
        highp vec3 var_c65bf;
        func_cf9f6(var_c65bf, var_9aeed, var_84209, var_cab08, var_6ec0d, var_d49b9, var_c6b5c, var_fc705, var_c26bc);
        highp vec3 var_8bbda = var_f8775;
        highp vec4 var_9536d;
        highp vec3 var_62261;
        highp vec3 var_7aa4c;
        bool var_c0cc5;
        func_76426(var_25152, var_f4e52, var_c0cc5, var_7aa4c, var_62261, var_9536d, var_8bbda, var_bed13, var_f8775, var_84209, var_fc705, var_c26bc, var_cab08, var_6ec0d);
        var_0a75d = var_c65bf + (var_7aa4c * (1.0 - var_f3062));
        var_cb40a = var_9aeed + (var_62261 * (1.0 - var_5d160));
        var_9a0a9 = var_9536d;
        var_5a6e4 = var_c0cc5;
    }
    else
    ...
    highp float var_a3aa7;
    if (var_5a6e4)
    {
        var_a3aa7 = PointLightDiffuseFadeOutParameters.w;
    }
    else
    {
        var_a3aa7 = PointLightDiffuseFadeOutParameters.z + ((PointLightDiffuseFadeOutParameters.w - PointLightDiffuseFadeOutParameters.z) * var_f3062);
    }
    highp vec4 var_a1a62 = var_9a0a9;
    highp float var_3bfa3 = TileLightIntensity.x * TileLightIntensity.x;
    highp vec4 var_17711 = SkyAmbientLightColorIntensity;
    highp vec3 var_0f774 = ((((var_c26bc.xyz * 1.0) * max(((clamp(vec3(var_3bfa3 + (var_a1a62.x * var_a1a62.w), (var_3bfa3 * ((((var_3bfa3 * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_a1a62.y * var_a1a62.w), (var_3bfa3 * (((var_3bfa3 * var_3bfa3) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_a1a62.z * var_a1a62.w)), vec3(0.0), vec3(1.0)) * BlockBaseAmbientLightColorIntensity.w) * var_a3aa7) + ((SkyAmbientLightColorIntensity.xyz * pow(TileLightIntensity.y, mix(5.0, 3.0, CameraLightIntensity.y))) * var_17711.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_0a75d) + var_cb40a;
    highp float var_7d5ab = length(var_f8775);
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_3de5f > 0.0)
        {
            ...
            var_cb5ed = mix(var_0f774, var_08c70, vec3(var_3de5f));
        }
        else
        {
            var_cb5ed = var_0f774;
    ...
    {
        var_7e3dc = mix(var_0f774, FogColor.xyz, vec3(clamp((((var_7d5ab / FogAndDistanceControl.z) + RenderChunkFogAlpha.x) - FogAndDistanceControl.x) / (FogAndDistanceControl.y - FogAndDistanceControl.x), 0.0, 1.0)));
    }
    highp vec3 var_28cb8;
    if (VolumeScatteringEnabledAndPointLightVolumetricsEnabled.x != 0.0)
    {
        highp vec2 var_65315 = VolumeNearFar.xy;
        highp vec2 var_7d045 = (var_bed13.xy + vec2(1.0)) * 0.5;
    ...
    {
        highp vec3 var_7914f = reflect(normalize(v_worldPos - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_6ec0d);
        ...
        highp vec3 var_0f77a = (var_6f3bc * (pow(clamp(((TileLightIntensity.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0), 3.0) * IBLParameters.x)) * IBLParameters.z;
        highp vec3 var_7744c;
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            highp vec4 var_72b9c;
            func_1e7c4(var_0f77a, var_72b9c);
        ...
        highp vec2 var_39589 = vec2(clamp(dot(var_84209, -(var_f8775 / vec3(var_3dc39))), 0.0, 1.0), 0.5);
    ...
    else
    {
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            highp vec2 var_32ca3 = vec2(clamp(dot(var_84209, -(var_f8775 / vec3(var_3dc39))), 0.0, 1.0), 0.5);
