...
void main() {
    ...
    highp vec4 var_e74f1 = vec4(var_f7609.x, var_f7609.y, var_f7609.z, var_f7609.w);
    ...
    bgfx_FragData2 = vec4(MERSUniforms.y, TileLightIntensity.x, TileLightIntensity.y, MERSUniforms.z);
}
