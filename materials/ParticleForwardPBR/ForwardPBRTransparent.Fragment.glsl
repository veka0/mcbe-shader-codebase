...
void main() {
    ...
    highp vec2 var_854de = v_vanillaLighting;
    ...
    highp vec3 var_f239a;
    func_9b87e(var_f239a, var_9e11a);
    int var_bec18 = int(PBRTextureFlags.x);
    highp float var_f2eeb;
    highp float var_240e6;
    highp float var_022af;
    ...
    if ((var_bec18 & 1) == 1)
    {
        ...
        var_90d31 = var_b362d;
        var_022af = var_4035b.z;
        var_240e6 = var_4035b.y;
        var_f2eeb = var_4035b.x;
    }
    else
    {
        var_90d31 = MERSUniforms.w;
        var_022af = MERSUniforms.z;
        var_240e6 = MERSUniforms.y;
        var_f2eeb = MERSUniforms.x;
    }
    ...
    highp vec3 var_6821e = var_e14aa.xyz;
    ...
    highp vec3 var_6f955;
    if ((((var_a461a.x + var_a461a.y) + var_a461a.z) < 9.9999997473787516355514526367188e-05) && (var_854de.x > 9.9999997473787516355514526367188e-05))
    {
        highp vec4 var_0bc6f = vec4(0.0);
        highp float var_9a19a = var_854de.x * var_854de.x;
        var_6f955 = clamp(vec3(var_9a19a + (var_0bc6f.x * var_0bc6f.w), (var_9a19a * ((((var_9a19a * 0.60000002384185791015625) + 0.4000000059604644775390625) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_0bc6f.y * var_0bc6f.w), (var_9a19a * (((var_9a19a * var_9a19a) * 0.60000002384185791015625) + 0.4000000059604644775390625)) + (var_0bc6f.z * var_0bc6f.w)), vec3(0.0), vec3(1.0));
    }
    else
    {
        var_6f955 = v_coloredLighting;
    }
    highp vec3 var_c5e74 = vec3(0.039999999105930328369140625 * (1.0 - var_f2eeb)) + (var_f239a * var_f2eeb);
    ...
    highp float var_62b20 = clamp(((var_854de.y * 16.0) - IBLSkyFadeParameters.y) / max(IBLSkyFadeParameters.x - IBLSkyFadeParameters.y, 1.0), 0.0, 1.0);
    ...
    if (var_5bd0a.z != 1.0)
    {
        ...
        highp float var_a712c = var_90d31 * SubsurfaceScatteringContributionAndDiffuseWrapValueAndFalloffScale.x;
        ...
        func_409ba(var_854de, var_33188, var_94c87, var_73e61, var_a3c91, var_6821e, var_8bbda, var_c90aa, var_c2de9, var_022af, var_c5e74, var_f239a, var_f2eeb, var_a712c);
        highp vec4 var_05431;
        highp vec3 var_aae12;
        highp vec3 var_e318f;
        func_d7f93(var_e318f, var_33188, var_aae12, var_94c87, var_05431, var_15859, var_2b534, var_73e61, var_c2de9, var_022af, var_c5e74, var_f239a, var_f2eeb, var_6821e, var_a712c);
        var_99cf4 = var_e318f;
        var_819bb = var_aae12;
        var_1cf85 = var_05431;
    }
    ...
    highp vec3 var_681b8;
    if (DirectionalLightToggleAndMaxDistanceAndMaxCascadesPerLightAndGPUBlockLightingEnabled.w != 0.0)
    {
        highp vec3 var_6db9a = ((v_worldPos - WorldOrigin.xyz) - vec3(0.5)) + (var_6821e * 0.20000000298023223876953125);
        ...
        if (var_a0c0a)
        {
            ...
            if (any(greaterThanEqual(abs(var_6821e), vec3(1.0))))
            {
                highp vec3 var_c2195 = var_6821e;
                highp vec3 var_3e9f3 = abs(var_6821e);
    ...
    highp float var_ad6e5 = var_854de.y * var_854de.y;
    ...
    if (AtmosphericScatteringToggles.x != 0.0)
    {
        ...
        if (var_79b3e > 0.0)
        {
            ...
            else
            {
                ...
                {
                    var_8e91d = mix(UndergroundFogColor.xyz, var_c1176, vec3(max(CameraAmbientContribution.y, var_854de.y)));
                }
                else
                {
                    var_8e91d = var_c1176;
    ...
    highp vec3 var_5779c = var_deaa5.xyz + (mix((((((var_f239a * (1.0 - var_f2eeb)) * max(((var_681b8 + (var_1cf85.xyz * var_a2cfa.w)) * BlockBaseAmbientLightColorIntensity.w) + ((SkyAmbientLightColorIntensity.xyz * mix((var_ad6e5 * var_ad6e5) * var_854de.y, (var_854de.y * var_854de.y) * var_854de.y, CameraLightIntensity.y)) * var_91d67.w), AmbientLightParams.xyz * AmbientLightParams.w)) * DiffuseSpecularEmissiveAmbientTermToggles.w) + var_99cf4) + var_819bb) + (((mix(var_f239a, vec3(dot(var_f239a, vec3(0.2125999927520751953125, 0.715200006961822509765625, 0.072200000286102294921875))), vec3(EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.y)) * DiffuseSpecularEmissiveAmbientTermToggles.z) * vec3(var_240e6)) * EmissiveMultiplierAndDesaturationAndCloudPCFAndContribution.x), var_2920e.xyz, vec3(var_baa7d.w)) * var_62d8e.w);
    ...
    if (IBLParameters.x != 0.0)
    {
        ...
        highp vec3 var_a56d9 = reflect(normalize(var_a8715 - (u_invView * vec4(0.0, 0.0, 0.0, 1.0)).xyz), var_6821e);
        highp float var_0f441;
        if (int(ConvolutionType.x) == 1)
        {
            highp float var_9a0e5 = 1.0 - var_022af;
            var_0f441 = (1.0 - (var_9a0e5 * var_9a0e5)) * (IBLParameters.y - 1.0);
        }
        else
        {
            highp float var_c17b7 = 1.0 - var_022af;
        ...
        if (DiffuseSpecularEmissiveAmbientTermToggles.w != 0.0)
        {
            ...
            func_f1037(var_6f955, var_f2eeb, var_713f8, var_26642);
        ...
        highp vec2 var_dea35 = vec2(clamp(dot(var_73e61, -normalize(var_dd3fd)), 0.0, 1.0), var_022af);
    ...
    if (PreExposureEnabled.x > 0.0)
    {
        var_3dd84 = var_cdd60 * ((0.180000007152557373046875 / texture(s_PreviousFrameAverageLuminance, vec2(0.5)).x) + 9.9999997473787516355514526367188e-05);
    }
    else
    {
        var_3dd84 = var_cdd60;
